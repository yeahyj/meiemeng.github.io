...
System.register("chunks:///_virtual/AppInit.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './BaseAppInit.ts', './app.ts', './Core.ts'], function (exports) {
  var _applyDecoratedDescriptor, _inheritsLoose, _initializerDefineProperty, _assertThisInitialized, cclegacy, _decorator, Node, UIOpacity, tween, settings, Settings, assetManager, ControlBundleName, ControllerBundleName, BaseAppInit, app, Core;
  return {
    setters: [function (module) {
