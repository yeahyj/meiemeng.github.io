System.register("chunks:///_virtual/app.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './Core.ts', './handle.ts'], function (exports) {
  var _inherits, _createSuper, _createClass, _defineProperty, _classCallCheck, cclegacy, game, Game, Core, cccInited, appInited;
  return {
    ...
    execute: function () {
      ...
      _defineProperty(App, "_inst", null);
...
System.register("chunks:///_virtual/AppInit.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './BaseAppInit.ts', './app.ts', './Core.ts'], function (exports) {
  var _applyDecoratedDescriptor, _inherits, _createSuper, _classCallCheck, _initializerDefineProperty, _assertThisInitialized, _createClass, cclegacy, _decorator, Node, UIOpacity, tween, settings, Settings, assetManager, ControlBundleName, ControllerBundleName, BaseAppInit, app, Core;
  return {
    setters: [function (module) {
      ...
      ControlBundleName = module.ControlBundleName;
    ...
    execute: function () {
      ...
      var AppInit = exports('AppInit', (_dec = ccclass('AppInit'), _dec2 = property(Node), _dec(_class = (_class2 = /*#__PURE__*/function (_BaseAppInit) {
        _inherits(AppInit, _BaseAppInit);
        var _super = _createSuper(AppInit);
        function AppInit() {
          var _this;
          ...
          _initializerDefineProperty(_assertThisInitialized(_this), "logo", _descriptor, _assertThisInitialized(_this));
          return _this;
        }
...
System.register("chunks:///_virtual/Audio.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc'], function (exports) {
  var _createClass, _classCallCheck, _defineProperty, cclegacy, Node, AudioSource;
  return {
    setters: [function (module) {
      _createClass = module.createClass;
      _classCallCheck = module.classCallCheck;
    ...
    execute: function () {
      ...
      var Audio = exports('default', /*#__PURE__*/function () {
        function Audio() {
          ...
          _defineProperty(this, "volumeScale", 1);
          _defineProperty(this, "mute", false);
          _defineProperty(this, "endedCallback", null);
          _defineProperty(this, "startedCallback", null);
        ...
        _createClass(Audio, [{
          ...
          value: function play(clip) {
            var onEnded = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : null;
            var onStarted = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : null;
          ...
          key: "onEnded",
          value: function onEnded(endedCallback) {
...
System.register("chunks:///_virtual/AudioEngine.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './AudioManager.ts'], function (exports) {
  var _createClass, _defineProperty, _classCallCheck, cclegacy, AudioManager;
  return {
    setters: [function (module) {
      _createClass = module.createClass;
      _defineProperty = module.defineProperty;
    ...
    execute: function () {
      ...
      var AudioEngine = exports('default', /*#__PURE__*/function () {
        function AudioEngine() {
          ...
          _defineProperty(this, "audioID", 1);
          _defineProperty(this, "endedCallbackMap", new Map());
          _defineProperty(this, "effectMap", new Map());
          _defineProperty(this, "music", null);
          _defineProperty(this, "musicMute", false);
          _defineProperty(this, "effectMute", false);
          _defineProperty(this, "musicVolume", 1);
          _defineProperty(this, "musicVolumeScale", 1);
          _defineProperty(this, "effectVolume", 1);
          _defineProperty(this, "effectVolumeScale", 1);
        }
        _createClass(AudioEngine, [{
          ...
          // 音效                        //
          ////////////////////////////////
          function playEffect(audioClip) {
            var _this = this;
            var volume = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 1;
            var loop = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : false;
            var onStarted = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : null;
            var onEnded = arguments.length > 4 && arguments[4] !== undefined ? arguments[4] : null;
          ...
          key: "stopEffect",
          value: function stopEffect(id) {
            var _this$effectMap$get;
            return !!((_this$effectMap$get = this.effectMap.get(id)) !== null && _this$effectMap$get !== void 0 && _this$effectMap$get.stop());
          }
        }, {
          key: "stopAllEffects",
          value: function stopAllEffects() {
          ...
          key: "pauseEffect",
          value: function pauseEffect(id) {
            var _this$effectMap$get2;
            return !!((_this$effectMap$get2 = this.effectMap.get(id)) !== null && _this$effectMap$get2 !== void 0 && _this$effectMap$get2.pause());
          }
        }, {
          key: "pauseAllEffects",
          value: function pauseAllEffects() {
            this.effectMap.forEach(function (audio) {
              audio.pause();
            });
          }
          ...
          key: "resumeEffect",
          value: function resumeEffect(id) {
            var _this$effectMap$get3;
            return !!((_this$effectMap$get3 = this.effectMap.get(id)) !== null && _this$effectMap$get3 !== void 0 && _this$effectMap$get3.resume());
          }
        }, {
          key: "resumeAllEffects",
          value: function resumeAllEffects() {
            this.effectMap.forEach(function (audio) {
              audio.resume();
            });
          }
          ...
          key: "setEffectMute",
          value: function setEffectMute(id, mute) {
            var _this$effectMap$get4;
            return !!((_this$effectMap$get4 = this.effectMap.get(id)) !== null && _this$effectMap$get4 !== void 0 && _this$effectMap$get4.setMute(mute));
          }
        }, {
          key: "setAllEffectsMute",
          value: function setAllEffectsMute(mute) {
          ...
          key: "getEffectMute",
          value: function getEffectMute(id) {
            var _this$effectMap$get5;
            return !!((_this$effectMap$get5 = this.effectMap.get(id)) !== null && _this$effectMap$get5 !== void 0 && _this$effectMap$get5.getMute());
          }
        }, {
          key: "getAllEffectsMute",
          value: function getAllEffectsMute() {
            return this.effectMute;
          }
        }, {
          key: "setEffectVolume",
          value: function setEffectVolume(id, volume) {
            var _this$effectMap$get6;
            return !!((_this$effectMap$get6 = this.effectMap.get(id)) !== null && _this$effectMap$get6 !== void 0 && _this$effectMap$get6.setVolume(volume));
          }
        }, {
          key: "setAllEffectsVolume",
          value: function setAllEffectsVolume(volume) {
          ...
          key: "getEffectVolume",
          value: function getEffectVolume(id) {
            var _this$effectMap$get7;
            return ((_this$effectMap$get7 = this.effectMap.get(id)) === null || _this$effectMap$get7 === void 0 ? void 0 : _this$effectMap$get7.getVolume()) || 0;
          }
        }, {
          key: "getAllEffectsVolume",
          value: function getAllEffectsVolume() {
            return this.effectVolume;
          }
        }, {
          key: "setEffectVolumeScale",
          value: function setEffectVolumeScale(id, volume) {
            var _this$effectMap$get8;
            return !!((_this$effectMap$get8 = this.effectMap.get(id)) !== null && _this$effectMap$get8 !== void 0 && _this$effectMap$get8.setVolumeScale(volume));
          }
        }, {
          key: "setAllEffectsVolumeScale",
          value: function setAllEffectsVolumeScale(scale) {
          ...
          key: "getEffectVolumeScale",
          value: function getEffectVolumeScale(id) {
            var _this$effectMap$get9;
            return ((_this$effectMap$get9 = this.effectMap.get(id)) === null || _this$effectMap$get9 === void 0 ? void 0 : _this$effectMap$get9.getVolumeScale()) || 0;
          }
        }, {
          key: "getAllEffectsVolumeScale",
          value: function getAllEffectsVolumeScale() {
          ...
          key: "playMusic",
          value: function playMusic(audioClip) {
            var volume = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 1;
            var onStarted = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : null;
            if (this.music) {
              this.music.destroy();
          ...
          value: function stopMusic() {
            var _this$music;
            return !!((_this$music = this.music) !== null && _this$music !== void 0 && _this$music.stop());
          }
        }, {
          key: "pauseMusic",
          value: function pauseMusic() {
            var _this$music2;
            return !!((_this$music2 = this.music) !== null && _this$music2 !== void 0 && _this$music2.pause());
          }
        }, {
          key: "resumeMusic",
          value: function resumeMusic() {
            var _this$music3;
            return !!((_this$music3 = this.music) !== null && _this$music3 !== void 0 && _this$music3.resume());
          }
        }, {
          key: "setMusicMute",
          value: function setMusicMute(mute) {
            var _this$music4;
            this.musicMute = mute;
            return !!((_this$music4 = this.music) !== null && _this$music4 !== void 0 && _this$music4.setMute(mute));
          }
        }, {
          key: "getMusicMute",
          value: function getMusicMute() {
          ...
          value: function setMusicVolume(volume) {
            ...
            return !!((_this$music5 = this.music) !== null && _this$music5 !== void 0 && _this$music5.setVolume(volume));
          }
        }, {
          key: "getMusicVolume",
          ...
          key: "setMusicVolumeScale",
          value: function setMusicVolumeScale(scale) {
            var _this$music6;
            this.musicVolumeScale = scale;
            return !!((_this$music6 = this.music) !== null && _this$music6 !== void 0 && _this$music6.setVolumeScale(scale));
          }
        }, {
          key: "getMusicVolumeScale",
          value: function getMusicVolumeScale() {
          ...
          key: "setEndedCallback",
          value: function setEndedCallback(audioID, callback) {
            if (audioID === 0) {
              var _this$music7;
              return !!((_this$music7 = this.music) !== null && _this$music7 !== void 0 && _this$music7.onEnded(callback));
            } else {
          ...
          key: "setVolume",
          value: function setVolume(audioID, volume) {
            if (audioID === 0) {
          ...
          key: "getVolume",
          value: function getVolume(audioID) {
            if (audioID === 0) {
          ...
          key: "setVolumeScale",
          value: function setVolumeScale(audioID, scale) {
            if (audioID === 0) {
          ...
          key: "getVolumeScale",
          value: function getVolumeScale(audioID) {
            if (audioID === 0) {
      ...
      _defineProperty(AudioEngine, "_inst", null);
      cclegacy._RF.pop();
    }
  };
});
...
System.register("chunks:///_virtual/AudioManager.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './Audio.ts'], function (exports) {
  var _createClass, _defineProperty, _classCallCheck, cclegacy, Audio;
  return {
    setters: [function (module) {
      _createClass = module.createClass;
      _defineProperty = module.defineProperty;
    ...
    execute: function () {
      ...
      _defineProperty(AudioManager, "_inst", null);
      cclegacy._RF.pop();
    }
  };
});
...
System.register("chunks:///_virtual/BaseAppInit.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './Core.ts', './BaseManager.ts'], function (exports) {
  var _inherits, _createSuper, _classCallCheck, _defineProperty, _assertThisInitialized, _createClass, cclegacy, _decorator, settings, Settings, assetManager, Button, Node, Component, isValid, EventTouch, Core, BaseManager;
  return {
    setters: [function (module) {
      _inherits = module.inherits;
      _createSuper = module.createSuper;
    ...
    execute: function () {
      ...
      var BaseAppInit = exports('default', (_dec = ccclass('BaseAppInit'), _dec(_class = /*#__PURE__*/function (_Component) {
        _inherits(BaseAppInit, _Component);
        var _super = _createSuper(BaseAppInit);
        function BaseAppInit() {
          var _this;
          _classCallCheck(this, BaseAppInit);
          _this = _super.call(this);
          _defineProperty(_assertThisInitialized(_this), "_base_completed", 0);
          _defineProperty(_assertThisInitialized(_this), "_base_completed_cache", 0);
          _defineProperty(_assertThisInitialized(_this), "_base_inited", false);
          _defineProperty(_assertThisInitialized(_this), "_base_finished", false);
          return _this;
        }
        ...
        _createClass(BaseAppInit, [{
          ...
          key: "onProgress",
          value: function onProgress(completed, total) {
          ...
          key: "onUserInit",
          value: function onUserInit(index) {
            return index;
          }
          ...
          key: "getUserAssetNum",
          value: function getUserAssetNum() {
            return 0;
          }
...
System.register("chunks:///_virtual/BaseControl.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc'], function (exports) {
  var _defineProperty, _inherits, _createSuper, _classCallCheck, _createClass, cclegacy;
  return {
    setters: [function (module) {
      _defineProperty = module.defineProperty;
      _inherits = module.inherits;
    ...
    execute: function () {
      ...
      var CallbackInfo = /*#__PURE__*/_createClass(function CallbackInfo(callback) {
      ...
      var CallbackList = /*#__PURE__*/function () {
        ...
        _createClass(CallbackList, [{
          ...
          value: function removeByCallback(callback) {
            for (var index = this.callbacks.length - 1; index >= 0; index--) {
              var info = this.callbacks[index];
      ...
      var EventEmitter = /*#__PURE__*/function () {
        ...
        _createClass(EventEmitter, [{
          key: "on",
          value: function on(event, cb, target) {
          ...
          key: "once",
          value: function once(event, cb, target) {
            if (!event.toString() || !cb) return;
            if (!this.listeners[event]) this.listeners[event] = new CallbackList();
          ...
          key: "off",
          value: function off(event, cb, target) {
            if (!event.toString() || !cb) return;
          ...
          key: "call",
          value: function call(event, args) {
            if (!event.toString()) return;
            if (!this.listeners[event]) return;
      ...
      var SuperBaseControl = /*#__PURE__*/function () {
        function SuperBaseControl() {
          _classCallCheck(this, SuperBaseControl);
          //用于类型提示推导//
      ...
      function BaseControl(Event) {
        ...
        return _class5 = /*#__PURE__*/function (_SuperBaseControl) {
          _inherits(BaseControl, _SuperBaseControl);
          ...
          return BaseControl;
        }(SuperBaseControl), _defineProperty(_class5, "Event", Event), _defineProperty(_class5, "_base_inst", null), _class5;
      }
      cclegacy._RF.pop();
    }
  };
    ...
    execute: function () {
      ...
      var SuperBaseController = /*#__PURE__*/function () {
        function SuperBaseController() {
          _classCallCheck(this, SuperBaseController);
          //用于类型提示推导//
          _defineProperty(this, "t", void 0);
          ////
          /////////////////
      ...
      function BaseController() {
        ...
        return _class5 = /*#__PURE__*/function (_SuperBaseController) {
          _inherits(BaseController, _SuperBaseController);
        ...
        }(SuperBaseController), _defineProperty(_class5, "Event", new Proxy({}, {
          get: function get(target, key) {
            if (target[key]) return target[key];
            target[key] = key;
            return key;
          }
        })), _defineProperty(_class5, "_base_inst", null), _class5;
      }
      cclegacy._RF.pop();
    }
  };
...
System.register("chunks:///_virtual/BaseManager.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './Core.ts'], function (exports) {
  var _createClass, _defineProperty, _classCallCheck, _inherits, _createSuper, _assertThisInitialized, cclegacy, _decorator, EventTarget, js, error, settings, assetManager, Prefab, find, path, instantiate, Widget, Component, Core;
  return {
    setters: [function (module) {
      _createClass = module.createClass;
      _defineProperty = module.defineProperty;
      ...
      var uuid = new ( /*#__PURE__*/function () {
        ...
        _createClass(UUID, [{
          ...
          value: function create() {
            ...
            return "".concat(Date.now(), "-").concat(this.index);
          }
        }]);
        return UUID;
      }())();
      var loadBegin = window.console.log.bind(window.console, '%c %s %c %s ', 'background:#32cd32; padding: 2px; border-radius: 5px 0 0 5px; border: 1px solid #32cd32; color: #fff; font-weight: normal;', "[BaseManager] \u4E0B\u8F7D\u5F00\u59CB ".concat(new Date().toLocaleString()), 'background:#ffffff; padding: 2px; border-radius: 0 5px 5px 0; border: 1px solid #32cd32; color: #32cd32; font-weight: normal;');
      var loadFinish = window.console.log.bind(window.console, '%c %s %c %s ', 'background:#00ae9d; padding: 2px; border-radius: 5px 0 0 5px; border: 1px solid #00ae9d; color: #fff; font-weight: normal;', "[BaseManager] \u4E0B\u8F7D\u5B8C\u6210 ".concat(new Date().toLocaleString()), 'background:#ffffff; padding: 2px; border-radius: 0 5px 5px 0; border: 1px solid #00ae9d; color: #00ae9d; font-weight: normal;');
      var loadError = window.console.log.bind(window.console, '%c %s %c %s ', 'background:#ff4757; padding: 2px; border-radius: 5px 0 0 5px; border: 1px solid #ff4757; color: #fff; font-weight: normal;', "[BaseManager] \u4E0B\u8F7D\u5931\u8D25 ".concat(new Date().toLocaleString()), 'background:#ffffff; padding: 2px; border-radius: 0 5px 5px 0; border: 1px solid #ff4757; color: #ff4757; font-weight: normal;');
      var initBegin = window.console.log.bind(window.console, '%c %s %c %s ', 'background:#3e4145; padding: 2px; border-radius: 5px 0 0 5px; border: 1px solid #3e4145; color: #fff; font-weight: normal;', "[BaseManager] \u521D\u59CB\u5316\u5F00\u59CB ".concat(new Date().toLocaleString()), 'background:#ffffff; padding: 2px; border-radius: 0 5px 5px 0; border: 1px solid #3e4145; color: #3e4145; font-weight: normal;');
      var initFinish = window.console.log.bind(window.console, '%c %s %c %s ', 'background:#008080; padding: 2px; border-radius: 5px 0 0 5px; border: 1px solid #008080; color: #fff; font-weight: normal;', "[BaseManager] \u521D\u59CB\u5316\u5B8C\u6210 ".concat(new Date().toLocaleString()), 'background:#ffffff; padding: 2px; border-radius: 0 5px 5px 0; border: 1px solid #008080; color: #008080; font-weight: normal;');
      var BaseManager = exports('default', (_dec = ccclass('BaseManager'), _dec(_class2 = (_class3 = /*#__PURE__*/function (_Component) {
        _inherits(BaseManager, _Component);
        var _super = _createSuper(BaseManager);
        function BaseManager() {
          var _this;
          _classCallCheck(this, BaseManager);
          _this = _super.call(this);
          // 事件管理器
          _defineProperty(_assertThisInitialized(_this), "_base_event", new EventTarget());
          // manager名字
          _defineProperty(_assertThisInitialized(_this), "_base_manager_name", js.getClassName(_assertThisInitialized(_this)));
          if (_this._base_manager_name !== 'Manager' && _this._base_manager_name.slice(-7) === 'Manager') {
            ...
            error("[".concat(_this._base_manager_name, "] manager\u547D\u540D\u9519\u8BEF(\u5E94\u4E3A xxxxManager \u4EE5Manager\u7ED3\u5C3E)"));
          }
          return _this;
        }
        ...
        _createClass(BaseManager, [{
          ...
          key: "log",
          get: function get() {
            return window.console.log.bind(window.console, '%c %s %c %s ', 'background:#4169e1; padding: 2px; border-radius: 5px 0 0 5px; border: 1px solid #4169e1; color: #fff; font-weight: normal;', "[".concat(this._base_manager_name, "] LOG ").concat(new Date().toLocaleString()), 'background:#ffffff ; padding: 2px; border-radius: 0 5px 5px 0; border: 1px solid #4169e1; color: #4169e1; font-weight: normal;');
          }
        }, {
          key: "warn",
          get: function get() {
            return window.console.warn.bind(window.console, '%c %s %c %s ', 'background:#ff7f50; padding: 2px; border-radius: 5px 0 0 5px; border: 1px solid #ff7f50; color: #fff; font-weight: normal;', "[".concat(this._base_manager_name, "] WARN ").concat(new Date().toLocaleString()), 'background:#ffffff ; padding: 2px; border-radius: 0 5px 5px 0; border: 1px solid #ff7f50; color: #ff7f50; font-weight: normal;');
          }
        }, {
          key: "error",
          get: function get() {
            return window.console.error.bind(window.console, '%c %s %c %s ', 'background:#ff4757; padding: 2px; border-radius: 5px 0 0 5px; border: 1px solid #ff4757; color: #fff; font-weight: normal;', "[".concat(this._base_manager_name, "] ERROR ").concat(new Date().toLocaleString()), 'background:#ffffff ; padding: 2px; border-radius: 0 5px 5px 0; border: 1px solid #ff4757; color: #ff4757; font-weight: normal;');
          }
        }, {
          key: "emit",
          ...
          key: "stringCaseNegate",
          value: function stringCaseNegate(str) {
          ...
          key: "init",
          value: function init(bundleName, onFinish) {
            var _this2 = this;
          ...
          key: "getTotalAssetNum",
          value: function getTotalAssetNum() {
          ...
          key: "getUserAssetUrls",
          value: function getUserAssetUrls() {
            var pathArr = [];
          ...
          key: "initManagers",
          value: function initManagers(progress, complete) {
            ...
            var onProgress = function onProgress(next, manager) {
              {
                var _window;
                var startTime = (_window = window) !== null && _window !== void 0 && (_window = _window.performance) !== null && _window !== void 0 && _window.now ? performance.now() : Date.now();
                initBegin(manager.managerName);
                return function () {
                  manager.onInited();
                  {
                    var _window2;
                    var endTime = (_window2 = window) !== null && _window2 !== void 0 && (_window2 = _window2.performance) !== null && _window2 !== void 0 && _window2.now ? performance.now() : Date.now();
                    initFinish("".concat(manager.managerName, " \u8017\u65F6:").concat((endTime - startTime).toFixed(6), " ms"));
                  }
              ...
              loadUserMgrTask.add(function (next, retry) {
                {
                  ...
                  var startTime = (_window3 = window) !== null && _window3 !== void 0 && (_window3 = _window3.performance) !== null && _window3 !== void 0 && _window3.now ? performance.now() : Date.now();
                  ...
                  bundle.load(url, Prefab, function (err, prefab) {
                    if (err || !prefab) {
                      ...
                      var _window4;
                      var endTime = (_window4 = window) !== null && _window4 !== void 0 && (_window4 = _window4.performance) !== null && _window4 !== void 0 && _window4.now ? performance.now() : Date.now();
                      loadFinish("".concat(managerName, " \u8017\u65F6:").concat((endTime - startTime).toFixed(6), " ms"));
        ...
        return BaseManager;
      }(Component), _defineProperty(_class3, "bundle", null), _class3)) || _class2));
      cclegacy._RF.pop();
    }
  };
});
...
System.register("chunks:///_virtual/BaseView.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './Core.ts'], function (exports) {
  var _defineProperty, _applyDecoratedDescriptor, _inherits, _createSuper, _classCallCheck, _assertThisInitialized, _initializerDefineProperty, _createClass, cclegacy, _decorator, Node, Enum, js, Scene, director, UITransform, Font, isValid, sp, SpriteFrame, Component, Core;
  return {
    setters: [function (module) {
      _defineProperty = module.defineProperty;
      _applyDecoratedDescriptor = module.applyDecoratedDescriptor;
    ...
    execute: function () {
      ...
      var BaseView = exports('default', (_dec = ccclass('BaseView'), _dec2 = property({
        ...
        function BaseView() {
          ...
          _this = _super.call.apply(_super, [this].concat(args));
          // 是否被调用过
          _defineProperty(_assertThisInitialized(_this), "_isOnCreateCalled", false);
          // view状态
          _defineProperty(_assertThisInitialized(_this), "_base_view_state", ViewState.Hid);
          // 当前view的名字
          _defineProperty(_assertThisInitialized(_this), "_base_view_name", js.getClassName(_assertThisInitialized(_this)));
          // 触摸是否有效
          _defineProperty(_assertThisInitialized(_this), "_base_touch_enable", true);
          // show/hide等待列表
          _defineProperty(_assertThisInitialized(_this), "_base_show_hide_delays", []);
          // 子界面融合相关
          _defineProperty(_assertThisInitialized(_this), "_base_mini_show", new Set());
          _initializerDefineProperty(_assertThisInitialized(_this), "_hideEvent", _descriptor, _assertThisInitialized(_this));
          _initializerDefineProperty(_assertThisInitialized(_this), "_singleton", _descriptor2, _assertThisInitialized(_this));
          _initializerDefineProperty(_assertThisInitialized(_this), "_captureFocus", _descriptor3, _assertThisInitialized(_this));
          _initializerDefineProperty(_assertThisInitialized(_this), "_shade", _descriptor4, _assertThisInitialized(_this));
          _initializerDefineProperty(_assertThisInitialized(_this), "_blockInput", _descriptor5, _assertThisInitialized(_this));
          /**
           * 子界面(只能用于Page)
           */
        ...
        _createClass(BaseView, [{
          ...
          set: function set(value) {
            ...
            if (this._shade !== value) {
              var _Core$inst;
              this._shade = value;
              (_Core$inst = Core.inst) === null || _Core$inst === void 0 || (_Core$inst = _Core$inst.manager) === null || _Core$inst === void 0 || (_Core$inst = _Core$inst.ui) === null || _Core$inst === void 0 || _Core$inst.refreshShade();
            } else {
              this._shade = value;
            }
          }
          ...
          key: "isMiniViewShow",
          value: function isMiniViewShow(name) {
          ...
          key: "setTouchEnabled",
          value: function setTouchEnabled() {
            var enabled = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : true;
            this._base_touch_enable = !!enabled;
          }
        }, {
          key: "blockPropagation",
          value: function blockPropagation(event) {
            if (this.blockInput) {
          ...
          key: "hideAllMiniViews",
          value: function hideAllMiniViews(data) {
          ...
          key: "hideMiniViews",
          value: function hideMiniViews(_ref) {
            var _this3 = this;
            var data = _ref.data,
              views = _ref.views;
            ...
            views.forEach(function (name) {
              if (_this3.miniViews.indexOf(name) === -1) {
                _this3.warn('hideMiniViews', "".concat(name, "\u4E0D\u5728miniViews\u4E2D, \u5DF2\u8DF3\u8FC7"));
                return;
              }
          ...
          key: "showMiniViews",
          value: function showMiniViews(_ref2) {
            var _this4 = this;
            var data = _ref2.data,
              views = _ref2.views,
              onShow = _ref2.onShow,
          ...
          key: "createMixMiniViewsTask",
          value: function createMixMiniViewsTask() {
            var _this5 = this;
            var views = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : [];
            var data = arguments.length > 1 ? arguments[1] : undefined;
            var _onShow = arguments.length > 2 ? arguments[2] : undefined;
            var _onHide = arguments.length > 3 ? arguments[3] : undefined;
            var task = Core.inst.lib.task.createSync();
            if (this.typeName !== ViewType.Page) {
              this.warn('showMiniViews', '仅支持Page类型');
              return task;
            ...
            views = views.filter(function (name) {
              ...
              if (_this5._base_mini_show.has(name)) {
                _this5.warn('showMiniViews', "\u91CD\u590D\u878D\u5408".concat(name, ", \u5DF2\u8DF3\u8FC7"));
                return false;
              }
              if (_this5.miniViews.indexOf(name) === -1) {
                _this5.warn('showMiniViews', "".concat(name, "\u4E0D\u5728miniViews\u4E2D, \u5DF2\u8DF3\u8FC7"));
                return false;
              }
              if (name.indexOf(_this5.baseName) !== ViewType.Paper.length && name.indexOf(ViewType.PaperAll) !== 0) {
                _this5.warn('showMiniViews', "".concat(name, "\u4E0D\u5C5E\u4E8E\u5F53\u524DPage, \u5DF2\u8DF3\u8FC7"));
                return false;
              }
            ...
            task.add(function (next) {
              ...
              views.forEach(function (name) {
                aSync.add(function (next) {
                  ...
                  if (!((_this5$_base_mini_sho = _this5._base_mini_show) !== null && _this5$_base_mini_sho !== void 0 && _this5$_base_mini_sho.has(name))) return next();
                  _this5.log("\u5C55\u793A\u5B50\u9875\u9762: ".concat(name));
                  // 是PaperAll,设置owner
                  ...
                  Core.inst.manager.ui.show({
                    ...
                    onHide: function onHide(result) {
                      ...
                      (_this5$_base_mini_sho2 = _this5._base_mini_show) === null || _this5$_base_mini_sho2 === void 0 || _this5$_base_mini_sho2["delete"](name);
                    ...
                    onError: function onError(result, code) {
                      ...
                      (_this5$_base_mini_sho3 = _this5._base_mini_show) === null || _this5$_base_mini_sho3 === void 0 || _this5$_base_mini_sho3["delete"](name);
          ...
          key: "setNodeAttr",
          value: function setNodeAttr(attr) {
            if (!attr) return;
          ...
          key: "show",
          value: function show(data, attr, onShow, onHide, beforeShow) {
            var _this6 = this;
            // 当前show操作需要等待其它流程
          ...
          key: "loadRes",
          value: function loadRes(path, type, callback) {
          ...
          key: "preloadRes",
          value: function preloadRes(path, type) {
          ...
          key: "loadResDir",
          value: function loadResDir(path, type, callback) {
          ...
          key: "preloadResDir",
          value: function preloadResDir(path, type) {
          ...
          key: "setFont",
          value: function setFont(target, path, onComplete) {
          ...
          key: "setSpine",
          value: function setSpine(target, path, onComplete) {
          ...
          key: "setSprite",
          value: function setSprite(target, path, onComplete) {
          ...
          key: "log",
          get: function get() {
            return window.console.log.bind(window.console, '%c %s %c %s ', 'background:#1e90ff; padding: 2px; border-radius: 5px 0 0 5px; border: 1px solid #1e90ff; color: #fff; font-weight: normal;', "[".concat(this._base_view_name, "] LOG ").concat(new Date().toLocaleString()), 'background:#ffffff; padding: 2px; border-radius: 0 5px 5px 0; border: 1px solid #1e90ff; color: #1e90ff; font-weight: normal;');
          }
        }, {
          key: "warn",
          get: function get() {
            return window.console.warn.bind(window.console, '%c %s %c %s ', 'background:#ff7f50; padding: 2px; border-radius: 5px 0 0 5px; border: 1px solid #ff7f50; color: #fff; font-weight: normal;', "[".concat(this._base_view_name, "] WARN ").concat(new Date().toLocaleString()), 'background:#ffffff; padding: 2px; border-radius: 0 5px 5px 0; border: 1px solid #ff7f50; color: #ff7f50; font-weight: normal;');
          }
        }, {
          key: "error",
          get: function get() {
            return window.console.error.bind(window.console, '%c %s %c %s ', 'background:#ff4757; padding: 2px; border-radius: 5px 0 0 5px; border: 1px solid #ff4757; color: #fff; font-weight: normal;', "[".concat(this._base_view_name, "] ERROR ").concat(new Date().toLocaleString()), 'background:#ffffff; padding: 2px; border-radius: 0 5px 5px 0; border: 1px solid #ff4757; color: #ff4757; font-weight: normal;');
          }
          ...
          */
          ...
          key: "beforeShow",
          value: function beforeShow(next, data) {
            next(null);
          }
          ...
          key: "beforeHide",
          value: function beforeHide(data) {
            return null;
          }
          ...
          function BindControl(Control) {
            return /*#__PURE__*/function (_BaseView) {
              _inherits(BindControl, _BaseView);
              var _super2 = _createSuper(BindControl);
              function BindControl() {
                _classCallCheck(this, BindControl);
          ...
          value: function BindController(Controller) {
            return /*#__PURE__*/function (_BaseView2) {
              _inherits(BindController, _BaseView2);
              var _super3 = _createSuper(BindController);
          ...
          key: "isViewValid",
          value: function isViewValid(next, data) {
            next && next(true);
          }
        }, {
          key: "isPage",
          value: function isPage(name) {
            return name.indexOf(ViewType.Page) === 0;
          }
        }, {
          key: "isPaper",
          value: function isPaper(name) {
            return name.indexOf(ViewType.Paper) === 0;
          }
        }, {
          key: "isPaperAll",
          value: function isPaperAll(name) {
            return name.indexOf(ViewType.PaperAll) === 0;
          }
        }, {
          key: "isPop",
          value: function isPop(name) {
            return name.indexOf(ViewType.Pop) === 0;
          }
        }, {
          key: "isTop",
          value: function isTop(name) {
            return name.indexOf(ViewType.Top) === 0;
          }
        }]);
        return BaseView;
      }(Component), _defineProperty(_class3, "_singleton", true), _class3), (_descriptor = _applyDecoratedDescriptor(_class2.prototype, "_hideEvent", [property], {
        configurable: true,
        enumerable: true,
        writable: true,
...
System.register("chunks:///_virtual/Core.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './debug.ts', './logger.ts', './storage.ts', './task.ts'], function (exports) {
  var _createClass, _defineProperty, _classCallCheck, cclegacy, EventTarget, js, debug, logger, storage, task;
  return {
    setters: [function (module) {
      _createClass = module.createClass;
      _defineProperty = module.defineProperty;
    ...
    execute: function () {
      ...
      var Core = exports('default', /*#__PURE__*/function () {
        ...
        _createClass(Core, [{
          key: "on",
          value: function on(event, callback, target) {
            if (EventMap[event]) callback.call(target);
            eventTarget.on(event, callback, target);
          }
        }, {
          key: "once",
          value: function once(event, callback, target) {
            if (EventMap[event]) {
          ...
          key: "off",
          value: function off(event, callback, target) {
      ...
      _defineProperty(Core, "EventType", EventType);
      _defineProperty(Core, "_inst", void 0);
      cclegacy._RF.pop();
    }
  };
});
...
System.register("chunks:///_virtual/debug-view-runtime-control.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc'], function (exports) {
  var _applyDecoratedDescriptor, _inherits, _createSuper, _classCallCheck, _initializerDefineProperty, _assertThisInitialized, _defineProperty, _createClass, cclegacy, _decorator, Node, Color, Canvas, UITransform, instantiate, Label, RichText, Toggle, Button, director, Component;
  return {
    setters: [function (module) {
      _applyDecoratedDescriptor = module.applyDecoratedDescriptor;
      _inherits = module.inherits;
    ...
    execute: function () {
      ...
      var DebugViewRuntimeControl = exports('DebugViewRuntimeControl', (_dec = ccclass('internal.DebugViewRuntimeControl'), _dec2 = property(Node), _dec3 = property(Node), _dec4 = property(Node), _dec(_class = (_class2 = /*#__PURE__*/function (_Component) {
        ...
        function DebugViewRuntimeControl() {
          ...
          _this = _super.call.apply(_super, [this].concat(args));
          _initializerDefineProperty(_assertThisInitialized(_this), "compositeModeToggle", _descriptor, _assertThisInitialized(_this));
          _initializerDefineProperty(_assertThisInitialized(_this), "singleModeToggle", _descriptor2, _assertThisInitialized(_this));
          _initializerDefineProperty(_assertThisInitialized(_this), "EnableAllCompositeModeButton", _descriptor3, _assertThisInitialized(_this));
          _defineProperty(_assertThisInitialized(_this), "_single", 0);
          _defineProperty(_assertThisInitialized(_this), "strSingle", ['No Single Debug', 'Vertex Color', 'Vertex Normal', 'Vertex Tangent', 'World Position', 'Vertex Mirror', 'Face Side', 'UV0', 'UV1', 'UV Lightmap', 'Project Depth', 'Linear Depth', 'Fragment Normal', 'Fragment Tangent', 'Fragment Binormal', 'Base Color', 'Diffuse Color', 'Specular Color', 'Transparency', 'Metallic', 'Roughness', 'Specular Intensity', 'IOR', 'Direct Diffuse', 'Direct Specular', 'Direct All', 'Env Diffuse', 'Env Specular', 'Env All', 'Emissive', 'Light Map', 'Shadow', 'AO', 'Fresnel', 'Direct Transmit Diffuse', 'Direct Transmit Specular', 'Env Transmit Diffuse', 'Env Transmit Specular', 'Transmit All', 'Direct Internal Specular', 'Env Internal Specular', 'Internal All', 'Fog']);
          _defineProperty(_assertThisInitialized(_this), "strComposite", ['Direct Diffuse', 'Direct Specular', 'Env Diffuse', 'Env Specular', 'Emissive', 'Light Map', 'Shadow', 'AO', 'Normal Map', 'Fog', 'Tone Mapping', 'Gamma Correction', 'Fresnel', 'Transmit Diffuse', 'Transmit Specular', 'Internal Specular', 'TT']);
          _defineProperty(_assertThisInitialized(_this), "strMisc", ['CSM Layer Coloration', 'Lighting With Albedo']);
          _defineProperty(_assertThisInitialized(_this), "compositeModeToggleList", []);
          _defineProperty(_assertThisInitialized(_this), "singleModeToggleList", []);
          _defineProperty(_assertThisInitialized(_this), "miscModeToggleList", []);
          _defineProperty(_assertThisInitialized(_this), "textComponentList", []);
          _defineProperty(_assertThisInitialized(_this), "labelComponentList", []);
          _defineProperty(_assertThisInitialized(_this), "textContentList", []);
          _defineProperty(_assertThisInitialized(_this), "hideButtonLabel", void 0);
          _defineProperty(_assertThisInitialized(_this), "_currentColorIndex", 0);
          _defineProperty(_assertThisInitialized(_this), "strColor", ['<color=#ffffff>', '<color=#000000>', '<color=#ff0000>', '<color=#00ff00>', '<color=#0000ff>']);
          _defineProperty(_assertThisInitialized(_this), "color", [Color.WHITE, Color.BLACK, Color.RED, Color.GREEN, Color.BLUE]);
          return _this;
        }
...
System.register("chunks:///_virtual/EventManager.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './BaseManager.ts'], function (exports) {
  var _inherits, _createSuper, _classCallCheck, _defineProperty, _assertThisInitialized, _createClass, cclegacy, _decorator, EventTarget, BaseManager;
  return {
    setters: [function (module) {
      _inherits = module.inherits;
      _createSuper = module.createSuper;
    ...
    execute: function () {
      ...
      var EventManager = exports('default', (_dec = ccclass('EventManager'), _dec(_class = /*#__PURE__*/function (_BaseManager) {
        _inherits(EventManager, _BaseManager);
        ...
        function EventManager() {
          ...
          _this = _super.call.apply(_super, [this].concat(args));
          _defineProperty(_assertThisInitialized(_this), "events", new Map());
          return _this;
        }
        _createClass(EventManager, [{
          ...
          key: "delete",
          value: function _delete(rootName) {
            return this.events["delete"](rootName);
          }
        }, {
          key: "get",
          value: function get(rootName) {
...
System.register("chunks:///_virtual/FrameAnimation.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './env'], function (exports) {
  var _applyDecoratedDescriptor, _defineProperty, _createClass, _classCallCheck, _initializerDefineProperty, _inherits, _createSuper, _assertThisInitialized, cclegacy, _decorator, Enum, SpriteFrame, Sprite, Component, EDITOR;
  return {
    setters: [function (module) {
      _applyDecoratedDescriptor = module.applyDecoratedDescriptor;
      _defineProperty = module.defineProperty;
    ...
    execute: function () {
      ...
      var FrameAnimationClip = exports('FrameAnimationClip', (_dec = ccclass('pkg:FrameAnimationClip'), _dec2 = property([SpriteFrame]), _dec(_class = (_class2 = /*#__PURE__*/_createClass(function FrameAnimationClip() {
        _classCallCheck(this, FrameAnimationClip);
      ...
      var FrameAnimation = exports('FrameAnimation', (_dec3 = ccclass('pkg:FrameAnimation'), _dec4 = requireComponent(Sprite), _dec5 = menu('pkg/FrameAnimation'), _dec6 = property([FrameAnimationClip]), _dec7 = property({
        ...
        _inherits(FrameAnimation, _Component);
        var _super = _createSuper(FrameAnimation);
        function FrameAnimation() {
          ...
          _this = _super.call.apply(_super, [this].concat(args));
          _initializerDefineProperty(_assertThisInitialized(_this), "clips", _descriptor4, _assertThisInitialized(_this));
          _initializerDefineProperty(_assertThisInitialized(_this), "_timeScale", _descriptor5, _assertThisInitialized(_this));
          _initializerDefineProperty(_assertThisInitialized(_this), "autoPlay", _descriptor6, _assertThisInitialized(_this));
          _initializerDefineProperty(_assertThisInitialized(_this), "_loop", _descriptor7, _assertThisInitialized(_this));
          _initializerDefineProperty(_assertThisInitialized(_this), "_animation", _descriptor8, _assertThisInitialized(_this));
          /**渲染组件 */
          _defineProperty(_assertThisInitialized(_this), "sprite", null);
          /**渲染下标 */
          _defineProperty(_assertThisInitialized(_this), "_renderIndex", 0);
          /**渲染等待时间 */
          _defineProperty(_assertThisInitialized(_this), "_renderDelayTime", 0);
          /**完成回调 */
          _defineProperty(_assertThisInitialized(_this), "_completeCallback", null);
          /**循环次数 */
          _defineProperty(_assertThisInitialized(_this), "_loopTimes", 0);
          /**已经完成的次数 */
          _defineProperty(_assertThisInitialized(_this), "_completeTimes", 0);
          /**是否正在播放 */
          _defineProperty(_assertThisInitialized(_this), "_playing", false);
          /**是否暂停了 */
          _defineProperty(_assertThisInitialized(_this), "_paused", false);
          /**是否播放完成自动销毁 */
          _defineProperty(_assertThisInitialized(_this), "_autoDestroy", false);
          return _this;
        }
        _createClass(FrameAnimation, [{
          ...
          key: "getClip",
          value: function getClip(animation) {
          ...
          key: "render",
          value: function render(clip, index) {
            if (!clip) {
          ...
          value: function play(animation) {
            ...
            if (!animation) return;
            // 设置播放速率
            this.timeScale = (_opts$timeScale = opts === null || opts === void 0 ? void 0 : opts.timeScale) !== null && _opts$timeScale !== void 0 ? _opts$timeScale : this.timeScale;
            // 设置自动销毁
            this._autoDestroy = (opts === null || opts === void 0 ? void 0 : opts.autoDestroy) || false;
            // 设置回调
            this._completeCallback = (opts === null || opts === void 0 ? void 0 : opts.onComplete) || null;
            // 设置循环次数
          ...
          key: "playOnce",
          value: function playOnce(animation, opts) {
          ...
          key: "playLoop",
          value: function playLoop(animation, opts) {
            this.play(animation, -1, opts);
          }
      ...
      }(Component), _defineProperty(_class6, "EventType", EventType), _class6), (_descriptor4 = _applyDecoratedDescriptor(_class5.prototype, "clips", [_dec6], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
...
System.register("chunks:///_virtual/ListItem.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './env'], function (exports) {
  var _applyDecoratedDescriptor, _inherits, _createSuper, _classCallCheck, _initializerDefineProperty, _assertThisInitialized, _defineProperty, _createClass, cclegacy, _decorator, Enum, Node, SpriteFrame, Sprite, Button, EventHandler, UITransform, tween, Vec3, Component, DEV;
  return {
    setters: [function (module) {
      _applyDecoratedDescriptor = module.applyDecoratedDescriptor;
      _inherits = module.inherits;
    ...
    execute: function () {
      ...
      var ListItem = exports('default', (_dec = ccclass('pkg:ListItem'), _dec2 = disallowMultiple(), _dec3 = menu('pkg/ListItem'), _dec4 = executionOrder(-5001), _dec5 = property({
        ...
        function ListItem() {
          ...
          _this = _super.call.apply(_super, [this].concat(args));
          //选择模式
          _initializerDefineProperty(_assertThisInitialized(_this), "selectedMode", _descriptor, _assertThisInitialized(_this));
          //被选标志
          _initializerDefineProperty(_assertThisInitialized(_this), "selectedNode", _descriptor2, _assertThisInitialized(_this));
          //被选择的SpriteFrame
          _initializerDefineProperty(_assertThisInitialized(_this), "selectedSpriteFrame", _descriptor3, _assertThisInitialized(_this));
          //未被选择的SpriteFrame
          _defineProperty(_assertThisInitialized(_this), "_unselectedSpriteFrame", null);
          //自适应尺寸
          _initializerDefineProperty(_assertThisInitialized(_this), "adaptiveSize", _descriptor4, _assertThisInitialized(_this));
          //选择
        ...
        _createClass(ListItem, [{
          ...
          key: "createEvt",
          value: function createEvt(component, handlerName) {
          ...
          key: "showAni",
          value: function showAni(aniType, callFunc, del) {
            var t = this;
            var twe;
...
System.register("chunks:///_virtual/ListView.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './env', './ListItem.ts'], function (exports) {
  var _applyDecoratedDescriptor, _inherits, _createSuper, _classCallCheck, _initializerDefineProperty, _assertThisInitialized, _defineProperty, _createClass, cclegacy, _decorator, ScrollView, Enum, Node, Prefab, CCFloat, EventHandler, CCBoolean, CCInteger, Layout, isValid, UITransform, instantiate, NodePool, Vec3, Size, Widget, tween, Component, DEV, ListItem;
  return {
    setters: [function (module) {
      _applyDecoratedDescriptor = module.applyDecoratedDescriptor;
      _inherits = module.inherits;
    ...
    execute: function () {
      ...
      var ListView = exports('default', (_dec = ccclass('pkg:ListView'), _dec2 = disallowMultiple(), _dec3 = menu('pkg/ListView'), _dec4 = requireComponent(ScrollView), _dec5 = executionOrder(-5000), _dec6 = property({
        ...
        function ListView() {
          ...
          _this = _super.call.apply(_super, [this].concat(args));
          //模板类型
          _initializerDefineProperty(_assertThisInitialized(_this), "templateType", _descriptor, _assertThisInitialized(_this));
          //模板Item（Node）
          _initializerDefineProperty(_assertThisInitialized(_this), "tmpNode", _descriptor2, _assertThisInitialized(_this));
          //模板Item（Prefab）
          _initializerDefineProperty(_assertThisInitialized(_this), "tmpPrefab", _descriptor3, _assertThisInitialized(_this));
          //滑动模式
          _initializerDefineProperty(_assertThisInitialized(_this), "_slideMode", _descriptor4, _assertThisInitialized(_this));
          //翻页作用距离
          _initializerDefineProperty(_assertThisInitialized(_this), "pageDistance", _descriptor5, _assertThisInitialized(_this));
          //页面改变事件
          _initializerDefineProperty(_assertThisInitialized(_this), "pageChangeEvent", _descriptor6, _assertThisInitialized(_this));
          //是否为虚拟列表（动态列表）
          _initializerDefineProperty(_assertThisInitialized(_this), "_virtual", _descriptor7, _assertThisInitialized(_this));
          //是否为循环列表
          _initializerDefineProperty(_assertThisInitialized(_this), "cyclic", _descriptor8, _assertThisInitialized(_this));
          //缺省居中
          _initializerDefineProperty(_assertThisInitialized(_this), "lackCenter", _descriptor9, _assertThisInitialized(_this));
          //缺省可滑动
          _initializerDefineProperty(_assertThisInitialized(_this), "lackSlide", _descriptor10, _assertThisInitialized(_this));
          //刷新频率
          _initializerDefineProperty(_assertThisInitialized(_this), "_updateRate", _descriptor11, _assertThisInitialized(_this));
          //分帧渲染（每帧渲染的Item数量（<=0时关闭分帧渲染））
          _initializerDefineProperty(_assertThisInitialized(_this), "frameByFrameRenderNum", _descriptor12, _assertThisInitialized(_this));
          //渲染事件（渲染器）
          _initializerDefineProperty(_assertThisInitialized(_this), "renderEvent", _descriptor13, _assertThisInitialized(_this));
          //选择模式
          _initializerDefineProperty(_assertThisInitialized(_this), "selectedMode", _descriptor14, _assertThisInitialized(_this));
          //触发选择事件
          _initializerDefineProperty(_assertThisInitialized(_this), "selectedEvent", _descriptor15, _assertThisInitialized(_this));
          _initializerDefineProperty(_assertThisInitialized(_this), "repeatEventSingle", _descriptor16, _assertThisInitialized(_this));
          _initializerDefineProperty(_assertThisInitialized(_this), "multSelectedMaxNum", _descriptor17, _assertThisInitialized(_this));
          //当前选择id
          _defineProperty(_assertThisInitialized(_this), "_selectedId", -1);
          _defineProperty(_assertThisInitialized(_this), "_lastSelectedId", void 0);
          _defineProperty(_assertThisInitialized(_this), "multSelected", void 0);
          _defineProperty(_assertThisInitialized(_this), "_forceUpdate", false);
          _defineProperty(_assertThisInitialized(_this), "_align", void 0);
          _defineProperty(_assertThisInitialized(_this), "_horizontalDir", void 0);
          _defineProperty(_assertThisInitialized(_this), "_verticalDir", void 0);
          _defineProperty(_assertThisInitialized(_this), "_startAxis", void 0);
          _defineProperty(_assertThisInitialized(_this), "_alignCalcType", void 0);
          _defineProperty(_assertThisInitialized(_this), "content", void 0);
          _defineProperty(_assertThisInitialized(_this), "_contentUt", void 0);
          _defineProperty(_assertThisInitialized(_this), "firstListId", void 0);
          _defineProperty(_assertThisInitialized(_this), "displayItemNum", void 0);
          _defineProperty(_assertThisInitialized(_this), "_updateDone", true);
          _defineProperty(_assertThisInitialized(_this), "_updateCounter", void 0);
          _defineProperty(_assertThisInitialized(_this), "_actualCount", void 0);
          _defineProperty(_assertThisInitialized(_this), "_cyclicNum", void 0);
          _defineProperty(_assertThisInitialized(_this), "_cyclicPos1", void 0);
          _defineProperty(_assertThisInitialized(_this), "_cyclicPos2", void 0);
          //列表数量
          _initializerDefineProperty(_assertThisInitialized(_this), "_count", _descriptor18, _assertThisInitialized(_this));
          ...
          _defineProperty(_assertThisInitialized(_this), "_resizeMode", void 0);
          _defineProperty(_assertThisInitialized(_this), "_topGap", void 0);
          _defineProperty(_assertThisInitialized(_this), "_rightGap", void 0);
          _defineProperty(_assertThisInitialized(_this), "_bottomGap", void 0);
          _defineProperty(_assertThisInitialized(_this), "_leftGap", void 0);
          _defineProperty(_assertThisInitialized(_this), "_columnGap", void 0);
          _defineProperty(_assertThisInitialized(_this), "_lineGap", void 0);
          _defineProperty(_assertThisInitialized(_this), "_colLineNum", void 0);
          _defineProperty(_assertThisInitialized(_this), "_lastDisplayData", void 0);
          _defineProperty(_assertThisInitialized(_this), "displayData", void 0);
          _defineProperty(_assertThisInitialized(_this), "_pool", void 0);
          _defineProperty(_assertThisInitialized(_this), "_itemTmp", void 0);
          _defineProperty(_assertThisInitialized(_this), "_itemTmpUt", void 0);
          _defineProperty(_assertThisInitialized(_this), "_needUpdateWidget", false);
          _defineProperty(_assertThisInitialized(_this), "_itemSize", void 0);
          _defineProperty(_assertThisInitialized(_this), "_sizeType", void 0);
          _defineProperty(_assertThisInitialized(_this), "_customSize", void 0);
          _defineProperty(_assertThisInitialized(_this), "frameCount", void 0);
          _defineProperty(_assertThisInitialized(_this), "_aniDelRuning", false);
          _defineProperty(_assertThisInitialized(_this), "_aniDelCB", void 0);
          _defineProperty(_assertThisInitialized(_this), "_aniDelItem", void 0);
          _defineProperty(_assertThisInitialized(_this), "_aniDelBeforePos", void 0);
          _defineProperty(_assertThisInitialized(_this), "_aniDelBeforeScale", void 0);
          _defineProperty(_assertThisInitialized(_this), "viewTop", void 0);
          _defineProperty(_assertThisInitialized(_this), "viewRight", void 0);
          _defineProperty(_assertThisInitialized(_this), "viewBottom", void 0);
          _defineProperty(_assertThisInitialized(_this), "viewLeft", void 0);
          _defineProperty(_assertThisInitialized(_this), "_doneAfterUpdate", false);
          _defineProperty(_assertThisInitialized(_this), "elasticTop", void 0);
          _defineProperty(_assertThisInitialized(_this), "elasticRight", void 0);
          _defineProperty(_assertThisInitialized(_this), "elasticBottom", void 0);
          _defineProperty(_assertThisInitialized(_this), "elasticLeft", void 0);
          _defineProperty(_assertThisInitialized(_this), "scrollToListId", void 0);
          _defineProperty(_assertThisInitialized(_this), "adhering", false);
          _defineProperty(_assertThisInitialized(_this), "_adheringBarrier", false);
          _defineProperty(_assertThisInitialized(_this), "nearestListId", void 0);
          _defineProperty(_assertThisInitialized(_this), "curPageNum", 0);
          _defineProperty(_assertThisInitialized(_this), "_beganPos", void 0);
          _defineProperty(_assertThisInitialized(_this), "_scrollPos", void 0);
          _defineProperty(_assertThisInitialized(_this), "_curScrollIsTouch", void 0);
          //当前滑动是否为手动
          _defineProperty(_assertThisInitialized(_this), "_scrollToListId", void 0);
          _defineProperty(_assertThisInitialized(_this), "_scrollToEndTime", void 0);
          _defineProperty(_assertThisInitialized(_this), "_scrollToSo", void 0);
          _defineProperty(_assertThisInitialized(_this), "_lack", void 0);
          _defineProperty(_assertThisInitialized(_this), "_allItemSize", void 0);
          _defineProperty(_assertThisInitialized(_this), "_allItemSizeNoEdge", void 0);
          _defineProperty(_assertThisInitialized(_this), "_scrollItem", void 0);
          //当前控制 ScrollView 滚动的 Item
          _defineProperty(_assertThisInitialized(_this), "_thisNodeUt", void 0);
          return _this;
        }
        _createClass(ListView, [{
          ...
          key: "setTemplateItem",
          value: function setTemplateItem(item) {
            if (!item) return;
            var t = this;
            t._itemTmp = item;
          ...
          key: "_calcItemPos",
          value: function _calcItemPos(id) {
          ...
          key: "_calcExistItemPos",
          value: function _calcExistItemPos(id) {
          ...
          key: "_getFixedSize",
          value: function _getFixedSize(listId) {
          ...
          key: "_onScrollBegan",
          value: function _onScrollBegan() {
            this._beganPos = this._sizeType ? this.viewTop : this.viewLeft;
          }
          //滚动结束时..
        }, {
          key: "_onScrollEnded",
          value: function _onScrollEnded() {
            var t = this;
          ...
          key: "_onTouchStart",
          value: function _onTouchStart(ev, captureListeners) {
          ...
          value: function _onTouchCancelled(ev, captureListeners) {
            var t = this;
          ...
          key: "_onItemAdaptive",
          value: function _onItemAdaptive(item) {
            var ut = item.getComponent(UITransform);
          ...
          value: function update() {
            ...
            if (this._virtual) {
              ...
              if (this._updateCounter < this._count) {
                ...
                for (var _n2 = this._updateCounter; _n2 < _len2; _n2++) {
          ...
          key: "_createOrUpdateItem",
          value: function _createOrUpdateItem(data) {
          ...
          key: "_createOrUpdateItem2",
          value: function _createOrUpdateItem2(listId) {
          ...
          key: "_updateListItem",
          value: function _updateListItem(listItem) {
            if (!listItem) return;
          ...
          key: "_resetItemSize",
          value: function _resetItemSize(item) {
            return;
          }
          /**
           * 更新Item位置
          ...
          key: "_updateItemPos",
          value: function _updateItemPos(listIdOrItem) {
          ...
          key: "setMultSelected",
          value: function setMultSelected(args, bool) {
            var t = this;
            if (!t.checkInited()) return;
          ...
          key: "getMultSelected",
          value: function getMultSelected() {
          ...
          key: "hasMultSelected",
          value: function hasMultSelected(listId) {
          ...
          key: "updateItem",
          value: function updateItem(args) {
          ...
          key: "getItemByListId",
          value: function getItemByListId(listId) {
            if (this.content) {
          ...
          key: "_getOutsideItem",
          value: function _getOutsideItem() {
            var item;
            var result = [];
            for (var n = this.content.children.length - 1; n >= 0; n--) {
          ...
          key: "_delRedundantItem",
          value: function _delRedundantItem() {
            if (this._virtual) {
          ...
          key: "_delSingleItem",
          value: function _delSingleItem(item) {
          ...
          key: "aniDelItem",
          value: function aniDelItem(listId, callFunc, aniType) {
            var t = this;
          ...
          key: "scrollTo",
          value: function scrollTo(listId) {
            var timeInSecond = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 0.5;
            var offset = arguments.length > 2 && arguments[2] !== undefined ? arguments[2] : null;
            var overStress = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : false;
            var t = this;
            if (!t.checkInited(false)) return;
          ...
          key: "_calcNearestItem",
          value: function _calcNearestItem() {
            var t = this;
          ...
          value: function prePage() {
            var timeInSecond = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 0.5;
            // cc.log('👈');
            if (!this.checkInited()) return;
          ...
          key: "skipPage",
          value: function skipPage(pageNum, timeInSecond) {
            var t = this;
            if (!t.checkInited()) return;
          ...
          key: "calcCustomSize",
          value: function calcCustomSize(count) {
            var t = this;
            if (!t.checkInited()) return;
...
System.register("chunks:///_virtual/LoaderManager.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './BaseManager.ts'], function (exports) {
  var _inherits, _createSuper, _classCallCheck, _createClass, _objectSpread2, cclegacy, _decorator, SceneAsset, assetManager, Asset, Font, isValid, sp, SpriteFrame, BaseManager;
  return {
    setters: [function (module) {
      _inherits = module.inherits;
      _createSuper = module.createSuper;
    ...
    execute: function () {
      ...
      var LoaderManager = exports('default', (_dec = ccclass('LoaderManager'), _dec(_class = /*#__PURE__*/function (_BaseManager) {
        _inherits(LoaderManager, _BaseManager);
        var _super = _createSuper(LoaderManager);
        ...
        _createClass(LoaderManager, [{
          key: "handle",
          value: function handle(_handle, _ref) {
            var _this = this;
            ...
            if (!path) {
              this.error("".concat(_handle, " fail. path is empty"));
              return _onComplete && _onComplete(null);
            }
            ...
            args.push(function (err, res) {
              if (err) {
                _this.error("".concat(_handle, " \"").concat(path, "\" fail"), err);
          ...
          key: "preloadDir",
          value: function preloadDir(params) {
          ...
          key: "loadAsync",
          value: function loadAsync(params) {
            var _this2 = this;
            return new Promise(function (resolve) {
              _this2.load(_objectSpread2(_objectSpread2({}, params), {}, {
                onComplete: resolve
              }));
            });
          }
          ...
          key: "loadDirAsync",
          value: function loadDirAsync(params) {
            var _this3 = this;
            return new Promise(function (resolve) {
              _this3.loadDir(_objectSpread2(_objectSpread2({}, params), {}, {
                onComplete: resolve
              }));
            });
          }
          ...
          value: function release(_ref2) {
            ...
            var path = _ref2.path,
              ...
              type = _ref2.type;
            if (!bundle) bundle = 'resources';
            (_assetManager$getBund = assetManager.getBundle(bundle)) === null || _assetManager$getBund === void 0 || _assetManager$getBund.release(path, type);
          }
          ...
          key: "releaseAll",
          value: function releaseAll(bundle) {
            if (!bundle) bundle = 'resources';
          ...
          key: "releaseUnused",
          value: function releaseUnused(bundle) {
            var _assetManager$getBund2;
            if (!bundle) bundle = 'resources';
            //@ts-ignore
            (_assetManager$getBund2 = assetManager.getBundle(bundle)) === null || _assetManager$getBund2 === void 0 || _assetManager$getBund2.releaseUnusedAssets();
          }
          ...
          key: "loadBundle",
          value: function loadBundle(_ref3) {
          ...
          key: "loadBundleAsync",
          value: function loadBundleAsync(params) {
            var _this4 = this;
            return new Promise(function (resolve) {
              _this4.loadBundle(_objectSpread2(_objectSpread2({}, params), {}, {
                onComplete: resolve
              }));
            });
          }
          ...
          key: "removeBundle",
          value: function removeBundle(bundle) {
            if (!bundle) bundle = 'resources';
          ...
          key: "loadRemote",
          value: function loadRemote(_ref4) {
            var _this5 = this;
            var url = _ref4.url,
              ext = _ref4.ext,
            ...
            if (ext) {
              assetManager.loadRemote(url, {
                ...
                if (error) {
                  _this5.error("loadRemote ".concat(url, " fail"));
          ...
          key: "loadRemoteAsync",
          value: function loadRemoteAsync(params) {
            var _this6 = this;
            return new Promise(function (resolve) {
              _this6.loadRemote(_objectSpread2(_objectSpread2({}, params), {}, {
                onComplete: resolve
              }));
            });
          }
          ...
          key: "setSpine",
          value: function setSpine(params) {
            this.load({
              path: params.path,
              bundle: params.bundle,
          ...
          key: "setSprite",
          value: function setSprite(params) {
            this.load({
              path: params.path,
              bundle: params.bundle,
              type: SpriteFrame,
    ...
    execute: function () {
      ...
      var Logger = /*#__PURE__*/function () {
        ...
        _createClass(Logger, [{
           ...
           */
          function get() {
            return window.console.log.bind(window.console, '%c %s %c %s ', 'background:#6495ed; padding: 2px; border-radius: 5px 0 0 5px; border: 1px solid #6495ed; color: #000; font-weight: normal;', "[LOG] ".concat(new Date().toLocaleString()), 'background:#ffffff ; padding: 2px; border-radius: 0 5px 5px 0; border: 1px solid #6495ed; color: #6495ed; font-weight: normal;');
          }
          ...
          key: "warn",
          get: function get() {
            return window.console.warn.bind(window.console, '%c %s %c %s ', 'background:#ff7f50; padding: 2px; border-radius: 5px 0 0 5px; border: 1px solid #ff7f50; color: #000; font-weight: normal;', "[WARN] ".concat(new Date().toLocaleString()), 'background:#ffffff ; padding: 2px; border-radius: 0 5px 5px 0; border: 1px solid #ff7f50; color: #ff7f50; font-weight: normal;');
          }
          ...
          key: "error",
          get: function get() {
            return window.console.error.bind(window.console, '%c %s %c %s ', 'background:#ff4757; padding: 2px; border-radius: 5px 0 0 5px; border: 1px solid #ff4757; color: #000; font-weight: normal;', "[ERROR] ".concat(new Date().toLocaleString()), 'background:#ffffff ; padding: 2px; border-radius: 0 5px 5px 0; border: 1px solid #ff4757; color: #ff4757; font-weight: normal;');
          }
          ...
          key: "debug",
          get: function get() {
            return window.console.log.bind(window.console, '%c %s %c %s ', 'background:#ff6347; padding: 2px; border-radius: 5px 0 0 5px; border: 1px solid #ff6347; color: #000; font-weight: normal;', "[DEBUG] ".concat(new Date().toLocaleString()), 'background:#ffffff ; padding: 2px; border-radius: 0 5px 5px 0; border: 1px solid #ff6347; color: #ff6347; font-weight: normal;');
          }
          ...
          key: "success",
          get: function get() {
            return window.console.log.bind(window.console, '%c %s %c %s ', 'background:#00ae9d; padding: 2px; border-radius: 5px 0 0 5px; border: 1px solid #00ae9d; color: #000; font-weight: normal;', "[SUCC] ".concat(new Date().toLocaleString()), 'background:#ffffff ; padding: 2px; border-radius: 0 5px 5px 0; border: 1px solid #00ae9d; color: #00ae9d; font-weight: normal;');
          }
        }]);
        return Logger;
      }();
...
System.register("chunks:///_virtual/Rocker.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc'], function (exports) {
  var _defineProperty, _applyDecoratedDescriptor, _inherits, _createSuper, _classCallCheck, _initializerDefineProperty, _assertThisInitialized, _createClass, cclegacy, _decorator, UITransform, Enum, Node, v3, math, Component;
  return {
    setters: [function (module) {
      _defineProperty = module.defineProperty;
      _applyDecoratedDescriptor = module.applyDecoratedDescriptor;
    ...
    execute: function () {
      ...
      var Rocker = exports('Rocker', (_dec = ccclass('pkg:Rocker'), _dec2 = menu('pkg/Rocker'), _dec3 = requireComponent(UITransform), _dec4 = property({
        ...
        _inherits(Rocker, _Component);
        var _super = _createSuper(Rocker);
        function Rocker() {
          var _this;
          _classCallCheck(this, Rocker);
          for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
            args[_key] = arguments[_key];
          }
          _this = _super.call.apply(_super, [this].concat(args));
          _initializerDefineProperty(_assertThisInitialized(_this), "type", _descriptor, _assertThisInitialized(_this));
          _initializerDefineProperty(_assertThisInitialized(_this), "pedestal", _descriptor2, _assertThisInitialized(_this));
          _initializerDefineProperty(_assertThisInitialized(_this), "joystick", _descriptor3, _assertThisInitialized(_this));
          _initializerDefineProperty(_assertThisInitialized(_this), "radius", _descriptor4, _assertThisInitialized(_this));
          _initializerDefineProperty(_assertThisInitialized(_this), "autoHide", _descriptor5, _assertThisInitialized(_this));
          return _this;
        }
        _createClass(Rocker, [{
          key: "show",
        ...
        return Rocker;
      }(Component), _defineProperty(_class3, "Type", RockerType), _defineProperty(_class3, "EventType", RockerEventType), _class3), (_descriptor = _applyDecoratedDescriptor(_class2.prototype, "type", [_dec4], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
...
System.register("chunks:///_virtual/SoundManager.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './Core.ts', './BaseManager.ts', './AudioEngine.ts'], function (exports) {
  var _defineProperty, _inherits, _createSuper, _classCallCheck, _assertThisInitialized, _createClass, _get, _getPrototypeOf, _asyncToGenerator, _objectSpread2, _regeneratorRuntime, cclegacy, _decorator, AudioClip, game, Game, isValid, Button, sys, Core, BaseManager, AudioEngine;
  return {
    setters: [function (module) {
      _defineProperty = module.defineProperty;
      _inherits = module.inherits;
    ...
    execute: function () {
      ...
      var SoundManager = exports('default', (_dec = ccclass('SoundManager'), _dec(_class = (_class2 = /*#__PURE__*/function (_BaseManager) {
        _inherits(SoundManager, _BaseManager);
        var _super = _createSuper(SoundManager);
        function SoundManager() {
          ...
          _this = _super.call.apply(_super, [this].concat(args));
          _defineProperty(_assertThisInitialized(_this), "musicMuteCacheKey", 'musicMute');
          _defineProperty(_assertThisInitialized(_this), "effectMuteCacheKey", 'effectMute');
          _defineProperty(_assertThisInitialized(_this), "musicVolumeScaleCacheKey", 'musicVolumeScale');
          _defineProperty(_assertThisInitialized(_this), "effectVolumeScaleCacheKey", 'effectVolumeScale');
          _defineProperty(_assertThisInitialized(_this), "defaultMusicName", '');
          _defineProperty(_assertThisInitialized(_this), "defaultMusicVolume", 1);
          _defineProperty(_assertThisInitialized(_this), "defaultEffectName", '');
          _defineProperty(_assertThisInitialized(_this), "defaultEffectVolume", 1);
          _defineProperty(_assertThisInitialized(_this), "audioCache", {});
          _defineProperty(_assertThisInitialized(_this), "effectInterval", {});
          _defineProperty(_assertThisInitialized(_this), "playingMusic", {
            uuid: '',
            id: -1,
            name: '',
            volume: 1,
        ...
        _createClass(SoundManager, [{
          ...
          value: function init(finish) {
            ...
            _get(_getPrototypeOf(SoundManager.prototype), "init", this).call(this, finish);

            // 预加载
            (_setting$preload = setting.preload) === null || _setting$preload === void 0 || _setting$preload.forEach(function (path) {
          ...
          key: "preload",
          value: function preload(soundPath, complete) {
            if (!soundPath) {
          ...
          key: "release",
          value: function release(soundPath) {
            if (soundPath.indexOf('effect') !== 0 && soundPath.indexOf('music') !== 0) {
              this.error("release ".concat(soundPath, " fail"));
              return;
            }
          ...
          key: "playDefaultMusic",
          value: function playDefaultMusic(onPlay) {
          ...
          key: "playDefaultEffect",
          value: function playDefaultEffect(onPlay) {
          ...
          key: "setButtonEffect",
          value: function setButtonEffect(target, name, opts) {
            if (name) {
              var _ref = opts || {},
          ...
          value: function (_playEffect) {
            ...
            this.load(name, function (audioClip) {
              ...
              if (!audioClip) {
                _this3.error("playEffect ".concat(name, " \u4E0D\u5B58\u5728\u6216\u52A0\u8F7D\u5931\u8D25"));
                onError && onError();
                return;
              }
              if (interval > 0) {
          ...
          key: "playEffectAsync",
          value: function (_playEffectAsync) {
              ...
              while (1) switch (_context.prev = _context.next) {
                case 0:
                  ...
                  return _context.abrupt("return", new Promise(function (resolve) {
                    _this4.playEffect(_objectSpread2(_objectSpread2({}, params), {}, {
          ...
          value: function (_playMusic) {
            ...
            this.load(name, function (audioClip) {
              ...
              // 不存在
              if (!audioClip) {
                _this5.error("playMusic ".concat(name, " \u4E0D\u5B58\u5728\u6216\u52A0\u8F7D\u5931\u8D25"));
                onError && onError();
                return;
              }
              // 静音
          ...
          key: "playMusicAsync",
          value: function (_playMusicAsync) {
            ...
            return new Promise(function (resolve) {
              _this6.playMusic(_objectSpread2(_objectSpread2({}, params), {}, {
          ...
          key: "replayMusic",
          value: function replayMusic(onPlay) {
          ...
          key: "setEffectMute",
          value: function setEffectMute(mute) {
            var isCache = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
          ...
          key: "setEffectVolumeScale",
          value: function setEffectVolumeScale(scale) {
            var isCache = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
        ...
        return SoundManager;
      }(BaseManager), _defineProperty(_class2, "setting", {}), _defineProperty(_class2, "MusicName", MusicName), _defineProperty(_class2, "EffectName", EffectName), _class2)) || _class));
      cclegacy._RF.pop();
    }
  };
});

System.register("chunks:///_virtual/storage.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc'], function (exports) {
  var _createClass, _classCallCheck, _defineProperty, cclegacy, sys, log, error, js;
  return {
    setters: [function (module) {
      _createClass = module.createClass;
      _classCallCheck = module.classCallCheck;
    ...
    execute: function () {
      ...
      var Storage = /*#__PURE__*/function () {
        function Storage() {
           ...
           * - 如果需要加密内容，请设置密钥的值
           */
          _defineProperty(this, "secretKey", '');
        }
        _createClass(Storage, [{
          ...
          key: "setWeek",
          value: function setWeek(key, value, cb) {
          ...
          key: "setDay",
          value: function setDay(key, value, cb) {
    ...
    execute: function () {
      ...
      var Sync = /*#__PURE__*/function () {
        function Sync() {
          ...
          _defineProperty(this, "finish", null);
          /**
        ...
        _createClass(Sync, [{
          ...
          key: "next",
          value: function next(index, data) {
            if (!this.running) {
              return false;
            }
      ...
      var Any = /*#__PURE__*/function () {
        function Any() {
          ...
          _defineProperty(this, "task", new Sync());
        }
        _createClass(Any, [{
          key: "results",
          get:
      ...
      var task = exports('default', {
         ...
         * 执行单个任务
         */
        execute: function execute(fun) {
          var retryMax = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : -1;
          var retryFinish = arguments.length > 2 ? arguments[2] : undefined;
          fun(function retry() {
            var timeout = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : 0;
...
System.register("chunks:///_virtual/TimerManager.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './BaseManager.ts'], function (exports) {
  var _inherits, _createSuper, _classCallCheck, _defineProperty, _assertThisInitialized, _createClass, _slicedToArray, cclegacy, _decorator, Component, BaseManager;
  return {
    setters: [function (module) {
      _inherits = module.inherits;
      _createSuper = module.createSuper;
    ...
    execute: function () {
      ...
      var Time = /*#__PURE__*/function () {
        function Time(time, callback, target) {
          ...
          _defineProperty(this, "_beginHour", 0);
          _defineProperty(this, "_beginMinute", 0);
          _defineProperty(this, "_beginSecond", 0);
          _defineProperty(this, "_endHour", 0);
          _defineProperty(this, "_endMinute", 0);
          _defineProperty(this, "_endSecond", 0);
          _defineProperty(this, "checkCallback", 0);
          _defineProperty(this, "callback", null);
          _defineProperty(this, "target", null);
          this.callback = callback;
          this.target = target;
          var _time$split = time.split('-'),
            ...
            time0 = _time$split2[0],
            time1 = _time$split2[1];
      ...
      var Timer = /*#__PURE__*/function (_Component) {
        ...
        function Timer() {
          ...
          _this = _super.call.apply(_super, [this].concat(args));
          _defineProperty(_assertThisInitialized(_this), "times", []);
          return _this;
        }
        _createClass(Timer, [{
          key: "registerDailyTrigger",
          value: function registerDailyTrigger(time, callback, target) {
            this.times.push(new Time(time, callback, target));
          }
        }, {
          key: "unregisterDailyTrigger",
          value: function unregisterDailyTrigger(callback) {
      ...
      var TimerManager = exports('default', (_dec = ccclass('TimerManager'), _dec(_class3 = /*#__PURE__*/function (_BaseManager) {
        _inherits(TimerManager, _BaseManager);
        var _super2 = _createSuper(TimerManager);
        function TimerManager() {
          ...
          _defineProperty(_assertThisInitialized(_this2), "timers", new Map());
          return _this2;
        }
...
System.register("chunks:///_virtual/UIManager.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './Core.ts', './BaseManager.ts', './BaseView.ts', './UIMgrLoading.ts', './UIMgrShade.ts', './UIMgrToast.ts', './UIMgrZOrder.ts'], function (exports) {
  var _defineProperty, _applyDecoratedDescriptor, _inherits, _createSuper, _classCallCheck, _initializerDefineProperty, _assertThisInitialized, _createClass, _get, _getPrototypeOf, _slicedToArray, _objectSpread2, cclegacy, _decorator, Node, Prefab, Canvas, find, Camera, director, instantiate, settings, Settings, size, screen, Layers, UITransform, Widget, Scene, js, isValid, SceneAsset, ResolutionPolicy, view, Core, BaseManager, ViewType, BaseView, UIMgrLoading, UIMgrShade, UIMgrToast, UIMgrZOrder;
  return {
    setters: [function (module) {
      _defineProperty = module.defineProperty;
      _applyDecoratedDescriptor = module.applyDecoratedDescriptor;
    ...
    execute: function () {
      ...
      var UIManager = exports('default', (_dec = ccclass('UIManager'), _dec2 = property({
        ...
        _inherits(UIManager, _BaseManager);
        ...
        function UIManager() {
          ...
          _this = _super.call.apply(_super, [this].concat(args));
          _initializerDefineProperty(_assertThisInitialized(_this), "loadingPre", _descriptor, _assertThisInitialized(_this));
          _initializerDefineProperty(_assertThisInitialized(_this), "shadePre", _descriptor2, _assertThisInitialized(_this));
          _initializerDefineProperty(_assertThisInitialized(_this), "toastPre", _descriptor3, _assertThisInitialized(_this));
          // 2D根节点
          _defineProperty(_assertThisInitialized(_this), "Root2D", null);
          // UI根节点
          _defineProperty(_assertThisInitialized(_this), "UserInterface", null);
          // 加载和遮罩节点
          _defineProperty(_assertThisInitialized(_this), "loading", null);
          _defineProperty(_assertThisInitialized(_this), "shade", null);
          _defineProperty(_assertThisInitialized(_this), "toast", null);
          _defineProperty(_assertThisInitialized(_this), "defaultUI", null);
          _defineProperty(_assertThisInitialized(_this), "defaultData", '');
          _defineProperty(_assertThisInitialized(_this), "currScene", '');
          _defineProperty(_assertThisInitialized(_this), "currPage", null);
          _defineProperty(_assertThisInitialized(_this), "currFocus", null);
          // 预制体缓存
          _defineProperty(_assertThisInitialized(_this), "prefabCache", {});
          _defineProperty(_assertThisInitialized(_this), "sceneCache", {});
          // 全局触摸有效
          _defineProperty(_assertThisInitialized(_this), "touchEnabled", true);
          // 记录触摸屏蔽
          _defineProperty(_assertThisInitialized(_this), "touchMaskMap", new Map());
          // 记录展示加载
          _defineProperty(_assertThisInitialized(_this), "showLoadingMap", new Map());
          // 记录正在加载中的有效的ui
          _defineProperty(_assertThisInitialized(_this), "uiLoadingMap", new Map());
          // 记录正在展示中的有效的ui
          _defineProperty(_assertThisInitialized(_this), "uiShowingMap", new Map());
          _defineProperty(_assertThisInitialized(_this), "showQueue", []);
          return _this;
        }
        _createClass(UIManager, [{
          ...
          value: function init(finish) {
            ...
            _get(_getPrototypeOf(UIManager.prototype), "init", this).call(this, finish);

            // 预加载,符合AnyTask规则
            if ((_setting$preload = setting.preload) !== null && _setting$preload !== void 0 && _setting$preload.length) {
          ...
          key: "addTouchMaskListener",
          value: function addTouchMaskListener() {
          ...
          key: "removeTouchMaskListener",
          value: function removeTouchMaskListener() {
            if (!this.touchEnabled) return;
            if (this.touchMaskMap.size > 0) return;
            for (var i = 0; i < BlockEvents.length; i++) {
          ...
          key: "getBaseView",
          value: function getBaseView(node) {
            if (!node) return null;
          ...
          key: "getViewInParents",
          value: function getViewInParents(target) {
            var node = target;
            var com = null;
          ...
          key: "getViewInChildren",
          value: function getViewInChildren(target) {
          ...
          key: "getUIClass",
          value: function getUIClass(name) {
          ...
          key: "getUIPrefix",
          value: function getUIPrefix(name) {
            ...
            this.error('getUIPrefix', "".concat(name));
          }
          ...
          key: "getUIParent",
          value: function getUIParent(name) {
            ...
            this.error('getUIParent', "\u627E\u4E0D\u5230".concat(name, "\u5BF9\u5E94\u7684Parent"));
            return null;
          }
          ...
          key: "getUIInScene",
          value: function getUIInScene(name) {
          ...
          key: "getUIInShowing",
          value: function getUIInShowing(name) {
            var multiple = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
            if (multiple) {
              var _result3 = [];
          ...
          key: "getNativeBundleName",
          value: function getNativeBundleName(uiName) {
            // 兼容旧版本
            var oldBundleName = "app-view_".concat(uiName);
            var projectBundles = settings.querySettings(Settings.Category.ASSETS, 'projectBundles');
          ...
          key: "getResBundleName",
          value: function getResBundleName(uiName) {
            // 兼容旧版本
            var oldBundleName = "app-view_".concat(uiName, "_Res");
            var projectBundles = settings.querySettings(Settings.Category.ASSETS, 'projectBundles');
            if (projectBundles && projectBundles.indexOf(oldBundleName) >= 0) {
              return oldBundleName;
            }
            return "".concat(BaseManager.stringCaseNegate(uiName), "-res");
          }
          ...
          key: "initBundle",
          value: function initBundle(name, onFinish) {
            var _this4 = this;
          ...
          key: "installUI",
          value: function installUI(name, complete, progress) {
            var _this5 = this;
          ...
          key: "uninstallUI",
          value: function uninstallUI(name) {
            if (this.sceneCache[name]) {
              // 释放引用计数
          ...
          key: "loadRes",
          value: function loadRes(target, path, type, callback) {
          ...
          key: "preloadRes",
          value: function preloadRes(target, path, type) {
            if (typeof target === 'string') {
              Core.inst.manager.loader.preload({
                bundle: this.getResBundleName(target),
                path: path,
          ...
          key: "loadResDir",
          value: function loadResDir(target, path, type, callback) {
            if (typeof target === 'string') {
          ...
          key: "preloadResDir",
          value: function preloadResDir(target, path, type) {
            if (typeof target === 'string') {
          ...
          key: "preload",
          value: function preload(name, complete) {
            var _this6 = this;
            // 验证name是否为真
            if (!name) {
              this.error('preload', 'fail');
          ...
          key: "release",
          value: function release(nameOrCom) {
            var _this7 = this;
            var uiName = '';
            ...
            if (!uiName) {
              this.error('release', "".concat(nameOrCom, " fail"));
              return;
            }
            ...
            if (typeof nameOrCom === 'string') {
              ...
              _nodes.forEach(function (node) {
                ...
                {
                  if (_this7.getBaseView(node).isShow) _this7.warn('release', "".concat(uiName, "\u6B63\u5904\u4E8Eshow\u72B6\u6001, \u6B64\u5904\u5C06\u76F4\u63A5destroy"));
                }
                node.parent = null;
                node.destroy();
              });
            ...
            // 传入节点或组件是释放单个
              ...
              if (node && isValid(node, true)) {
                {
                  if (this.getBaseView(node).isShow) this.warn('release', "".concat(uiName, "\u6B63\u5904\u4E8Eshow\u72B6\u6001, \u6B64\u5904\u5C06\u76F4\u63A5destroy"));
                }
                node.parent = null;
                node.destroy();
              }
          ...
          key: "checkUIValid",
          value: function checkUIValid(name, data, callback) {
            var _this8 = this;
            this.installUI(name, function (result) {
          ...
          key: "parsingPrefab",
          value: function parsingPrefab(prefab, name) {
            var _node$getComponent;
            if (!prefab) return null;
            var node = instantiate(prefab);
            node.active = false;
            if (node.name !== name) {
              this.warn('parsingPrefab', "\u8282\u70B9\u540D\u4E0EUI\u540D\u4E0D\u4E00\u81F4, \u5DF2\u91CD\u7F6E\u4E3AUI\u540D: ".concat(this.getUIPath(name)));
              node.name = name;
            }
            node.parent = this.getUIParent(name);
            (_node$getComponent = node.getComponent(Widget)) === null || _node$getComponent === void 0 || _node$getComponent.updateAlignment();
            return node;
          }
          ...
          key: "parsingScene",
          value: function parsingScene(asset, name) {
            if (!asset || !asset.scene) return null;
            if (asset.scene.name !== name) {
              this.warn('parsingScene', "\u573A\u666F\u540D\u4E0EUI\u540D\u4E0D\u4E00\u81F4, \u5DF2\u91CD\u7F6E\u4E3AUI\u540D: ".concat(this.getUIPath(name)));
              asset.scene.name = name;
            }
            var view = this.getViewInChildren(asset.scene);
            if (!view) {
              this.error('parsingScene', "\u89E3\u6790\u573A\u666F\u65F6\u672A\u67E5\u8BE2\u5230\u6839\u8282\u70B9\u5B58\u5728BaseView: ".concat(this.getUIPath(name)));
              return null;
            }
            view.node.active = false;
            if (view.node.name !== name) {
              this.warn('parsingScene', "\u8282\u70B9\u540D\u4E0EUI\u540D\u4E0D\u4E00\u81F4, \u5DF2\u91CD\u7F6E\u4E3AUI\u540D: ".concat(this.getUIPath(name)));
              view.node.name = name;
            }
            return view.node;
          }
        }, {
          key: "addUILoadingUuid",
          value: function addUILoadingUuid(name) {
            var uuid = this.createUUID();
          ...
          key: "removeUILoadingUuid",
          value: function removeUILoadingUuid(name, uuid) {
          ...
          key: "createUI",
          value: function createUI(name, silent, callback) {
            var _this9 = this;
            // 添加触摸屏蔽
          ...
          key: "showDefault",
          value: function showDefault(onShow) {
            if (this.defaultUI) {
              this.show({
                name: this.defaultUI,
          ...
          key: "putInShowQueue",
          value: function putInShowQueue(data) {
          ...
          key: "consumeShowQueue",
          value: function consumeShowQueue() {
            var _this10 = this;
          ...
          value: function showUI(params) {
            ...
            this.createUI(name, silent, function (node, scene) {
              if (!node) {
                _this11.error('show', "".concat(name, " \u4E0D\u5B58\u5728\u6216\u52A0\u8F7D\u5931\u8D25"));
                // 「没有指定onError」或「onError返回true」会自动发起重试
                if (onError && onError("".concat(name, " \u4E0D\u5B58\u5728\u6216\u52A0\u8F7D\u5931\u8D25"), UIManager.ErrorCode.LoadError) !== true) {
                  return;
                }
                ...
                if (error) {
                  ...
                  if (scene) {
                    ...
                    director.runSceneImmediate(_scene, null, function () {
                      _this11.log("\u5207\u6362\u573A\u666F: ".concat(UIScene));
                    });
                  }
                }
              });
          ...
          key: "show",
          value: function show(params // @ts-ignore
          ) {
            var _this12 = this;
            var name = params.name,
              data = params.data,
            ...
            Core.inst.lib.task.execute(function (retry) {
              _this12.checkUIValid(name, data, function (valid) {
                // 加载失败
                if (valid === -1) {
                  _this12.error('show', "".concat(name, " \u4E0D\u5B58\u5728\u6216\u52A0\u8F7D\u5931\u8D25"));
                  // 「没有指定onError」或「onError返回true」会自动发起重试
                  if (onError && onError("".concat(name, " \u4E0D\u5B58\u5728\u6216\u52A0\u8F7D\u5931\u8D25"), UIManager.ErrorCode.LoadError) !== true) {
                ...
                // ui无效
                if (valid === 0) {
                  _this12.warn('show', "".concat(name, " \u65E0\u6548"));
                  _this12.uninstallUI(name);
                  onError && onError("".concat(name, " \u65E0\u6548"), UIManager.ErrorCode.InvalidError);
          ...
          key: "showAsync",
          value: function showAsync(params // @ts-ignore
          ) {
            var _this13 = this;
            return new Promise(function (resolve) {
              _this13.show(_objectSpread2(_objectSpread2({}, params), {}, {
                onHide: function onHide(result) {
                  resolve(result);
                }
              }));
          ...
          key: "pop",
          value: function pop(_ref4 // @ts-ignore
          ) {
            var name = _ref4.name,
              data = _ref4.data,
              onHide = _ref4.onHide;
          ...
          key: "shift",
          value: function shift(_ref5 // @ts-ignore
          ) {
            var name = _ref5.name,
              data = _ref5.data,
              onHide = _ref5.onHide;
            ...
            this.warn('shift', "".concat(name, " \u4E0D\u5B58\u5728"));
          }
          ...
          key: "hideLoading",
          value: function hideLoading(uuid) {
            if (!uuid) return;
          ...
          key: "removeTouchMask",
          value: function removeTouchMask(uuid) {
            if (!uuid) return;
          ...
          key: "showToast",
          value: function showToast(message, timeout) {
            if (!this.toast) {
          ...
          key: "setTouchEnabled",
          value: function setTouchEnabled(enabled) {
            if (enabled) {
          ...
          key: "onUserInterface",
          value: function onUserInterface() {
            for (var _len2 = arguments.length, args = new Array(_len2), _key2 = 0; _key2 < _len2; _key2++) {
              args[_key2] = arguments[_key2];
            }
          ...
          key: "onceUserInterface",
          value: function onceUserInterface() {
            for (var _len3 = arguments.length, args = new Array(_len3), _key3 = 0; _key3 < _len3; _key3++) {
              args[_key3] = arguments[_key3];
            }
          ...
          key: "offUserInterface",
          value: function offUserInterface() {
            for (var _len4 = arguments.length, args = new Array(_len4), _key4 = 0; _key4 < _len4; _key4++) {
              args[_key4] = arguments[_key4];
            }
          ...
          key: "targetOffUserInterface",
          value: function targetOffUserInterface() {
            for (var _len5 = arguments.length, args = new Array(_len5), _key5 = 0; _key5 < _len5; _key5++) {
              args[_key5] = arguments[_key5];
            }
          ...
          key: "targetOffUIRoot2D",
          value: function targetOffUIRoot2D() {
          ...
          key: "sortUserInterface",
          value: function sortUserInterface(name) {
            var _this$UserInterface;
            (_this$UserInterface = this.UserInterface) === null || _this$UserInterface === void 0 || (_this$UserInterface = _this$UserInterface.getChildByName(name)) === null || _this$UserInterface === void 0 || (_this$UserInterface = _this$UserInterface.getComponent(UIMgrZOrder)) === null || _this$UserInterface === void 0 || _this$UserInterface.updateZOrder();
          }
        }]);
        return UIManager;
      }(BaseManager), _defineProperty(_class3, "setting", {}), _defineProperty(_class3, "ErrorCode", ErrorCode), _defineProperty(_class3, "ViewName", ViewName), _defineProperty(_class3, "MiniViewName", MiniViewName), _class3), (_descriptor = _applyDecoratedDescriptor(_class2.prototype, "loadingPre", [_dec2], {
        configurable: true,
        enumerable: true,
        writable: true,
        initializer: function initializer() {
...
System.register("chunks:///_virtual/UIMgrLoading.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc'], function (exports) {
  var _applyDecoratedDescriptor, _inherits, _createSuper, _classCallCheck, _initializerDefineProperty, _assertThisInitialized, _defineProperty, _createClass, cclegacy, _decorator, Graphics, UITransform, Component;
  return {
    setters: [function (module) {
      _applyDecoratedDescriptor = module.applyDecoratedDescriptor;
      _inherits = module.inherits;
    ...
    execute: function () {
      ...
      var UIMgrLoading = exports('default', (_dec = ccclass('UIMgrLoading'), _dec2 = requireComponent(Graphics), _dec3 = requireComponent(UITransform), _dec4 = property({
        ...
        _inherits(UIMgrLoading, _Component);
        var _super = _createSuper(UIMgrLoading);
        function UIMgrLoading() {
          var _this;
          _classCallCheck(this, UIMgrLoading);
          for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
            args[_key] = arguments[_key];
          }
          _this = _super.call.apply(_super, [this].concat(args));
          _initializerDefineProperty(_assertThisInitialized(_this), "delay", _descriptor, _assertThisInitialized(_this));
          _defineProperty(_assertThisInitialized(_this), "progress", 0);
          _defineProperty(_assertThisInitialized(_this), "ringScale", 1);
          _defineProperty(_assertThisInitialized(_this), "reverse", false);
          _defineProperty(_assertThisInitialized(_this), "angleSpeed", 120);
          _defineProperty(_assertThisInitialized(_this), "ringSpeed", 0.02);
          _defineProperty(_assertThisInitialized(_this), "inited", false);
          _defineProperty(_assertThisInitialized(_this), "drawing", false);
          _defineProperty(_assertThisInitialized(_this), "timedown", 0);
          return _this;
        }
        _createClass(UIMgrLoading, [{
          key: "init",
          value: function init() {
...
System.register("chunks:///_virtual/UIMgrShade.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc'], function (exports) {
  var _applyDecoratedDescriptor, _inherits, _createSuper, _classCallCheck, _initializerDefineProperty, _assertThisInitialized, _defineProperty, _createClass, cclegacy, _decorator, UIOpacity, Component;
  return {
    setters: [function (module) {
      _applyDecoratedDescriptor = module.applyDecoratedDescriptor;
      _inherits = module.inherits;
    ...
    execute: function () {
      ...
      var UIMgrShade = exports('default', (_dec = ccclass('UIMgrShade'), _dec2 = requireComponent(UIOpacity), _dec(_class = _dec2(_class = (_class2 = /*#__PURE__*/function (_Component) {
        _inherits(UIMgrShade, _Component);
        var _super = _createSuper(UIMgrShade);
        function UIMgrShade() {
          var _this;
          _classCallCheck(this, UIMgrShade);
          for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
            args[_key] = arguments[_key];
          }
          _this = _super.call.apply(_super, [this].concat(args));
          _initializerDefineProperty(_assertThisInitialized(_this), "_delay", _descriptor, _assertThisInitialized(_this));
          _initializerDefineProperty(_assertThisInitialized(_this), "_begin", _descriptor2, _assertThisInitialized(_this));
          _initializerDefineProperty(_assertThisInitialized(_this), "_end", _descriptor3, _assertThisInitialized(_this));
          _initializerDefineProperty(_assertThisInitialized(_this), "_speed", _descriptor4, _assertThisInitialized(_this));
          _defineProperty(_assertThisInitialized(_this), "inited", false);
          _defineProperty(_assertThisInitialized(_this), "drawing", false);
          _defineProperty(_assertThisInitialized(_this), "timedown", 0);
          return _this;
        ...
        _createClass(UIMgrShade, [{
          ...
          key: "init",
          value: function init(delay, begin, end, speed) {
            this.delay = delay;
            this.begin = begin;
            this.end = end;
            this.speed = speed;
...
System.register("chunks:///_virtual/UIMgrToast.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './UIMgrToastCell.ts'], function (exports) {
  var _applyDecoratedDescriptor, _inherits, _createSuper, _classCallCheck, _initializerDefineProperty, _assertThisInitialized, _defineProperty, _createClass, cclegacy, _decorator, UITransform, Prefab, NodePool, instantiate, UIOpacity, tween, Tween, view, Component, UIMgrToastCell;
  return {
    setters: [function (module) {
      _applyDecoratedDescriptor = module.applyDecoratedDescriptor;
      _inherits = module.inherits;
    ...
    execute: function () {
      ...
      var UIMgrToast = exports('default', (_dec = ccclass('UIMgrToast'), _dec2 = requireComponent(UITransform), _dec3 = property(Prefab), _dec(_class = _dec2(_class = (_class2 = /*#__PURE__*/function (_Component) {
        _inherits(UIMgrToast, _Component);
        var _super = _createSuper(UIMgrToast);
        function UIMgrToast() {
          var _this;
          _classCallCheck(this, UIMgrToast);
          for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
            args[_key] = arguments[_key];
          }
          _this = _super.call.apply(_super, [this].concat(args));
          _initializerDefineProperty(_assertThisInitialized(_this), "cell", _descriptor, _assertThisInitialized(_this));
          /**每条信息显示几秒 */
          _defineProperty(_assertThisInitialized(_this), "lifeTime", 2);
          /**消失时花费几秒渐隐 */
          _defineProperty(_assertThisInitialized(_this), "outTime", 0.2);
          /**挤压基础速度 */
          _defineProperty(_assertThisInitialized(_this), "squeezeSpeed", 200);
          /**节点缓存池子 */
          _defineProperty(_assertThisInitialized(_this), "pool", new NodePool());
          return _this;
        }
...
System.register("chunks:///_virtual/UIMgrToastCell.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc'], function (exports) {
  var _applyDecoratedDescriptor, _inherits, _createSuper, _classCallCheck, _initializerDefineProperty, _assertThisInitialized, _createClass, cclegacy, _decorator, UIOpacity, UITransform, Label, Component;
  return {
    setters: [function (module) {
      _applyDecoratedDescriptor = module.applyDecoratedDescriptor;
      _inherits = module.inherits;
    ...
    execute: function () {
      ...
      var UIMgrToastCell = exports('default', (_dec = ccclass('UIMgrToastCell'), _dec2 = requireComponent(UIOpacity), _dec3 = requireComponent(UITransform), _dec4 = property(Label), _dec(_class = _dec2(_class = _dec3(_class = (_class2 = /*#__PURE__*/function (_Component) {
        _inherits(UIMgrToastCell, _Component);
        var _super = _createSuper(UIMgrToastCell);
        function UIMgrToastCell() {
          var _this;
          _classCallCheck(this, UIMgrToastCell);
          for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
            args[_key] = arguments[_key];
          }
          _this = _super.call.apply(_super, [this].concat(args));
        ...
        _createClass(UIMgrToastCell, [{
          key: "init",
          value: function init(title) {
            if (title.split('\n').find(function (v) {
              return v.length > 30;
            })) {
...
System.register("chunks:///_virtual/UIMgrZOrder.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc'], function (exports) {
  var _inherits, _createSuper, _classCallCheck, _defineProperty, _assertThisInitialized, _createClass, cclegacy, _decorator, Node, director, Director, Component;
  return {
    setters: [function (module) {
      _inherits = module.inherits;
      _createSuper = module.createSuper;
    ...
    execute: function () {
      ...
      var UIMgrZOrder = exports('default', (_dec = ccclass('UIMgrZOrder'), _dec(_class = /*#__PURE__*/function (_Component) {
        _inherits(UIMgrZOrder, _Component);
        var _super = _createSuper(UIMgrZOrder);
        function UIMgrZOrder() {
          var _this;
          _classCallCheck(this, UIMgrZOrder);
          for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
            args[_key] = arguments[_key];
          }
          _this = _super.call.apply(_super, [this].concat(args));
          _defineProperty(_assertThisInitialized(_this), "zOrder", false);
          _defineProperty(_assertThisInitialized(_this), "tempArr", []);
          return _this;
        }
        _createClass(UIMgrZOrder, [{
          key: "onLoad",
          value: function onLoad() {
          ...
          key: "onChildRemoveed",
          value: function onChildRemoveed(child) {
            child.off(Node.EventType.TRANSFORM_CHANGED, this.checkUpdateZOrder, this);
          }
        }, {
          key: "checkUpdateZOrder",
          value: function checkUpdateZOrder() {
