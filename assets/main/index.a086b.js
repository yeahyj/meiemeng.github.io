...
System.register("chunks:///_virtual/AppInit.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './BaseAppInit.ts', './app.ts', './Core.ts'], function (exports) {
  var _applyDecoratedDescriptor, _inheritsLoose, _initializerDefineProperty, _assertThisInitialized, cclegacy, _decorator, Node, UIOpacity, tween, settings, Settings, assetManager, BaseAppInit, app, Core;
  return {
    setters: [function (module) {
    ...
    execute: function () {
      ...
      var AppInit = exports('AppInit', (_dec = ccclass('AppInit'), _dec2 = property(Node), _dec(_class = (_class2 = /*#__PURE__*/function (_BaseAppInit) {
        ...
        function AppInit() {
          ...
          _this.AdminBundleName = 'app-admin';
          _this.ModelBundleName = 'app-model';
          _this.ControlBundleName = 'app-control';
          _this.ControllerBundleName = 'app-controller';
          _this.ManagerBundleName = 'app-manager';
          _this.DotReWriteFuncs = ['startInit', 'nextInit'];
          return _this;
        }
        ...
        _proto.initData = function initData() {
          ...
          Core.inst.lib.task.createAny().add([function (next, retry) {
            ...
            if (projectBundles.indexOf(_this2.ModelBundleName) === -1) return next();
            assetManager.loadBundle(_this2.ModelBundleName, function (err) {
              if (err) return retry(0.1);
              next();
            });
          }, function (next, retry) {
            if (projectBundles.indexOf(_this2.ControllerBundleName) === -1) return next();
            assetManager.loadBundle(_this2.ControllerBundleName, function (err) {
              if (err) return retry(0.1);
              next();
            });
          }, function (next, retry) {
...
System.register("chunks:///_virtual/cc-comp-frame-animation.ts", ['cc', './index.ts', './FrameAnimation.ts'], function (exports) {
  var cclegacy;
  return {
    setters: [function (module) {
      cclegacy = module.cclegacy;
...
System.register("chunks:///_virtual/cc-comp-list-view.ts", ['cc', './index2.ts', './ListView.ts', './ListItem.ts'], function (exports) {
  var cclegacy;
  return {
    setters: [function (module) {
      cclegacy = module.cclegacy;
...
System.register("chunks:///_virtual/index.ts", ['cc', './FrameAnimation.ts'], function (exports) {
  var cclegacy;
  return {
    setters: [function (module) {
      cclegacy = module.cclegacy;
...
System.register("chunks:///_virtual/index2.ts", ['cc', './ListView.ts', './ListItem.ts'], function (exports) {
  var cclegacy;
  return {
    setters: [function (module) {
      cclegacy = module.cclegacy;
...
System.register("chunks:///_virtual/main", ['./debug-view-runtime-control.ts', './AppInit.ts', './app.ts', './handle.ts', './setting.ts', './cc-comp-list-view.ts', './cc-comp-frame-animation.ts', './cc-ctrl-rocker.ts', './Core.ts', './BaseAppInit.ts', './BaseControl.ts', './BaseController.ts', './BaseManager.ts', './BaseModel.ts', './BaseView.ts', './debug.ts', './logger.ts', './storage.ts', './task.ts', './EventManager.ts', './LoaderManager.ts', './Audio.ts', './AudioEngine.ts', './AudioManager.ts', './SoundManager.ts', './TimerManager.ts', './UIManager.ts', './UIMgrLoading.ts', './UIMgrShade.ts', './UIMgrToast.ts', './UIMgrToastCell.ts', './UIMgrZOrder.ts', './ListItem.ts', './ListView.ts', './index2.ts', './FrameAnimation.ts', './index.ts', './Rocker.ts', './index3.ts'], function () {
  return {
