System.register("chunks:///_virtual/AfterDeathMarkerComp.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './ECS.ts', './DeathComp.ts'], function (exports) {
  var _inherits, _createSuper, _classCallCheck, _defineProperty, _assertThisInitialized, _createClass, cclegacy, ecs, DeathComp;
  return {
    ...
    execute: function () {
      ...
      var AfterDeathMarkerComp = exports('AfterDeathMarkerComp', (_dec = ecs.register('AfterDeathMarkerComp'), _dec(_class = /*#__PURE__*/function (_ecs$Comp) {
        _inherits(AfterDeathMarkerComp, _ecs$Comp);
        var _super = _createSuper(AfterDeathMarkerComp);
        function AfterDeathMarkerComp() {
          var _this;
          _classCallCheck(this, AfterDeathMarkerComp);
          for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
            args[_key] = arguments[_key];
          }
          _this = _super.call.apply(_super, [this].concat(args));
          //当前时间
          _defineProperty(_assertThisInitialized(_this), "curTime", 5);
          return _this;
        }
        _createClass(AfterDeathMarkerComp, [{
          key: "reset",
      ...
      var AfterDeathMarkerSystem = exports('AfterDeathMarkerSystem', /*#__PURE__*/function (_ecs$ComblockSystem) {
        _inherits(AfterDeathMarkerSystem, _ecs$ComblockSystem);
        var _super2 = _createSuper(AfterDeathMarkerSystem);
        function AfterDeathMarkerSystem() {
          _classCallCheck(this, AfterDeathMarkerSystem);
          return _super2.call(this);
        }
        _createClass(AfterDeathMarkerSystem, [{
          key: "filter",
...
System.register("chunks:///_virtual/AtkDetectorComp.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './Object.ts', './ECS.ts', './FactionTypeComp.ts', './Collider.ts', './Shape.ts', './ConstType.ts', './StateMachineComp.ts', './DeathComp.ts', './BaseUnit.ts', './AfterDeathMarkerComp.ts'], function (exports) {
  var _defineProperty, _inherits, _createSuper, _classCallCheck, _assertThisInitialized, _createClass, _get, _getPrototypeOf, cclegacy, _decorator, PhysicsSystem, Vec3, Dirty, cObject, ecs, FactionTypeComp, cCollider, ShapeType, EntityType, RoleStateMachineType, StateMachineComp, DeathComp, BaaseUnit, AfterDeathMarkerComp;
  return {
    setters: [function (module) {
      _defineProperty = module.defineProperty;
      _inherits = module.inherits;
    ...
    execute: function () {
      ...
      var AtkDetectorComp = exports('AtkDetectorComp', (_dec = ccclass('AtkDetectorComp'), _dec2 = ecs.register('AtkDetectorComp', false), _dec(_class = _dec2(_class = (_class2 = /*#__PURE__*/function (_cObject) {
        _inherits(AtkDetectorComp, _cObject);
        var _super = _createSuper(AtkDetectorComp);
        function AtkDetectorComp() {
          var _this;
          _classCallCheck(this, AtkDetectorComp);
          for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
            args[_key] = arguments[_key];
          }
          _this = _super.call.apply(_super, [this].concat(args));
          _defineProperty(_assertThisInitialized(_this), "pursueRadius", 500);
          _defineProperty(_assertThisInitialized(_this), "attackRadius", 300);
          _defineProperty(_assertThisInitialized(_this), "canRecycle", void 0);
          _defineProperty(_assertThisInitialized(_this), "ent", void 0);
          return _this;
        }
        _createClass(AtkDetectorComp, [{
          key: "onLoad",
          value: function onLoad() {
            this.type = ShapeType.Sphere;
            this.radius = this.pursueRadius;
            _get(_getPrototypeOf(AtkDetectorComp.prototype), "onLoad", this).call(this);
          }
        }, {
          key: "start",
          ...
          value: function onTriggerEnter(b) {
            _get(_getPrototypeOf(AtkDetectorComp.prototype), "onTriggerEnter", this).call(this, b);
            //找到了可以攻击的目标
          }
          ...
          value: function onTriggerStay(b) {
            _get(_getPrototypeOf(AtkDetectorComp.prototype), "onTriggerStay", this).call(this, b);
          ...
          value: function onTriggerExit(b) {
            _get(_getPrototypeOf(AtkDetectorComp.prototype), "onTriggerExit", this).call(this, b);
          }

          //加入碰撞
        }, {
          key: "addCollider",
          value: function addCollider() {
      ...
      }(cObject), _defineProperty(_class2, "tid", -1), _defineProperty(_class2, "compName", void 0), _class2)) || _class) || _class));
      cclegacy._RF.pop();
    }
  };
});
...
System.register("chunks:///_virtual/AutoCastComp.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './ECS.ts', './WeaponCastMarkerComp.ts'], function (exports) {
  var _inherits, _createSuper, _classCallCheck, _createClass, cclegacy, ecs, WeaponCastMarkerComp;
  return {
    setters: [function (module) {
      _inherits = module.inherits;
      _createSuper = module.createSuper;
    ...
    execute: function () {
      ...
      var AutoCastComp = exports('AutoCastComp', (_dec = ecs.register('AutoCastComp'), _dec(_class = /*#__PURE__*/function (_ecs$Comp) {
        _inherits(AutoCastComp, _ecs$Comp);
        var _super = _createSuper(AutoCastComp);
        function AutoCastComp() {
          _classCallCheck(this, AutoCastComp);
          return _super.apply(this, arguments);
        }
        _createClass(AutoCastComp, [{
          key: "reset",
          value: function reset() {}
        }]);
        return AutoCastComp;
      ...
      var AutoCastSystem = exports('AutoCastSystem', /*#__PURE__*/function (_ecs$ComblockSystem) {
        _inherits(AutoCastSystem, _ecs$ComblockSystem);
        var _super2 = _createSuper(AutoCastSystem);
        function AutoCastSystem() {
          _classCallCheck(this, AutoCastSystem);
          return _super2.call(this);
        }
        _createClass(AutoCastSystem, [{
          key: "filter",
          value: function filter() {
...
System.register("chunks:///_virtual/BaseEntity.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './ECS.ts', './UnitComp.ts'], function (exports) {
  var _inherits, _createSuper, _classCallCheck, _createClass, _get, _getPrototypeOf, cclegacy, ecs, UnitComp;
  return {
    setters: [function (module) {
      _inherits = module.inherits;
      _createSuper = module.createSuper;
    ...
    execute: function () {
      ...
      var BaseEntity = exports('BaseEntity', /*#__PURE__*/function (_ecs$Entity) {
        _inherits(BaseEntity, _ecs$Entity);
        var _super = _createSuper(BaseEntity);
        function BaseEntity() {
        ...
        _createClass(BaseEntity, [{
          ...
          value: function destroy() {
            var _this$get;
            // 销毁实体时，清理节点
            (_this$get = this.get(UnitComp)) === null || _this$get === void 0 || (_this$get = _this$get.unit) === null || _this$get === void 0 || (_this$get = _this$get.node) === null || _this$get === void 0 || _this$get.destroy();
            _get(_getPrototypeOf(BaseEntity.prototype), "destroy", this).call(this);
          }
        }]);
        return BaseEntity;
      }(ecs.Entity));
...
System.register("chunks:///_virtual/BaseSkillComp.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './ECS.ts'], function (exports) {
  var _inherits, _createSuper, _classCallCheck, _defineProperty, _assertThisInitialized, _createClass, cclegacy, ecs;
  return {
    setters: [function (module) {
      _inherits = module.inherits;
      _createSuper = module.createSuper;
    ...
    execute: function () {
      ...
      var BaseSkillComp = exports('BaseSkillComp', /*#__PURE__*/function (_ecs$Comp) {
        _inherits(BaseSkillComp, _ecs$Comp);
        var _super = _createSuper(BaseSkillComp);
        function BaseSkillComp() {
          var _this;
          _classCallCheck(this, BaseSkillComp);
          for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
            args[_key] = arguments[_key];
          }
          _this = _super.call.apply(_super, [this].concat(args));
          _defineProperty(_assertThisInitialized(_this), "skillId", 0);
          _defineProperty(_assertThisInitialized(_this), "weaponManager", null);
          _defineProperty(_assertThisInitialized(_this), "skillPlugin", []);
          _defineProperty(_assertThisInitialized(_this), "modifyPlugin", []);
          //额外组件
          _defineProperty(_assertThisInitialized(_this), "extraModifyPlugin", []);
          _defineProperty(_assertThisInitialized(_this), "lv", 1);
          return _this;
        }
        _createClass(BaseSkillComp, [{
          key: "reset",
          value: function reset() {}
        }, {
          key: "init",
...
System.register("chunks:///_virtual/BaseUnit.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './Object.ts', './Collider.ts'], function (exports) {
  var _inherits, _createSuper, _classCallCheck, _defineProperty, _assertThisInitialized, _createClass, _get, _getPrototypeOf, cclegacy, _decorator, cObject, cCollider;
  return {
    setters: [function (module) {
      _inherits = module.inherits;
      _createSuper = module.createSuper;
    ...
    execute: function () {
      ...
      var BaaseUnit = exports('BaaseUnit', /*#__PURE__*/function (_cObject) {
        _inherits(BaaseUnit, _cObject);
        var _super = _createSuper(BaaseUnit);
        function BaaseUnit() {
          var _this;
          _classCallCheck(this, BaaseUnit);
          for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
            args[_key] = arguments[_key];
          }
          _this = _super.call.apply(_super, [this].concat(args));
        ...
        _createClass(BaaseUnit, [{
          key: "onLoad",
          value: function onLoad() {
            _get(_getPrototypeOf(BaaseUnit.prototype), "onLoad", this).call(this);
          }
          ...
          key: "removeCollision",
          value: function removeCollision() {
...
System.register("chunks:///_virtual/BattleUtil.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './app.ts', './MapModelComp.ts', './PositionComp.ts', './FactionTypeComp.ts', './ConstType.ts', './EnabledComp.ts', './DamageFlyText.ts', './RoleConfig.ts'], function (exports) {
  var _createClass, _classCallCheck, _typeof, _createForOfIteratorHelper, _defineProperty, cclegacy, Vec3, instantiate, app, MapModelComp, PositionComp, FactionTypeComp, FactionType, AttributeType, MapLayersType, EnabledComp, DamageFlyText, DB_RoleConfig;
  return {
    setters: [function (module) {
      _createClass = module.createClass;
      _classCallCheck = module.classCallCheck;
    ...
    execute: function () {
      ...
      var BattleUtil = exports('default', /*#__PURE__*/function () {
        function BattleUtil() {
          _classCallCheck(this, BattleUtil);
        }
        _createClass(BattleUtil, null, [{
          key: "randomPointInMap",
          value: /**地图里面随机取一个点 */
          ...
          key: "randomPointAroundPlayer",
          value: function randomPointAroundPlayer(radius) {
          ...
          key: "getNearestEnemy",
          value: function getNearestEnemy(role) {
          ...
          key: "getNearestEnemyByPos",
          value: function getNearestEnemyByPos(pos, faction) {
          ...
          key: "getEnemyFaction",
          value: function getEnemyFaction(faction) {
          ...
          key: "randomSelectWithProbability",
          value: function randomSelectWithProbability(arr) {
            if (arr.length === 0) {
              return null;
            }
          ...
          key: "getRoleAttribute",
          value: function getRoleAttribute(roleId, lv, difficulty) {
            var _ref;
            var roleConfig = DB_RoleConfig[roleId];
            var upgradeLv = lv - 1;
            return _ref = {}, _defineProperty(_ref, AttributeType.hp, (roleConfig[AttributeType.hp] + upgradeLv * roleConfig.upgradeAttribute[AttributeType.hp]) * difficulty), _defineProperty(_ref, AttributeType.hpRecover, (roleConfig[AttributeType.hpRecover] + upgradeLv * roleConfig.upgradeAttribute[AttributeType.hpRecover]) * difficulty), _defineProperty(_ref, AttributeType.atk, (roleConfig[AttributeType.atk] + upgradeLv * roleConfig.upgradeAttribute[AttributeType.atk]) * difficulty), _defineProperty(_ref, AttributeType.atkSpeed, roleConfig[AttributeType.atkSpeed] + upgradeLv * roleConfig.upgradeAttribute[AttributeType.atkSpeed]), _defineProperty(_ref, AttributeType.speed, roleConfig[AttributeType.speed] + upgradeLv * roleConfig.upgradeAttribute[AttributeType.speed]), _defineProperty(_ref, AttributeType.crit, roleConfig[AttributeType.crit] + upgradeLv * roleConfig.upgradeAttribute[AttributeType.crit]), _defineProperty(_ref, AttributeType.critDamage, roleConfig[AttributeType.critDamage] + upgradeLv * roleConfig.upgradeAttribute[AttributeType.critDamage]), _defineProperty(_ref, AttributeType.cdReduce, roleConfig[AttributeType.cdReduce] + upgradeLv * roleConfig.upgradeAttribute[AttributeType.cdReduce]), _defineProperty(_ref, AttributeType.reflectDamage, 100), _ref;
          }
          ...
          key: "createDamageFlyText",
          value: function createDamageFlyText(value, startPos) {
...
System.register("chunks:///_virtual/BerforeDeathMarkerComp.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './ECS.ts', './UnitComp.ts', './AfterDeathMarkerComp.ts'], function (exports) {
  var _inherits, _createSuper, _classCallCheck, _defineProperty, _assertThisInitialized, _createClass, cclegacy, ecs, UnitComp, AfterDeathMarkerComp;
  return {
    setters: [function (module) {
      _inherits = module.inherits;
      _createSuper = module.createSuper;
    ...
    execute: function () {
      ...
      var BerforeDeathMarkerComp = exports('BerforeDeathMarkerComp', (_dec = ecs.register('BerforeDeathMarkerComp'), _dec(_class = /*#__PURE__*/function (_ecs$Comp) {
        _inherits(BerforeDeathMarkerComp, _ecs$Comp);
        var _super = _createSuper(BerforeDeathMarkerComp);
        function BerforeDeathMarkerComp() {
          var _this;
          _classCallCheck(this, BerforeDeathMarkerComp);
          for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
            args[_key] = arguments[_key];
          }
          _this = _super.call.apply(_super, [this].concat(args));
          /**逻辑结束帧 */
          _defineProperty(_assertThisInitialized(_this), "frame", 1);
          return _this;
        }
        _createClass(BerforeDeathMarkerComp, [{
          key: "reset",
          value: function reset() {
            this.frame = 1;
          }
      ...
      var BerforeDeathMarkerSystem = exports('BerforeDeathMarkerSystem', /*#__PURE__*/function (_ref) {
        _inherits(BerforeDeathMarkerSystem, _ref);
        var _super2 = _createSuper(BerforeDeathMarkerSystem);
        function BerforeDeathMarkerSystem() {
          _classCallCheck(this, BerforeDeathMarkerSystem);
          return _super2.call(this);
        }
        _createClass(BerforeDeathMarkerSystem, [{
          key: "filter",
          value: function filter() {
          ...
          value: function entityEnter(e) {
            ...
            (_e$get = e.get(UnitComp)) === null || _e$get === void 0 || (_e$get = _e$get.unit) === null || _e$get === void 0 || _e$get.removeCollision();
          }
        }, {
          key: "update",
          value: function update(e) {
...
System.register("chunks:///_virtual/BigMapComp.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './ECS.ts'], function (exports) {
  var _inherits, _createSuper, _classCallCheck, _createClass, cclegacy, _decorator, ecs;
  return {
    setters: [function (module) {
      _inherits = module.inherits;
      _createSuper = module.createSuper;
    ...
    execute: function () {
      ...
      var BigMapComp = exports('BigMapComp', (_dec = ccclass('BigMapComp'), _dec2 = ecs.register('BigMapComp'), _dec(_class = _dec2(_class = /*#__PURE__*/function (_ecs$Comp) {
        _inherits(BigMapComp, _ecs$Comp);
        var _super = _createSuper(BigMapComp);
        function BigMapComp() {
          _classCallCheck(this, BigMapComp);
          return _super.apply(this, arguments);
        }
        _createClass(BigMapComp, [{
          key: "reset",
          value: function reset() {}
        }]);
        return BigMapComp;
      ...
      var BigMapSystem = exports('BigMapSystem', /*#__PURE__*/function (_ecs$ComblockSystem) {
        _inherits(BigMapSystem, _ecs$ComblockSystem);
        var _super2 = _createSuper(BigMapSystem);
        function BigMapSystem() {
          _classCallCheck(this, BigMapSystem);
          return _super2.call(this);
        }
        _createClass(BigMapSystem, [{
          key: "filter",
          value: function filter() {
...
System.register("chunks:///_virtual/Bomb.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './ECS.ts', './FactionTypeComp.ts', './SkillCompManagerComp.ts', './CollisionComp.ts', './DeathBombExplosionComp.ts', './cc-comp-frame-animation.ts', './BaseUnit.ts', './FrameAnimation.ts'], function (exports) {
  var _applyDecoratedDescriptor, _inherits, _createSuper, _classCallCheck, _initializerDefineProperty, _assertThisInitialized, _createClass, _get, _getPrototypeOf, cclegacy, _decorator, PhysicsSystem, ecs, FactionTypeComp, SkillCompManagerComp, CollisionComp, DeathBombExplosionComp, BaaseUnit, FrameAnimation;
  return {
    setters: [function (module) {
    ...
    execute: function () {
      ...
      var Bomb = exports('Bomb', (_dec = ccclass('Bomb'), _dec2 = ecs.register('Bomb', false), _dec3 = property(FrameAnimation), _dec(_class = _dec2(_class = (_class2 = /*#__PURE__*/function (_BaaseUnit) {
        ...
        function Bomb() {
          ...
          _this = _super.call.apply(_super, [this].concat(args));
          _initializerDefineProperty(_assertThisInitialized(_this), "aniClip", _descriptor, _assertThisInitialized(_this));
          return _this;
        }
        _createClass(Bomb, [{
          key: "onLoad",
          value: function onLoad() {
            ...
            _get(_getPrototypeOf(Bomb.prototype), "onLoad", this).call(this);
          }
...
System.register("chunks:///_virtual/BombComp.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './SkillRenderComp.ts', './EnabledComp.ts', './PositionComp.ts', './UnitComp.ts', './app.ts', './ECS.ts', './ConstType.ts', './BaseUnit.ts'], function (exports) {
  var _inherits, _createSuper, _classCallCheck, _createClass, cclegacy, _decorator, Prefab, instantiate, SkillRenderComp, EnabledComp, PositionComp, UnitComp, app, ecs, MapLayersType, BaaseUnit;
  return {
    setters: [function (module) {
      _inherits = module.inherits;
      _createSuper = module.createSuper;
    ...
    execute: function () {
      ...
      var BombComp = exports('BombComp', (_dec = ccclass('BombComp'), _dec2 = ecs.register('BombComp'), _dec(_class = _dec2(_class = /*#__PURE__*/function (_SkillRenderComp) {
        _inherits(BombComp, _SkillRenderComp);
        var _super = _createSuper(BombComp);
        function BombComp() {
          _classCallCheck(this, BombComp);
          return _super.apply(this, arguments);
        }
        _createClass(BombComp, [{
          key: "reset",
          value: function reset() {}
        }]);
        return BombComp;
      ...
      var BombSystem = exports('BombSystem', /*#__PURE__*/function (_ecs$ComblockSystem) {
        _inherits(BombSystem, _ecs$ComblockSystem);
        var _super2 = _createSuper(BombSystem);
        function BombSystem() {
          _classCallCheck(this, BombSystem);
          return _super2.call(this);
        }
        _createClass(BombSystem, [{
          key: "filter",
          value: function filter() {
...
System.register("chunks:///_virtual/BombExplosion.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './ECS.ts', './cc-comp-frame-animation.ts', './FactionTypeComp.ts', './CollisionComp.ts', './AfterDeathMarkerComp.ts', './SkillAfterDeathComp.ts', './BaseUnit.ts', './FrameAnimation.ts'], function (exports) {
  var _applyDecoratedDescriptor, _inherits, _createSuper, _classCallCheck, _initializerDefineProperty, _assertThisInitialized, _createClass, _get, _getPrototypeOf, cclegacy, _decorator, PhysicsSystem, ecs, FactionTypeComp, CollisionComp, AfterDeathMarkerComp, SkillAfterDeathComp, BaaseUnit, FrameAnimation;
  return {
    setters: [function (module) {
      _applyDecoratedDescriptor = module.applyDecoratedDescriptor;
      _inherits = module.inherits;
    ...
    execute: function () {
      ...
      var BombExplosion = exports('BombExplosion', (_dec = ccclass('BombExplosion'), _dec2 = ecs.register('BombExplosion', false), _dec3 = property(FrameAnimation), _dec(_class = _dec2(_class = (_class2 = /*#__PURE__*/function (_BaaseUnit) {
        _inherits(BombExplosion, _BaaseUnit);
        var _super = _createSuper(BombExplosion);
        ...
        _createClass(BombExplosion, [{
          ...
          value: function onLoad() {
            ...
            this.group = this.ent.get(FactionTypeComp).group;
            this.agent = false;
            _get(_getPrototypeOf(BombExplosion.prototype), "onLoad", this).call(this);
          }
...
System.register("chunks:///_virtual/BombExplosionComp.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './SkillRenderComp.ts', './EnabledComp.ts', './PositionComp.ts', './UnitComp.ts', './SkillAfterDeathComp.ts', './app.ts', './ECS.ts', './ConstType.ts', './BaseUnit.ts'], function (exports) {
  var _inherits, _createSuper, _classCallCheck, _createClass, cclegacy, _decorator, Prefab, instantiate, SkillRenderComp, EnabledComp, PositionComp, UnitComp, SkillAfterDeathComp, app, ecs, MapLayersType, BaaseUnit;
  return {
    setters: [function (module) {
      _inherits = module.inherits;
      _createSuper = module.createSuper;
    ...
    execute: function () {
      ...
      var BombExplosionComp = exports('BombExplosionComp', (_dec = ccclass('BombExplosionComp'), _dec2 = ecs.register('BombExplosionComp'), _dec(_class = _dec2(_class = /*#__PURE__*/function (_SkillRenderComp) {
        _inherits(BombExplosionComp, _SkillRenderComp);
        var _super = _createSuper(BombExplosionComp);
        function BombExplosionComp() {
          _classCallCheck(this, BombExplosionComp);
          return _super.apply(this, arguments);
        }
        _createClass(BombExplosionComp, [{
          key: "reset",
          value: function reset() {}
        }]);
      ...
      var BombExplosionSystem = exports('BombExplosionSystem', /*#__PURE__*/function (_ecs$ComblockSystem) {
        _inherits(BombExplosionSystem, _ecs$ComblockSystem);
        var _super2 = _createSuper(BombExplosionSystem);
        function BombExplosionSystem() {
          _classCallCheck(this, BombExplosionSystem);
          return _super2.call(this);
        }
        _createClass(BombExplosionSystem, [{
          key: "filter",
          value: function filter() {
...
System.register("chunks:///_virtual/CameraFollowComp.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './app.ts', './ECS.ts', './PositionComp.ts', './MapModelComp.ts'], function (exports) {
  var _inherits, _createSuper, _classCallCheck, _defineProperty, _assertThisInitialized, _createClass, cclegacy, app, ecs, PositionComp, MapModelComp;
  return {
    setters: [function (module) {
      _inherits = module.inherits;
      _createSuper = module.createSuper;
    ...
    execute: function () {
      ...
      var CameraFollowComp = exports('CameraFollowComp', (_dec = ecs.register('CameraFollowComp'), _dec(_class = /*#__PURE__*/function (_ecs$Comp) {
        _inherits(CameraFollowComp, _ecs$Comp);
        var _super = _createSuper(CameraFollowComp);
        function CameraFollowComp() {
          var _this;
          _classCallCheck(this, CameraFollowComp);
          for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
            args[_key] = arguments[_key];
          }
          _this = _super.call.apply(_super, [this].concat(args));
          ...
          /**跟随的实体 */
          _defineProperty(_assertThisInitialized(_this), "followEty", null);
          /**跟随的点 */
          _defineProperty(_assertThisInitialized(_this), "followPos", null);
          return _this;
        }
        _createClass(CameraFollowComp, [{
          key: "reset",
          value: function reset() {}
        }]);
      ...
      var CameraFollowSystem = exports('CameraFollowSystem', /*#__PURE__*/function (_ref) {
        _inherits(CameraFollowSystem, _ref);
        var _super2 = _createSuper(CameraFollowSystem);
        function CameraFollowSystem() {
          _classCallCheck(this, CameraFollowSystem);
          return _super2.call(this);
        }
        _createClass(CameraFollowSystem, [{
          key: "filter",
          value: function filter() {
...
System.register("chunks:///_virtual/ChainSaw.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './ECS.ts', './cc-comp-frame-animation.ts', './FactionTypeComp.ts', './SkillCompManagerComp.ts', './CollisionComp.ts', './BaseUnit.ts', './FrameAnimation.ts'], function (exports) {
  var _applyDecoratedDescriptor, _inherits, _createSuper, _classCallCheck, _initializerDefineProperty, _assertThisInitialized, _createClass, _get, _getPrototypeOf, cclegacy, _decorator, PhysicsSystem, ecs, FactionTypeComp, SkillCompManagerComp, CollisionComp, BaaseUnit, FrameAnimation;
  return {
    setters: [function (module) {
      _applyDecoratedDescriptor = module.applyDecoratedDescriptor;
      _inherits = module.inherits;
    ...
    execute: function () {
      ...
      var ChainSaw = exports('ChainSaw', (_dec = ccclass('ChainSaw'), _dec2 = ecs.register('ChainSaw', false), _dec3 = property(FrameAnimation), _dec(_class = _dec2(_class = (_class2 = /*#__PURE__*/function (_BaaseUnit) {
        _inherits(ChainSaw, _BaaseUnit);
        var _super = _createSuper(ChainSaw);
        function ChainSaw() {
          var _this;
          _classCallCheck(this, ChainSaw);
          for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
            args[_key] = arguments[_key];
          }
          _this = _super.call.apply(_super, [this].concat(args));
        ...
        _createClass(ChainSaw, [{
          ...
          value: function onLoad() {
            ...
            this.maxRadius = 15;
            this.ent.get(SkillCompManagerComp).addCompByid(200101);
            _get(_getPrototypeOf(ChainSaw.prototype), "onLoad", this).call(this);
          }
...
System.register("chunks:///_virtual/ChainSawComp.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './ECS.ts', './SkillRenderComp.ts', './CollisionMotionlessComp.ts', './CollisionReboundComp.ts', './app.ts', './ConstType.ts', './BaseUnit.ts', './EnabledComp.ts', './PositionComp.ts', './UnitComp.ts'], function (exports) {
  var _inherits, _createSuper, _classCallCheck, _createClass, cclegacy, _decorator, Prefab, instantiate, ecs, SkillRenderComp, CollisionMotionlessComp, CollisionReboundComp, app, MapLayersType, BaaseUnit, EnabledComp, PositionComp, UnitComp;
  return {
    setters: [function (module) {
      _inherits = module.inherits;
      _createSuper = module.createSuper;
    ...
    execute: function () {
      ...
      var ChainSawComp = exports('ChainSawComp', (_dec = ccclass('ChainSawComp'), _dec2 = ecs.register('ChainSawComp'), _dec(_class = _dec2(_class = /*#__PURE__*/function (_SkillRenderComp) {
        _inherits(ChainSawComp, _SkillRenderComp);
        var _super = _createSuper(ChainSawComp);
        function ChainSawComp() {
          _classCallCheck(this, ChainSawComp);
          return _super.apply(this, arguments);
        }
        _createClass(ChainSawComp, [{
          key: "reset",
          value: function reset() {}
        }]);
        return ChainSawComp;
      ...
      var ChainSawSystem = exports('ChainSawSystem', /*#__PURE__*/function (_ecs$ComblockSystem) {
        _inherits(ChainSawSystem, _ecs$ComblockSystem);
        var _super2 = _createSuper(ChainSawSystem);
        function ChainSawSystem() {
          _classCallCheck(this, ChainSawSystem);
          return _super2.call(this);
        }
        _createClass(ChainSawSystem, [{
          key: "filter",
          value: function filter() {
...
System.register("chunks:///_virtual/CollectDropComp.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './app.ts', './ECS.ts', './BerforeDeathMarkerComp.ts', './PositionComp.ts', './DropModelComp.ts'], function (exports) {
  var _inherits, _createSuper, _classCallCheck, _defineProperty, _assertThisInitialized, _createClass, cclegacy, app, ecs, BerforeDeathMarkerComp, PositionComp, DropModelComp;
  return {
    setters: [function (module) {
      _inherits = module.inherits;
      _createSuper = module.createSuper;
    ...
    execute: function () {
      ...
      var CollectDropComp = exports('CollectDropComp', (_dec = ecs.register('CollectDropComp'), _dec(_class = /*#__PURE__*/function (_ecs$Comp) {
        _inherits(CollectDropComp, _ecs$Comp);
        var _super = _createSuper(CollectDropComp);
        function CollectDropComp() {
          var _this;
          _classCallCheck(this, CollectDropComp);
          for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
            args[_key] = arguments[_key];
          }
          _this = _super.call.apply(_super, [this].concat(args));
          //是否在拾取范围
          _defineProperty(_assertThisInitialized(_this), "isInCollectRange", false);
          return _this;
        }
        _createClass(CollectDropComp, [{
          key: "reset",
          value: function reset() {}
        }]);
      ...
      var CollectDropSystem = exports('CollectDropSystem', /*#__PURE__*/function (_ecs$ComblockSystem) {
        _inherits(CollectDropSystem, _ecs$ComblockSystem);
        var _super2 = _createSuper(CollectDropSystem);
        function CollectDropSystem() {
          _classCallCheck(this, CollectDropSystem);
          return _super2.call(this);
        }
        _createClass(CollectDropSystem, [{
          key: "filter",
          value: function filter() {
...
System.register("chunks:///_virtual/ColliderComp.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './Collider.ts', './ECS.ts'], function (exports) {
  var _inherits, _createSuper, _classCallCheck, _createClass, cclegacy, cCollider, ecs;
  return {
    setters: [function (module) {
      _inherits = module.inherits;
      _createSuper = module.createSuper;
    ...
    execute: function () {
      ...
      var ColliderComp = exports('ColliderComp', (_dec = ecs.register('ColliderComp'), _dec(_class = /*#__PURE__*/function (_ecs$Comp) {
        _inherits(ColliderComp, _ecs$Comp);
        var _super = _createSuper(ColliderComp);
        function ColliderComp() {
          _classCallCheck(this, ColliderComp);
          return _super.apply(this, arguments);
        }
        _createClass(ColliderComp, [{
          key: "reset",
          value: function reset() {}
        }]);
        return ColliderComp;
      ...
      var ColliderSystem = exports('ColliderSystem', /*#__PURE__*/function (_ecs$ComblockSystem) {
        _inherits(ColliderSystem, _ecs$ComblockSystem);
        var _super2 = _createSuper(ColliderSystem);
        function ColliderSystem() {
          _classCallCheck(this, ColliderSystem);
          return _super2.call(this);
        }
        _createClass(ColliderSystem, [{
          key: "filter",
          value: function filter() {
...
System.register("chunks:///_virtual/CollisionComp.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './SkillPluginConfig.ts', './ECS.ts', './ConstType.ts', './CollisionMarkerComp.ts', './SkillModelComp.ts', './EnabledComp.ts', './FactionTypeComp.ts', './HpComp.ts', './RoleModelComp.ts'], function (exports) {
  var _inherits, _createSuper, _classCallCheck, _defineProperty, _assertThisInitialized, _createClass, cclegacy, DB_SkillPluginConfig, ecs, EntityType, AttributeType, CollisionMarkerComp, SkillModelComp, EnabledComp, FactionTypeComp, HpComp, RoleModelComp;
  return {
    setters: [function (module) {
      _inherits = module.inherits;
      _createSuper = module.createSuper;
    ...
    execute: function () {
      ...
      var CollisionComp = exports('CollisionComp', (_dec = ecs.register('CollisionComp'), _dec(_class = /*#__PURE__*/function (_ecs$Comp) {
        _inherits(CollisionComp, _ecs$Comp);
        var _super = _createSuper(CollisionComp);
        function CollisionComp() {
          var _this;
          _classCallCheck(this, CollisionComp);
          for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
            args[_key] = arguments[_key];
          }
          _this = _super.call.apply(_super, [this].concat(args));
          /**碰撞过的实体，会更新碰撞时间 */
          _defineProperty(_assertThisInitialized(_this), "colliderResult", new Map());
          /**碰撞,会执行碰撞结果 */
          _defineProperty(_assertThisInitialized(_this), "collisonResult", []);
          /**是否碰撞 */
          _defineProperty(_assertThisInitialized(_this), "isCollision", true);
          return _this;
        }
        _createClass(CollisionComp, [{
          key: "reset",
          value: function reset() {
          ...
          key: "addCollision",
          value: function addCollision(ent) {
      ...
      var CollisionSystem = exports('CollisionSystem', /*#__PURE__*/function (_ecs$ComblockSystem) {
        _inherits(CollisionSystem, _ecs$ComblockSystem);
        var _super2 = _createSuper(CollisionSystem);
...
System.register("chunks:///_virtual/CollisionFireballComp.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './ECS.ts', './SkillRenderComp.ts', './PositionComp.ts', './SkillPluginConfig.ts', './SkillManagerComp.ts', './app.ts', './ConstType.ts', './BaseUnit.ts', './EnabledComp.ts', './UnitComp.ts'], function (exports) {
  var _inherits, _createSuper, _classCallCheck, _createClass, cclegacy, _decorator, js, Prefab, instantiate, ecs, SkillRenderComp, PositionComp, DB_SkillPluginConfig, SkillManagerComp, app, MapLayersType, BaaseUnit, EnabledComp, UnitComp;
  return {
    setters: [function (module) {
      _inherits = module.inherits;
      _createSuper = module.createSuper;
    ...
    execute: function () {
      ...
      var CollisionFireballComp = exports('CollisionFireballComp', (_dec = ccclass('CollisionFireballComp'), _dec2 = ecs.register('CollisionFireballComp'), _dec(_class = _dec2(_class = /*#__PURE__*/function (_SkillRenderComp) {
        _inherits(CollisionFireballComp, _SkillRenderComp);
        var _super = _createSuper(CollisionFireballComp);
        function CollisionFireballComp() {
          _classCallCheck(this, CollisionFireballComp);
          return _super.apply(this, arguments);
        }
        _createClass(CollisionFireballComp, [{
          key: "initSkill",
          value: function initSkill() {
            var skillId = 200301;
      ...
      var CollisionFireballSystem = exports('CollisionFireballSystem', /*#__PURE__*/function (_ecs$ComblockSystem) {
        _inherits(CollisionFireballSystem, _ecs$ComblockSystem);
        var _super2 = _createSuper(CollisionFireballSystem);
        function CollisionFireballSystem() {
          _classCallCheck(this, CollisionFireballSystem);
          return _super2.call(this);
        }
        _createClass(CollisionFireballSystem, [{
          key: "filter",
          value: function filter() {
...
System.register("chunks:///_virtual/CollisionMarkerComp.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './ECS.ts'], function (exports) {
  var _inherits, _createSuper, _classCallCheck, _createClass, cclegacy, ecs;
  return {
    setters: [function (module) {
      _inherits = module.inherits;
      _createSuper = module.createSuper;
    ...
    execute: function () {
      ...
      var CollisionMarkerComp = exports('CollisionMarkerComp', (_dec = ecs.register('CollisionMarkerComp'), _dec(_class = /*#__PURE__*/function (_ecs$Comp) {
        _inherits(CollisionMarkerComp, _ecs$Comp);
        var _super = _createSuper(CollisionMarkerComp);
        function CollisionMarkerComp() {
          _classCallCheck(this, CollisionMarkerComp);
          return _super.apply(this, arguments);
        }
        _createClass(CollisionMarkerComp, [{
          key: "reset",
          value: function reset() {}
        }]);
      ...
      var CollisionMarkerSystem = exports('CollisionMarkerSystem', /*#__PURE__*/function (_ecs$ComblockSystem) {
        _inherits(CollisionMarkerSystem, _ecs$ComblockSystem);
        var _super2 = _createSuper(CollisionMarkerSystem);
        function CollisionMarkerSystem() {
          _classCallCheck(this, CollisionMarkerSystem);
          return _super2.call(this);
        }
        _createClass(CollisionMarkerSystem, [{
          key: "filter",
          value: function filter() {
...
System.register("chunks:///_virtual/CollisionMotionlessComp.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './ECS.ts', './CollisionMarkerComp.ts', './RestrictMoveComp.ts'], function (exports) {
  var _inherits, _createSuper, _classCallCheck, _createClass, cclegacy, ecs, CollisionMarkerComp, RestrictMoveComp;
  return {
    setters: [function (module) {
      _inherits = module.inherits;
      _createSuper = module.createSuper;
    ...
    execute: function () {
      ...
      var CollisionMotionlessComp = exports('CollisionMotionlessComp', (_dec = ecs.register('CollisionMotionlessComp'), _dec(_class = /*#__PURE__*/function (_ecs$Comp) {
        _inherits(CollisionMotionlessComp, _ecs$Comp);
        var _super = _createSuper(CollisionMotionlessComp);
        function CollisionMotionlessComp() {
          _classCallCheck(this, CollisionMotionlessComp);
          return _super.apply(this, arguments);
        }
        _createClass(CollisionMotionlessComp, [{
          key: "reset",
          value: function reset() {}
        }]);
      ...
      var CollisionMotionlessSystem = exports('CollisionMotionlessSystem', /*#__PURE__*/function (_ecs$ComblockSystem) {
        _inherits(CollisionMotionlessSystem, _ecs$ComblockSystem);
        var _super2 = _createSuper(CollisionMotionlessSystem);
        function CollisionMotionlessSystem() {
          _classCallCheck(this, CollisionMotionlessSystem);
          return _super2.call(this);
        }
        _createClass(CollisionMotionlessSystem, [{
          key: "filter",
          value: function filter() {
...
System.register("chunks:///_virtual/CollisionReboundComp.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './ECS.ts', './CollisionMarkerComp.ts', './DirectionComp.ts', './LinearSkillMoveComp.ts'], function (exports) {
  var _inherits, _createSuper, _classCallCheck, _createClass, cclegacy, Vec3, ecs, CollisionMarkerComp, DirectionComp, LinearSkillMoveComp;
  return {
    setters: [function (module) {
      _inherits = module.inherits;
      _createSuper = module.createSuper;
    ...
    execute: function () {
      ...
      var CollisionReboundComp = exports('CollisionReboundComp', (_dec = ecs.register('CollisionReboundComp'), _dec(_class = /*#__PURE__*/function (_ecs$Comp) {
        _inherits(CollisionReboundComp, _ecs$Comp);
        var _super = _createSuper(CollisionReboundComp);
        function CollisionReboundComp() {
          _classCallCheck(this, CollisionReboundComp);
          return _super.apply(this, arguments);
        }
        _createClass(CollisionReboundComp, [{
          key: "reset",
          value: function reset() {}
        }]);
      ...
      var CollisionReboundSystem = exports('CollisionReboundSystem', /*#__PURE__*/function (_ecs$ComblockSystem) {
        _inherits(CollisionReboundSystem, _ecs$ComblockSystem);
        var _super2 = _createSuper(CollisionReboundSystem);
        function CollisionReboundSystem() {
          _classCallCheck(this, CollisionReboundSystem);
          return _super2.call(this);
        }
        _createClass(CollisionReboundSystem, [{
          key: "filter",
          value: function filter() {
...
System.register("chunks:///_virtual/CollisionTriggerComp.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './ECS.ts', './SkillRenderComp.ts', './SkillPluginConfig.ts', './BerforeDeathMarkerComp.ts', './ConstType.ts', './FactionTypeComp.ts', './PositionComp.ts', './SkillEntity.ts', './MasterComp.ts', './SkillModelComp.ts', './SkillManagerComp.ts', './BattleUtil.ts'], function (exports) {
  var _inherits, _createSuper, _classCallCheck, _createClass, _defineProperty, cclegacy, _decorator, Vec3, ecs, SkillRenderComp, DB_SkillPluginConfig, BerforeDeathMarkerComp, SkillAttributeType, EntityType, FactionTypeComp, PositionComp, SkillEntity, MasterComp, SkillModelComp, SkillManagerComp, BattleUtil;
  return {
    setters: [function (module) {
      _inherits = module.inherits;
      _createSuper = module.createSuper;
    ...
    execute: function () {
      ...
      var CollisionTriggerComp = exports('CollisionTriggerComp', (_dec = ccclass('CollisionTriggerComp'), _dec2 = ecs.register('CollisionTriggerComp'), _dec(_class = _dec2(_class = /*#__PURE__*/function (_SkillRenderComp) {
        _inherits(CollisionTriggerComp, _SkillRenderComp);
        var _super = _createSuper(CollisionTriggerComp);
        function CollisionTriggerComp() {
          _classCallCheck(this, CollisionTriggerComp);
          return _super.apply(this, arguments);
        }
        _createClass(CollisionTriggerComp, [{
          key: "initSkill",
          value: function initSkill() {
            this.skillPlugin = [];
            this.modifyPlugin = [];
      ...
      var CollisionTriggerSystem = exports('CollisionTriggerSystem', /*#__PURE__*/function (_ecs$ComblockSystem) {
        _inherits(CollisionTriggerSystem, _ecs$ComblockSystem);
        var _super2 = _createSuper(CollisionTriggerSystem);
        function CollisionTriggerSystem() {
          _classCallCheck(this, CollisionTriggerSystem);
          return _super2.call(this);
        }
        _createClass(CollisionTriggerSystem, [{
          key: "filter",
          value: function filter() {
          ...
          value: function entityEnter(e) {
            ...
            for (var i = 0; i < comp.skillPlugin.length; i++) {
              ...
              skillEntity.get(SkillModelComp).init({
                att: (_att = {}, _defineProperty(_att, SkillAttributeType.hp, config.pierce), _defineProperty(_att, SkillAttributeType.atk, config.damage), _defineProperty(_att, SkillAttributeType.speed, config.speed), _defineProperty(_att, SkillAttributeType.crit, config.crit), _defineProperty(_att, SkillAttributeType.critDamage, config.critDamage), _defineProperty(_att, SkillAttributeType.lifeTime, config.lifeTime), _att),
...
System.register("chunks:///_virtual/ConstType.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc'], function (exports) {
  ...
  return {
    ...
    execute: function () {
      ...
      var CorrectionSourceType = exports('CorrectionSourceType', /*#__PURE__*/function (CorrectionSourceType) {
        ...
        CorrectionSourceType[CorrectionSourceType["OTHER"] = 3] = "OTHER";
      ...
      var RoleAnimLoop = exports('RoleAnimLoop', (_RoleAnimLoop = {}, _defineProperty(_RoleAnimLoop, RoleAnimType.idle, true), _defineProperty(_RoleAnimLoop, RoleAnimType.dizzy, false), _defineProperty(_RoleAnimLoop, RoleAnimType.run, true), _defineProperty(_RoleAnimLoop, RoleAnimType.atk, false), _defineProperty(_RoleAnimLoop, RoleAnimType.dead, false), _defineProperty(_RoleAnimLoop, RoleAnimType.hit, false), _RoleAnimLoop));
...
System.register("chunks:///_virtual/ControlEntity.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './ECS.ts', './BaseEntity.ts', './CreateRoleComp.ts'], function (exports) {
  var _inherits, _createSuper, _classCallCheck, _createClass, _get, _getPrototypeOf, cclegacy, ecs, BaseEntity, CreateRoleComp;
  return {
    setters: [function (module) {
      _inherits = module.inherits;
      _createSuper = module.createSuper;
    ...
    execute: function () {
      ...
      var ControlEntity = exports('ControlEntity', (_dec = ecs.register('ControlEntity'), _dec(_class = /*#__PURE__*/function (_BaseEntity) {
        _inherits(ControlEntity, _BaseEntity);
        var _super = _createSuper(ControlEntity);
        function ControlEntity() {
          _classCallCheck(this, ControlEntity);
          return _super.apply(this, arguments);
        }
        _createClass(ControlEntity, [{
          key: "init",
          value: function init() {
            _get(_getPrototypeOf(ControlEntity.prototype), "init", this).call(this);
  ...
  return {
    ...
    execute: function () {
      ...
      var ControlSystem = exports('ControlSystem', /*#__PURE__*/function (_ecs$System) {
        _inherits(ControlSystem, _ecs$System);
        var _super = _createSuper(ControlSystem);
        ...
        return _createClass(ControlSystem);
      }(ecs.System));
      cclegacy._RF.pop();
    }
  };
...
System.register("chunks:///_virtual/CreateBombExplosionComp.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './ECS.ts', './ConstType.ts', './SkillRenderComp.ts', './PositionComp.ts', './SkillEntity.ts', './SkillPluginConfig.ts', './FactionTypeComp.ts', './MasterComp.ts', './SkillModelComp.ts'], function (exports) {
  var _inherits, _createSuper, _classCallCheck, _defineProperty, _assertThisInitialized, _createClass, cclegacy, _decorator, Vec3, js, ecs, SkillAttributeType, EntityType, SkillRenderComp, PositionComp, SkillEntity, DB_SkillPluginConfig, FactionTypeComp, MasterComp, SkillModelComp;
  return {
    setters: [function (module) {
      _inherits = module.inherits;
      _createSuper = module.createSuper;
    ...
    execute: function () {
      ...
      var CreateBombExplosionComp = exports('CreateBombExplosionComp', (_dec = ccclass('CreateBombExplosionComp'), _dec2 = ecs.register('CreateBombExplosionComp'), _dec(_class = _dec2(_class = /*#__PURE__*/function (_SkillRenderComp) {
        _inherits(CreateBombExplosionComp, _SkillRenderComp);
        var _super = _createSuper(CreateBombExplosionComp);
        function CreateBombExplosionComp() {
          var _this;
          _classCallCheck(this, CreateBombExplosionComp);
          for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
            args[_key] = arguments[_key];
          }
          _this = _super.call.apply(_super, [this].concat(args));
          _defineProperty(_assertThisInitialized(_this), "pos", new Vec3());
          _defineProperty(_assertThisInitialized(_this), "atk", 0);
          return _this;
        }
        _createClass(CreateBombExplosionComp, [{
          key: "initData",
      ...
      var CreateBombExplosionSystem = exports('CreateBombExplosionSystem', /*#__PURE__*/function (_ecs$ComblockSystem) {
        _inherits(CreateBombExplosionSystem, _ecs$ComblockSystem);
        var _super2 = _createSuper(CreateBombExplosionSystem);
        function CreateBombExplosionSystem() {
          _classCallCheck(this, CreateBombExplosionSystem);
          return _super2.call(this);
        }
        _createClass(CreateBombExplosionSystem, [{
          key: "filter",
          value: function filter() {
          ...
          value: function entityEnter(e) {
            ...
            var config = DB_SkillPluginConfig[skillId];
            skillEntity.get(SkillModelComp).init({
              att: (_att = {}, _defineProperty(_att, SkillAttributeType.hp, config.pierce), _defineProperty(_att, SkillAttributeType.atk, e.get(SkillModelComp).attributes.get(SkillAttributeType.atk).value), _defineProperty(_att, SkillAttributeType.speed, 0), _defineProperty(_att, SkillAttributeType.crit, config.crit), _defineProperty(_att, SkillAttributeType.critDamage, config.critDamage), _defineProperty(_att, SkillAttributeType.lifeTime, config.lifeTime), _att),
              skillId: skillId,
              scatteringAngle: 0,
...
System.register("chunks:///_virtual/CreateRoleComp.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './ECS.ts', './ConstType.ts', './RoleEntity.ts', './app.ts', './DeathComp.ts', './EnabledComp.ts', './FactionTypeComp.ts', './AfterDeathMarkerComp.ts', './PositionComp.ts', './RoleModelComp.ts', './RoleShowAnimation1Comp.ts', './MapModelComp.ts'], function (exports) {
  var _inherits, _createSuper, _classCallCheck, _defineProperty, _assertThisInitialized, _createClass, _createForOfIteratorHelper, cclegacy, _decorator, ecs, EntityType, RoleEntity, app, DeathComp, EnabledComp, FactionTypeComp, AfterDeathMarkerComp, PositionComp, RoleModelComp, RoleShowAnimation1Comp, MapModelComp;
  return {
    setters: [function (module) {
      _inherits = module.inherits;
      _createSuper = module.createSuper;
    ...
    execute: function () {
      ...
      var CreateRoleComp = exports('CreateRoleComp', (_dec = ccclass('CreateRoleComp'), _dec2 = ecs.register('CreateRoleComp'), _dec(_class = _dec2(_class = /*#__PURE__*/function (_ecs$Comp) {
        _inherits(CreateRoleComp, _ecs$Comp);
        var _super = _createSuper(CreateRoleComp);
        function CreateRoleComp() {
          var _this;
          _classCallCheck(this, CreateRoleComp);
          for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
            args[_key] = arguments[_key];
          }
          _this = _super.call.apply(_super, [this].concat(args));
          /**待生成的角色 */
          _defineProperty(_assertThisInitialized(_this), "awaitAddRoleData", []);
          /**已经生成的角色 */
          _defineProperty(_assertThisInitialized(_this), "alreadyAddRole", new Map());
          return _this;
        }
        _createClass(CreateRoleComp, [{
          key: "addRoleData",
          value: function addRoleData(data) {
            this.awaitAddRoleData.push(data);
          }
        }, {
          key: "addAlreadyAddRole",
          value: function addAlreadyAddRole(role) {
            var faction = role.get(FactionTypeComp).faction;
          ...
          key: "getAwaitAddRoleDataLength",
          value: function getAwaitAddRoleDataLength() {
            return this.awaitAddRoleData.length;
          }
        }, {
          key: "getAlreadyAddRoleLength",
          value: function getAlreadyAddRoleLength(faction) {
            var _this$alreadyAddRole$;
            return ((_this$alreadyAddRole$ = this.alreadyAddRole.get(faction)) === null || _this$alreadyAddRole$ === void 0 ? void 0 : _this$alreadyAddRole$.length) || 0;
          }
        }, {
          key: "clearRoleData",
          value: function clearRoleData(faction) {
            //清除已经生成的
      ...
      var CreateRoleSystem = exports('CreateRoleSystem', /*#__PURE__*/function (_ecs$ComblockSystem) {
        _inherits(CreateRoleSystem, _ecs$ComblockSystem);
        var _super2 = _createSuper(CreateRoleSystem);
        function CreateRoleSystem() {
          _classCallCheck(this, CreateRoleSystem);
          return _super2.call(this);
        }
        _createClass(CreateRoleSystem, [{
          key: "filter",
          value: function filter() {
          ...
          value: function update(e) {
            ...
            if (comp.awaitAddRoleData.length > 0) {
              ...
              role.add(RoleShowAnimation1Comp);
              if (data.extraComps) {
                var _iterator2 = _createForOfIteratorHelper(data.extraComps),
                  _step2;
                try {
            ...
            if (comp.alreadyAddRole.size > 0) {
              // 遍历所有敌人，删除不在地图上的敌人
              var _iterator3 = _createForOfIteratorHelper(comp.alreadyAddRole.keys()),
                _step3;
              try {
...
System.register("chunks:///_virtual/CreateTaskComp.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './CompConfig.ts', './TaskConfig.ts', './ECS.ts', './EnabledComp.ts', './ShowTaskComp.ts', './TaskModelComp.ts', './TaskEntity.ts', './app.ts'], function (exports) {
  var _inherits, _createSuper, _classCallCheck, _defineProperty, _assertThisInitialized, _createClass, cclegacy, js, DB_CompConfig, DB_TaskConfig, ecs, EnabledComp, ShowTaskComp, TaskModelComp, TaskEntity, app;
  return {
    setters: [function (module) {
      _inherits = module.inherits;
      _createSuper = module.createSuper;
    ...
    execute: function () {
      ...
      var CreateTaskComp = exports('CreateTaskComp', (_dec = ecs.register('CreateTaskComp'), _dec(_class = /*#__PURE__*/function (_ecs$Comp) {
        _inherits(CreateTaskComp, _ecs$Comp);
        var _super = _createSuper(CreateTaskComp);
        function CreateTaskComp() {
          var _this;
          _classCallCheck(this, CreateTaskComp);
          for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
            args[_key] = arguments[_key];
          }
          _this = _super.call.apply(_super, [this].concat(args));
          _defineProperty(_assertThisInitialized(_this), "taskId", void 0);
          return _this;
        }
        _createClass(CreateTaskComp, [{
          key: "reset",
          value: function reset() {}
        }]);
      ...
      var CreateTaskSystem = exports('CreateTaskSystem', /*#__PURE__*/function (_ecs$ComblockSystem) {
        _inherits(CreateTaskSystem, _ecs$ComblockSystem);
        var _super2 = _createSuper(CreateTaskSystem);
        function CreateTaskSystem() {
          _classCallCheck(this, CreateTaskSystem);
          return _super2.call(this);
        }
        _createClass(CreateTaskSystem, [{
          key: "filter",
          value: function filter() {
...
System.register("chunks:///_virtual/DamageFlyText.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc'], function (exports) {
  var _inherits, _createSuper, _classCallCheck, _defineProperty, _assertThisInitialized, _createClass, cclegacy, _decorator, Label, Color, Vec3, tween, Component;
  return {
    setters: [function (module) {
      _inherits = module.inherits;
      _createSuper = module.createSuper;
    ...
    execute: function () {
      ...
      var DamageFlyText = exports('DamageFlyText', (_dec = ccclass('DamageFlyText'), _dec(_class = /*#__PURE__*/function (_Component) {
        _inherits(DamageFlyText, _Component);
        var _super = _createSuper(DamageFlyText);
        function DamageFlyText() {
          var _this;
          _classCallCheck(this, DamageFlyText);
          for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
            args[_key] = arguments[_key];
          }
          _this = _super.call.apply(_super, [this].concat(args));
          _defineProperty(_assertThisInitialized(_this), "duration", 1.0);
          // 飘字持续时间
          _defineProperty(_assertThisInitialized(_this), "riseHeight", 50);
          return _this;
        }
        _createClass(DamageFlyText, [{
          key: "init",
          value:
          // 飘字上升高度
          // 初始化飘字控件
          function init(value, startPosition) {
            var _this2 = this;
...
System.register("chunks:///_virtual/DamageFlyTextComp.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './ECS.ts', './BattleUtil.ts', './PositionComp.ts'], function (exports) {
  var _inherits, _createSuper, _classCallCheck, _defineProperty, _assertThisInitialized, _createClass, cclegacy, ecs, BattleUtil, PositionComp;
  return {
    setters: [function (module) {
      _inherits = module.inherits;
      _createSuper = module.createSuper;
    ...
    execute: function () {
      ...
      var DamageFlyTextComp = exports('DamageFlyTextComp', (_dec = ecs.register('DamageFlyTextComp'), _dec(_class = /*#__PURE__*/function (_ecs$Comp) {
        _inherits(DamageFlyTextComp, _ecs$Comp);
        var _super = _createSuper(DamageFlyTextComp);
        function DamageFlyTextComp() {
          var _this;
          _classCallCheck(this, DamageFlyTextComp);
          for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
            args[_key] = arguments[_key];
          }
          _this = _super.call.apply(_super, [this].concat(args));
          //等待中的
          _defineProperty(_assertThisInitialized(_this), "readyText", []);
          //间隔时间
          _defineProperty(_assertThisInitialized(_this), "interval", 0.3);
          //当前间隔时间
          _defineProperty(_assertThisInitialized(_this), "curInterval", 0.3);
          return _this;
        }
        _createClass(DamageFlyTextComp, [{
          key: "addText",
      ...
      var DamageFlyTextSystem = exports('DamageFlyTextSystem', /*#__PURE__*/function (_ecs$ComblockSystem) {
        _inherits(DamageFlyTextSystem, _ecs$ComblockSystem);
        var _super2 = _createSuper(DamageFlyTextSystem);
        function DamageFlyTextSystem() {
          _classCallCheck(this, DamageFlyTextSystem);
          return _super2.call(this);
        }
        _createClass(DamageFlyTextSystem, [{
          key: "filter",
          value: function filter() {
...
System.register("chunks:///_virtual/DeathBombExplosionComp.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './ECS.ts', './ConstType.ts', './SkillRenderComp.ts', './PositionComp.ts', './BerforeDeathMarkerComp.ts', './SkillModelComp.ts', './CreateBombExplosionComp.ts'], function (exports) {
  var _inherits, _createSuper, _classCallCheck, _createClass, cclegacy, _decorator, ecs, SkillAttributeType, SkillRenderComp, PositionComp, BerforeDeathMarkerComp, SkillModelComp, CreateBombExplosionComp;
  return {
    setters: [function (module) {
      _inherits = module.inherits;
      _createSuper = module.createSuper;
    ...
    execute: function () {
      ...
      var DeathBombExplosionComp = exports('DeathBombExplosionComp', (_dec = ccclass('DeathBombExplosionComp'), _dec2 = ecs.register('DeathBombExplosionComp'), _dec(_class = _dec2(_class = /*#__PURE__*/function (_SkillRenderComp) {
        _inherits(DeathBombExplosionComp, _SkillRenderComp);
        var _super = _createSuper(DeathBombExplosionComp);
        function DeathBombExplosionComp() {
          _classCallCheck(this, DeathBombExplosionComp);
          return _super.apply(this, arguments);
        }
        _createClass(DeathBombExplosionComp, [{
          key: "reset",
          value: function reset() {}
        }]);
      ...
      var DeathBombExplosionSystem = exports('DeathBombExplosionSystem', /*#__PURE__*/function (_ecs$ComblockSystem) {
        _inherits(DeathBombExplosionSystem, _ecs$ComblockSystem);
        var _super2 = _createSuper(DeathBombExplosionSystem);
        function DeathBombExplosionSystem() {
          _classCallCheck(this, DeathBombExplosionSystem);
          return _super2.call(this);
        }
        _createClass(DeathBombExplosionSystem, [{
          key: "filter",
          value: function filter() {
...
System.register("chunks:///_virtual/DeathComp.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './BattleController.ts', './app.ts', './ECS.ts', './IsPlayerComp.ts', './AfterDeathMarkerComp.ts', './UnitComp.ts'], function (exports) {
  var _inherits, _createSuper, _classCallCheck, _createClass, cclegacy, BattleController, app, ecs, IsPlayerComp, AfterDeathMarkerComp, UnitComp;
  return {
    setters: [function (module) {
      _inherits = module.inherits;
      _createSuper = module.createSuper;
    ...
    execute: function () {
      ...
      var DeathComp = exports('DeathComp', (_dec = ecs.register('DeathComp'), _dec(_class = /*#__PURE__*/function (_ecs$Comp) {
        _inherits(DeathComp, _ecs$Comp);
        var _super = _createSuper(DeathComp);
        function DeathComp() {
          _classCallCheck(this, DeathComp);
          return _super.apply(this, arguments);
        }
        _createClass(DeathComp, [{
          key: "reset",
          value: function reset() {}
        }]);
        return DeathComp;
      ...
      var DeathSystem = exports('DeathSystem', /*#__PURE__*/function (_ecs$ComblockSystem) {
        _inherits(DeathSystem, _ecs$ComblockSystem);
        var _super2 = _createSuper(DeathSystem);
        function DeathSystem() {
          _classCallCheck(this, DeathSystem);
          return _super2.call(this);
        }
        _createClass(DeathSystem, [{
          key: "filter",
          value: function filter() {
...
System.register("chunks:///_virtual/DeathExpComp.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './ECS.ts', './AfterDeathMarkerComp.ts'], function (exports) {
  var _inherits, _createSuper, _classCallCheck, _createClass, cclegacy, ecs, AfterDeathMarkerComp;
  return {
    setters: [function (module) {
      _inherits = module.inherits;
      _createSuper = module.createSuper;
    ...
    execute: function () {
      ...
      var DeathExpComp = exports('DeathExpComp', (_dec = ecs.register('DeathExpComp'), _dec(_class = /*#__PURE__*/function (_ecs$Comp) {
        _inherits(DeathExpComp, _ecs$Comp);
        var _super = _createSuper(DeathExpComp);
        function DeathExpComp() {
          _classCallCheck(this, DeathExpComp);
          return _super.apply(this, arguments);
        }
        _createClass(DeathExpComp, [{
          key: "reset",
          value: function reset() {}
        }]);
        return DeathExpComp;
      ...
      var DeathExpSystem = exports('DeathExpSystem', /*#__PURE__*/function (_ecs$ComblockSystem) {
        _inherits(DeathExpSystem, _ecs$ComblockSystem);
        var _super2 = _createSuper(DeathExpSystem);
        function DeathExpSystem() {
          _classCallCheck(this, DeathExpSystem);
          return _super2.call(this);
        }
        _createClass(DeathExpSystem, [{
          key: "filter",
          value: function filter() {
...
System.register("chunks:///_virtual/DirectionComp.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './ECS.ts'], function (exports) {
  var _inherits, _createSuper, _classCallCheck, _defineProperty, _assertThisInitialized, _createClass, cclegacy, v3, Vec3, ecs;
  return {
    setters: [function (module) {
      _inherits = module.inherits;
      _createSuper = module.createSuper;
    ...
    execute: function () {
      ...
      var DirectionComp = exports('DirectionComp', (_dec = ecs.register('DirectionComp'), _dec(_class = /*#__PURE__*/function (_ecs$Comp) {
        _inherits(DirectionComp, _ecs$Comp);
        var _super = _createSuper(DirectionComp);
        function DirectionComp() {
          var _this;
          _classCallCheck(this, DirectionComp);
          for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
            args[_key] = arguments[_key];
          }
          _this = _super.call.apply(_super, [this].concat(args));
          /**方向 */
          _defineProperty(_assertThisInitialized(_this), "_direction", v3(0, 0, 0));
          /** 权重 */
          _defineProperty(_assertThisInitialized(_this), "weight", -1);
          return _this;
        }
        _createClass(DirectionComp, [{
          ...
          key: "setDirection",
          value: function setDirection(data) {
      ...
      var ResetDirectionSystem = exports('ResetDirectionSystem', /*#__PURE__*/function (_ecs$ComblockSystem) {
        _inherits(ResetDirectionSystem, _ecs$ComblockSystem);
        var _super2 = _createSuper(ResetDirectionSystem);
        function ResetDirectionSystem() {
          _classCallCheck(this, ResetDirectionSystem);
          return _super2.call(this);
        }
        _createClass(ResetDirectionSystem, [{
          key: "filter",
          value: function filter() {
...
System.register("chunks:///_virtual/DoubleCastComp.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './ECS.ts', './SkillRenderComp.ts', './SkillPluginConfig.ts'], function (exports) {
  var _inherits, _createSuper, _classCallCheck, _createClass, cclegacy, _decorator, ecs, SkillRenderComp, DB_SkillPluginConfig;
  return {
    setters: [function (module) {
      _inherits = module.inherits;
      _createSuper = module.createSuper;
    ...
    execute: function () {
      ...
      var DoubleCastComp = exports('DoubleCastComp', (_dec = ccclass('DoubleCastComp'), _dec2 = ecs.register('DoubleCastComp'), _dec(_class = _dec2(_class = /*#__PURE__*/function (_SkillRenderComp) {
        _inherits(DoubleCastComp, _SkillRenderComp);
        var _super = _createSuper(DoubleCastComp);
        function DoubleCastComp() {
          _classCallCheck(this, DoubleCastComp);
          return _super.apply(this, arguments);
        }
        _createClass(DoubleCastComp, [{
          key: "initSkill",
          value: function initSkill() {
            var config = DB_SkillPluginConfig[this.skillId];
            var extraCast = config.extraCast;
      ...
      var DoubleCastSystem = exports('DoubleCastSystem', /*#__PURE__*/function (_ecs$ComblockSystem) {
        _inherits(DoubleCastSystem, _ecs$ComblockSystem);
        var _super2 = _createSuper(DoubleCastSystem);
        function DoubleCastSystem() {
          _classCallCheck(this, DoubleCastSystem);
          return _super2.call(this);
        }
        _createClass(DoubleCastSystem, [{
          key: "filter",
          value: function filter() {
...
System.register("chunks:///_virtual/Drop.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './cc-comp-frame-animation.ts', './ECS.ts', './ItemPrefab.ts', './DropModelComp.ts', './BaseUnit.ts', './FrameAnimation.ts'], function (exports) {
  var _applyDecoratedDescriptor, _inherits, _createSuper, _classCallCheck, _initializerDefineProperty, _assertThisInitialized, _createClass, cclegacy, _decorator, Node, ecs, ItemPrefab, DropModelComp, BaaseUnit, FrameAnimation;
  return {
    setters: [function (module) {
      _applyDecoratedDescriptor = module.applyDecoratedDescriptor;
      _inherits = module.inherits;
    ...
    execute: function () {
      ...
      var Drop = exports('Drop', (_dec = ccclass('Drop'), _dec2 = ecs.register('Drop', false), _dec3 = property(FrameAnimation), _dec4 = property(Node), _dec(_class = _dec2(_class = (_class2 = /*#__PURE__*/function (_BaaseUnit) {
        ...
        function Drop() {
          ...
          _this = _super.call.apply(_super, [this].concat(args));
          _initializerDefineProperty(_assertThisInitialized(_this), "aniClip", _descriptor, _assertThisInitialized(_this));
          _initializerDefineProperty(_assertThisInitialized(_this), "itemNode", _descriptor2, _assertThisInitialized(_this));
          return _this;
        }
        _createClass(Drop, [{
          key: "initUI",
...
System.register("chunks:///_virtual/DropComp.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './DropModelComp.ts', './DropEntity.ts', './IsPlayerComp.ts', './BerforeDeathMarkerComp.ts', './PositionComp.ts', './RoleModelComp.ts', './BattleUtil.ts', './app.ts', './RoleConfig.ts', './SkillPluginConfig.ts', './ECS.ts', './ConstType.ts'], function (exports) {
  var _inherits, _createSuper, _classCallCheck, _createClass, cclegacy, _decorator, DropModelComp, DropEntity, IsPlayerComp, BerforeDeathMarkerComp, PositionComp, RoleModelComp, BattleUtil, app, DB_RoleConfig, DB_SkillPluginConfig, ecs, RoleType, ItemType;
  return {
    setters: [function (module) {
      _inherits = module.inherits;
      _createSuper = module.createSuper;
    ...
    execute: function () {
      ...
      var DropComp = exports('DropComp', (_dec = ccclass('DropComp'), _dec2 = ecs.register('DropComp'), _dec(_class = _dec2(_class = /*#__PURE__*/function (_ecs$Comp) {
        _inherits(DropComp, _ecs$Comp);
        var _super = _createSuper(DropComp);
        function DropComp() {
          _classCallCheck(this, DropComp);
          return _super.apply(this, arguments);
        }
        _createClass(DropComp, [{
          key: "reset",
          value: function reset() {}
        }]);
        return DropComp;
      ...
      var DropSystem = exports('DropSystem', /*#__PURE__*/function (_ecs$ComblockSystem) {
        _inherits(DropSystem, _ecs$ComblockSystem);
        var _super2 = _createSuper(DropSystem);
        function DropSystem() {
          _classCallCheck(this, DropSystem);
          return _super2.call(this);
        }
        _createClass(DropSystem, [{
          key: "filter",
          value: function filter() {
...
System.register("chunks:///_virtual/DropEntity.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './ECS.ts', './BaseEntity.ts', './EnabledComp.ts', './FactionTypeComp.ts', './UnitComp.ts', './PositionComp.ts', './DropModelComp.ts', './DropViewComp.ts', './DirectionComp.ts', './DropItemAfterDeathComp.ts', './IsDropComp.ts'], function (exports) {
  var _inherits, _createSuper, _classCallCheck, _createClass, _get, _getPrototypeOf, cclegacy, ecs, BaseEntity, EnabledComp, FactionTypeComp, UnitComp, PositionComp, DropModelComp, DropViewComp, DirectionComp, DropItemAfterDeathComp, IsDropComp;
  return {
    setters: [function (module) {
      _inherits = module.inherits;
      _createSuper = module.createSuper;
    ...
    execute: function () {
      ...
      var DropEntity = exports('DropEntity', (_dec = ecs.register('DropEntity'), _dec(_class = /*#__PURE__*/function (_BaseEntity) {
        _inherits(DropEntity, _BaseEntity);
        var _super = _createSuper(DropEntity);
        function DropEntity() {
          _classCallCheck(this, DropEntity);
          return _super.apply(this, arguments);
        }
        _createClass(DropEntity, [{
          key: "init",
          value: function init() {
            _get(_getPrototypeOf(DropEntity.prototype), "init", this).call(this);
...
System.register("chunks:///_virtual/DropItemAfterDeathComp.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './ECS.ts', './AfterDeathMarkerComp.ts', './UnitComp.ts'], function (exports) {
  var _inherits, _createSuper, _classCallCheck, _defineProperty, _assertThisInitialized, _createClass, cclegacy, ecs, AfterDeathMarkerComp, UnitComp;
  return {
    setters: [function (module) {
      _inherits = module.inherits;
      _createSuper = module.createSuper;
    ...
    execute: function () {
      ...
      var DropItemAfterDeathComp = exports('DropItemAfterDeathComp', (_dec = ecs.register('DropItemAfterDeathComp'), _dec(_class = /*#__PURE__*/function (_ecs$Comp) {
        _inherits(DropItemAfterDeathComp, _ecs$Comp);
        var _super = _createSuper(DropItemAfterDeathComp);
        function DropItemAfterDeathComp() {
          var _this;
          _classCallCheck(this, DropItemAfterDeathComp);
          for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
            args[_key] = arguments[_key];
          }
          _this = _super.call.apply(_super, [this].concat(args));
          //当前时间
          _defineProperty(_assertThisInitialized(_this), "curTime", 0.2);
          return _this;
        }
        _createClass(DropItemAfterDeathComp, [{
          key: "reset",
          value: function reset() {
            this.curTime = 0.2;
          }
      ...
      var DropItemAfterDeathSystem = exports('DropItemAfterDeathSystem', /*#__PURE__*/function (_ecs$ComblockSystem) {
        _inherits(DropItemAfterDeathSystem, _ecs$ComblockSystem);
        var _super2 = _createSuper(DropItemAfterDeathSystem);
        function DropItemAfterDeathSystem() {
          _classCallCheck(this, DropItemAfterDeathSystem);
          return _super2.call(this);
        }
        _createClass(DropItemAfterDeathSystem, [{
          key: "filter",
          value: function filter() {
          ...
          value: function entityEnter(e) {
            var _e$get$unit;
            (_e$get$unit = e.get(UnitComp).unit) === null || _e$get$unit === void 0 || _e$get$unit.removeCollision();
  ...
  return {
    ...
    execute: function () {
      ...
      var DropModelComp = exports('DropModelComp', (_dec = ecs.register('DropModelComp'), _dec(_class = /*#__PURE__*/function (_ecs$Comp) {
        _inherits(DropModelComp, _ecs$Comp);
        var _super = _createSuper(DropModelComp);
        function DropModelComp() {
          var _this;
          _classCallCheck(this, DropModelComp);
          for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
            args[_key] = arguments[_key];
          }
          _this = _super.call.apply(_super, [this].concat(args));
...
System.register("chunks:///_virtual/DropPlayerExpComp.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './RoleConfig.ts', './ECS.ts', './ConstType.ts', './IsPlayerComp.ts', './BerforeDeathMarkerComp.ts', './RoleModelComp.ts', './UpgradeComp.ts', './app.ts'], function (exports) {
  var _inherits, _createSuper, _classCallCheck, _createClass, cclegacy, _decorator, DB_RoleConfig, ecs, RoleType, IsPlayerComp, BerforeDeathMarkerComp, RoleModelComp, UpgradeComp, app;
  return {
    setters: [function (module) {
      _inherits = module.inherits;
      _createSuper = module.createSuper;
    ...
    execute: function () {
      ...
      var DropPlayerExpComp = exports('DropPlayerExpComp', (_dec = ccclass('DropPlayerExpComp'), _dec2 = ecs.register('DropPlayerExpComp'), _dec(_class = _dec2(_class = /*#__PURE__*/function (_ecs$Comp) {
        _inherits(DropPlayerExpComp, _ecs$Comp);
        var _super = _createSuper(DropPlayerExpComp);
        function DropPlayerExpComp() {
          _classCallCheck(this, DropPlayerExpComp);
          return _super.apply(this, arguments);
        }
        _createClass(DropPlayerExpComp, [{
          key: "reset",
          value: function reset() {}
        }]);
      ...
      var DropPlayerExpSystem = exports('DropPlayerExpSystem', /*#__PURE__*/function (_ecs$ComblockSystem) {
        _inherits(DropPlayerExpSystem, _ecs$ComblockSystem);
        var _super2 = _createSuper(DropPlayerExpSystem);
        function DropPlayerExpSystem() {
          _classCallCheck(this, DropPlayerExpSystem);
          return _super2.call(this);
        }
        _createClass(DropPlayerExpSystem, [{
          key: "filter",
          value: function filter() {
...
System.register("chunks:///_virtual/DropTaskExpComp.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './RoleConfig.ts', './ECS.ts', './ConstType.ts', './IsPlayerComp.ts', './BerforeDeathMarkerComp.ts', './RoleModelComp.ts', './TaskModelComp.ts', './app.ts'], function (exports) {
  var _inherits, _createSuper, _classCallCheck, _createClass, cclegacy, _decorator, DB_RoleConfig, ecs, RoleType, IsPlayerComp, BerforeDeathMarkerComp, RoleModelComp, TaskModelComp, app;
  return {
    setters: [function (module) {
      _inherits = module.inherits;
      _createSuper = module.createSuper;
    ...
    execute: function () {
      ...
      var DropTaskExpComp = exports('DropTaskExpComp', (_dec = ccclass('DropTaskExpComp'), _dec2 = ecs.register('DropTaskExpComp'), _dec(_class = _dec2(_class = /*#__PURE__*/function (_ecs$Comp) {
        _inherits(DropTaskExpComp, _ecs$Comp);
        var _super = _createSuper(DropTaskExpComp);
        function DropTaskExpComp() {
          _classCallCheck(this, DropTaskExpComp);
          return _super.apply(this, arguments);
        }
        _createClass(DropTaskExpComp, [{
          key: "reset",
          value: function reset() {}
        }]);
      ...
      var DropTaskExpSystem = exports('DropTaskExpSystem', /*#__PURE__*/function (_ecs$ComblockSystem) {
        _inherits(DropTaskExpSystem, _ecs$ComblockSystem);
        var _super2 = _createSuper(DropTaskExpSystem);
        function DropTaskExpSystem() {
          _classCallCheck(this, DropTaskExpSystem);
          return _super2.call(this);
        }
        _createClass(DropTaskExpSystem, [{
          key: "filter",
          value: function filter() {
...
System.register("chunks:///_virtual/DropViewComp.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './CollectDropComp.ts', './app.ts', './ECS.ts', './ConstType.ts', './BaseUnit.ts', './EnabledComp.ts', './PositionComp.ts', './UnitComp.ts', './Drop.ts'], function (exports) {
  var _inherits, _createSuper, _classCallCheck, _createClass, cclegacy, Prefab, instantiate, CollectDropComp, app, ecs, MapLayersType, BaaseUnit, EnabledComp, PositionComp, UnitComp, Drop;
  return {
    setters: [function (module) {
      _inherits = module.inherits;
      _createSuper = module.createSuper;
    ...
    execute: function () {
      ...
      var DropViewComp = exports('DropViewComp', (_dec = ecs.register('DropViewComp'), _dec(_class = /*#__PURE__*/function (_ecs$Comp) {
        _inherits(DropViewComp, _ecs$Comp);
        var _super = _createSuper(DropViewComp);
        function DropViewComp() {
          _classCallCheck(this, DropViewComp);
          return _super.apply(this, arguments);
        }
        _createClass(DropViewComp, [{
          key: "reset",
          value: function reset() {}
        }]);
        return DropViewComp;
      ...
      var DropViewSystem = exports('DropViewSystem', /*#__PURE__*/function (_ecs$ComblockSystem) {
        _inherits(DropViewSystem, _ecs$ComblockSystem);
        var _super2 = _createSuper(DropViewSystem);
        function DropViewSystem() {
          _classCallCheck(this, DropViewSystem);
          return _super2.call(this);
        }
        _createClass(DropViewSystem, [{
          key: "filter",
          value: function filter() {
...
System.register("chunks:///_virtual/DropViewLoadComp.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './ECS.ts', './ConstType.ts'], function (exports) {
  var _inherits, _createSuper, _classCallCheck, _createClass, cclegacy, ecs, MapLayersType;
  return {
    setters: [function (module) {
      _inherits = module.inherits;
      _createSuper = module.createSuper;
    ...
    execute: function () {
      ...
      var DropViewLoadComp = exports('DropViewLoadComp', (_dec = ecs.register('DropViewLoadComp'), _dec(_class = /*#__PURE__*/function (_ecs$Comp) {
        _inherits(DropViewLoadComp, _ecs$Comp);
        var _super = _createSuper(DropViewLoadComp);
        function DropViewLoadComp() {
          _classCallCheck(this, DropViewLoadComp);
          return _super.apply(this, arguments);
        }
        _createClass(DropViewLoadComp, [{
          key: "reset",
          value: function reset() {}
        }]);
      ...
      var DropViewLoadSystem = exports('DropViewLoadSystem', /*#__PURE__*/function (_ecs$ComblockSystem) {
        _inherits(DropViewLoadSystem, _ecs$ComblockSystem);
        var _super2 = _createSuper(DropViewLoadSystem);
        function DropViewLoadSystem() {
          _classCallCheck(this, DropViewLoadSystem);
          return _super2.call(this);
        }
        _createClass(DropViewLoadSystem, [{
          key: "filter",
          value: function filter() {
  ...
  return {
    ...
    execute: function () {
      ...
      var DungeonComp = exports('DungeonComp', (_dec = ccclass('DungeonComp'), _dec2 = ecs.register('DungeonComp'), _dec(_class = _dec2(_class = /*#__PURE__*/function (_ecs$Comp) {
        _inherits(DungeonComp, _ecs$Comp);
        var _super = _createSuper(DungeonComp);
        function DungeonComp() {
          _classCallCheck(this, DungeonComp);
          return _super.apply(this, arguments);
        }
        _createClass(DungeonComp, [{
          key: "reset",
          value: function reset() {}
        }]);
        return DungeonComp;
      ...
      var DungeonSystem = exports('DungeonSystem', /*#__PURE__*/function (_ecs$ComblockSystem) {
        _inherits(DungeonSystem, _ecs$ComblockSystem);
        var _super2 = _createSuper(DungeonSystem);
        function DungeonSystem() {
          _classCallCheck(this, DungeonSystem);
          return _super2.call(this);
        }
        _createClass(DungeonSystem, [{
          key: "filter",
          value: function filter() {
  ...
  return {
    ...
    execute: function () {
      ...
      var EnabledComp = exports('EnabledComp', (_dec = ecs.register('EnabledComp'), _dec(_class = /*#__PURE__*/function (_ecs$Comp) {
        _inherits(EnabledComp, _ecs$Comp);
        var _super = _createSuper(EnabledComp);
        function EnabledComp() {
          var _this;
          _classCallCheck(this, EnabledComp);
          for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
            args[_key] = arguments[_key];
          }
          _this = _super.call.apply(_super, [this].concat(args));
          _defineProperty(_assertThisInitialized(_this), "enable", true);
          return _this;
        }
        _createClass(EnabledComp, [{
          key: "reset",
          value: function reset() {}
        }]);
        return EnabledComp;
...
System.register("chunks:///_virtual/Enemy1FsmComp.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './ECS.ts', './ConstType.ts', './PursueComp.ts', './PursuePlayerMoveComp.ts', './RoleAutoCastComp.ts', './SkeletonViewComp.ts', './StateMachineComp.ts', './AtkDetectorComp.ts'], function (exports) {
  var _inherits, _createSuper, _classCallCheck, _createClass, cclegacy, _decorator, ecs, RoleStateMachineType, RoleAnimType, PursueComp, PursuePlayerMoveComp, RoleAutoCastComp, SkeletonViewComp, StateMachineComp, AtkDetectorComp;
  return {
    setters: [function (module) {
      _inherits = module.inherits;
      _createSuper = module.createSuper;
    ...
    execute: function () {
      ...
      var Enemy1FsmComp = exports('Enemy1FsmComp', (_dec = ccclass('Enemy1FsmComp'), _dec2 = ecs.register('Enemy1FsmComp'), _dec(_class = _dec2(_class = /*#__PURE__*/function (_ecs$Comp) {
        _inherits(Enemy1FsmComp, _ecs$Comp);
        var _super = _createSuper(Enemy1FsmComp);
        function Enemy1FsmComp() {
          _classCallCheck(this, Enemy1FsmComp);
          return _super.apply(this, arguments);
        }
        _createClass(Enemy1FsmComp, [{
          key: "reset",
          value: function reset() {}
        }]);
      ...
      var Enemy1FsmSystem = exports('Enemy1FsmSystem', /*#__PURE__*/function (_ecs$ComblockSystem) {
        _inherits(Enemy1FsmSystem, _ecs$ComblockSystem);
        var _super2 = _createSuper(Enemy1FsmSystem);
        function Enemy1FsmSystem() {
          _classCallCheck(this, Enemy1FsmSystem);
          return _super2.call(this);
        }
        _createClass(Enemy1FsmSystem, [{
          key: "filter",
          value: function filter() {
          ...
          value: function entityEnter(e) {
            ...
            var move = {
              enter: function enter() {
                ...
                (_e$get = e.get(SkeletonViewComp)) === null || _e$get === void 0 || _e$get.playAnim(RoleAnimType.idle);
            ...
            var pursue = {
              enter: function enter() {
                ...
                (_e$get2 = e.get(SkeletonViewComp)) === null || _e$get2 === void 0 || _e$get2.playAnim(RoleAnimType.idle);
...
System.register("chunks:///_virtual/FactionTypeComp.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './ECS.ts', './ConstType.ts'], function (exports) {
  var _inherits, _createSuper, _classCallCheck, _defineProperty, _assertThisInitialized, _createClass, cclegacy, PhysicsSystem, ecs, FactionType;
  return {
    setters: [function (module) {
      _inherits = module.inherits;
      _createSuper = module.createSuper;
    ...
    execute: function () {
      ...
      var FactionTypeComp = exports('FactionTypeComp', (_dec = ecs.register('FactionTypeComp'), _dec(_class = /*#__PURE__*/function (_ecs$Comp) {
        _inherits(FactionTypeComp, _ecs$Comp);
        var _super = _createSuper(FactionTypeComp);
        function FactionTypeComp() {
          var _this;
          _classCallCheck(this, FactionTypeComp);
          for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
            args[_key] = arguments[_key];
          }
          _this = _super.call.apply(_super, [this].concat(args));
          /**阵营 */
          _defineProperty(_assertThisInitialized(_this), "faction", void 0);
          /**类型 */
        ...
        _createClass(FactionTypeComp, [{
          ...
          key: "getGroupByFaction",
          value: function getGroupByFaction(faction) {
            var group = PhysicsSystem.PhysicsGroup;
          ...
          key: "getMaskByFaction",
          value: function getMaskByFaction(faction) {
            var group = PhysicsSystem.PhysicsGroup;
            if (faction == FactionType.ENEMY) {
              return group['ALLY'];
            } else if (faction == FactionType.ALLY) {
...
System.register("chunks:///_virtual/Fireball.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './cc-comp-frame-animation.ts', './FactionTypeComp.ts', './SkillCompManagerComp.ts', './CollisionComp.ts', './BaseUnit.ts', './FrameAnimation.ts'], function (exports) {
  var _applyDecoratedDescriptor, _inherits, _createSuper, _classCallCheck, _initializerDefineProperty, _assertThisInitialized, _createClass, _get, _getPrototypeOf, cclegacy, _decorator, PhysicsSystem, FactionTypeComp, SkillCompManagerComp, CollisionComp, BaaseUnit, FrameAnimation;
  return {
    setters: [function (module) {
      _applyDecoratedDescriptor = module.applyDecoratedDescriptor;
      _inherits = module.inherits;
      ...
      var Fireball = exports('Fireball', (_dec = ccclass('Fireball'), _dec2 = property(FrameAnimation), _dec(_class = (_class2 = /*#__PURE__*/function (_BaaseUnit) {
        ...
        _createClass(Fireball, [{
          ...
          value: function onLoad() {
            ...
            this.maxRadius = 15;
            this.ent.get(SkillCompManagerComp).addCompByid(200101);
            _get(_getPrototypeOf(Fireball.prototype), "onLoad", this).call(this);
          }
...
System.register("chunks:///_virtual/FireballComp.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './ECS.ts', './SkillRenderComp.ts', './PositionComp.ts', './app.ts', './ConstType.ts', './BaseUnit.ts', './EnabledComp.ts', './UnitComp.ts'], function (exports) {
  var _inherits, _createSuper, _classCallCheck, _createClass, cclegacy, _decorator, Prefab, instantiate, ecs, SkillRenderComp, PositionComp, app, MapLayersType, BaaseUnit, EnabledComp, UnitComp;
  return {
    setters: [function (module) {
      _inherits = module.inherits;
      _createSuper = module.createSuper;
    ...
    execute: function () {
      ...
      var FireballComp = exports('FireballComp', (_dec = ccclass('FireballComp'), _dec2 = ecs.register('FireballComp'), _dec(_class = _dec2(_class = /*#__PURE__*/function (_SkillRenderComp) {
        _inherits(FireballComp, _SkillRenderComp);
        var _super = _createSuper(FireballComp);
        function FireballComp() {
          _classCallCheck(this, FireballComp);
          return _super.apply(this, arguments);
        }
        _createClass(FireballComp, [{
          key: "reset",
          value: function reset() {}
        }]);
        return FireballComp;
      ...
      var FireballSystem = exports('FireballSystem', /*#__PURE__*/function (_ecs$ComblockSystem) {
        _inherits(FireballSystem, _ecs$ComblockSystem);
        var _super2 = _createSuper(FireballSystem);
        function FireballSystem() {
          _classCallCheck(this, FireballSystem);
          return _super2.call(this);
        }
        _createClass(FireballSystem, [{
          key: "filter",
          value: function filter() {
...
System.register("chunks:///_virtual/FixedEntPositionComp.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './ECS.ts', './PositionComp.ts'], function (exports) {
  var _inherits, _createSuper, _classCallCheck, _defineProperty, _assertThisInitialized, _createClass, cclegacy, ecs, PositionComp;
  return {
    setters: [function (module) {
      _inherits = module.inherits;
      _createSuper = module.createSuper;
    ...
    execute: function () {
      ...
      var FixedEntPositionComp = exports('FixedEntPositionComp', (_dec = ecs.register('FixedEntPositionComp'), _dec(_class = /*#__PURE__*/function (_ecs$Comp) {
        _inherits(FixedEntPositionComp, _ecs$Comp);
        var _super = _createSuper(FixedEntPositionComp);
        function FixedEntPositionComp() {
          var _this;
          _classCallCheck(this, FixedEntPositionComp);
          for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
            args[_key] = arguments[_key];
          }
          _this = _super.call.apply(_super, [this].concat(args));
          _defineProperty(_assertThisInitialized(_this), "fixedEnt", null);
          return _this;
        }
        _createClass(FixedEntPositionComp, [{
          key: "reset",
          value: function reset() {}
        }]);
      ...
      var FixedEntPositionSystem = exports('FixedEntPositionSystem', /*#__PURE__*/function (_ecs$ComblockSystem) {
        _inherits(FixedEntPositionSystem, _ecs$ComblockSystem);
        var _super2 = _createSuper(FixedEntPositionSystem);
        function FixedEntPositionSystem() {
          _classCallCheck(this, FixedEntPositionSystem);
          return _super2.call(this);
        }
        _createClass(FixedEntPositionSystem, [{
          key: "filter",
          value: function filter() {
...
System.register("chunks:///_virtual/GameFailComp.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './app.ts', './ECS.ts'], function (exports) {
  var _inherits, _createSuper, _classCallCheck, _createClass, cclegacy, app, ecs;
  return {
    setters: [function (module) {
      _inherits = module.inherits;
      _createSuper = module.createSuper;
    ...
    execute: function () {
      ...
      var GameFailComp = exports('GameFailComp', (_dec = ecs.register('GameFailComp'), _dec(_class = /*#__PURE__*/function (_ecs$Comp) {
        _inherits(GameFailComp, _ecs$Comp);
        var _super = _createSuper(GameFailComp);
        function GameFailComp() {
          _classCallCheck(this, GameFailComp);
          return _super.apply(this, arguments);
        }
        _createClass(GameFailComp, [{
          key: "reset",
          value: function reset() {}
        }]);
        return GameFailComp;
      ...
      var GameFailSystem = exports('GameFailSystem', /*#__PURE__*/function (_ecs$ComblockSystem) {
        _inherits(GameFailSystem, _ecs$ComblockSystem);
        var _super2 = _createSuper(GameFailSystem);
        function GameFailSystem() {
          _classCallCheck(this, GameFailSystem);
          return _super2.call(this);
        }
        _createClass(GameFailSystem, [{
          key: "filter",
          value: function filter() {
  ...
  return {
    ...
    execute: function () {
      ...
      var GameSuccessComp = exports('GameSuccessComp', (_dec = ecs.register('GameSuccessComp'), _dec(_class = /*#__PURE__*/function (_ecs$Comp) {
        _inherits(GameSuccessComp, _ecs$Comp);
        var _super = _createSuper(GameSuccessComp);
        function GameSuccessComp() {
          _classCallCheck(this, GameSuccessComp);
          return _super.apply(this, arguments);
        }
        _createClass(GameSuccessComp, [{
          key: "reset",
          value: function reset() {}
        }]);
      ...
      var GameSuccessSystem = exports('GameSuccessSystem', /*#__PURE__*/function (_ecs$ComblockSystem) {
        _inherits(GameSuccessSystem, _ecs$ComblockSystem);
        var _super2 = _createSuper(GameSuccessSystem);
        function GameSuccessSystem() {
          _classCallCheck(this, GameSuccessSystem);
          return _super2.call(this);
        }
        _createClass(GameSuccessSystem, [{
          key: "filter",
          value: function filter() {
...
System.register("chunks:///_virtual/GenerateOneRoleComp.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './ECS.ts', './BattleUtil.ts', './MapModelComp.ts', './MonsterFactoryConfig.ts', './CreateRoleComp.ts', './ConstType.ts', './TaskRoleComp.ts', './TaskConfig.ts', './TaskModelComp.ts', './app.ts', './PositionComp.ts'], function (exports) {
  var _inherits, _createSuper, _classCallCheck, _createClass, cclegacy, _decorator, v3, ecs, BattleUtil, MapModelComp, DB_MonsterFactoryConfig, CreateRoleComp, FactionType, TaskRoleComp, DB_TaskConfig, TaskModelComp, app, PositionComp;
  return {
    setters: [function (module) {
      _inherits = module.inherits;
      _createSuper = module.createSuper;
    ...
    execute: function () {
      ...
      var GenerateOneRoleComp = exports('GenerateOneRoleComp', (_dec = ccclass('GenerateOneRoleComp'), _dec2 = ecs.register('GenerateOneRoleComp'), _dec(_class = _dec2(_class = /*#__PURE__*/function (_ecs$Comp) {
        _inherits(GenerateOneRoleComp, _ecs$Comp);
        var _super = _createSuper(GenerateOneRoleComp);
        function GenerateOneRoleComp() {
          _classCallCheck(this, GenerateOneRoleComp);
          return _super.apply(this, arguments);
        }
        _createClass(GenerateOneRoleComp, [{
          key: "reset",
          value: function reset() {}
        }]);
      ...
      var GenerateOneRoleSystem = exports('GenerateOneRoleSystem', /*#__PURE__*/function (_ecs$ComblockSystem) {
        _inherits(GenerateOneRoleSystem, _ecs$ComblockSystem);
        var _super2 = _createSuper(GenerateOneRoleSystem);
        function GenerateOneRoleSystem() {
          _classCallCheck(this, GenerateOneRoleSystem);
          return _super2.call(this);
        }
        _createClass(GenerateOneRoleSystem, [{
          key: "filter",
          value: function filter() {
          ...
          value: function getRandomMonsterId(e) {
          ...
          key: "getRandomPositionAroundPlayer",
          value: function getRandomPositionAroundPlayer(mapComp) {
...
System.register("chunks:///_virtual/HpComp.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './ECS.ts', './ConstType.ts', './DamageFlyTextComp.ts', './FactionTypeComp.ts', './AfterDeathMarkerComp.ts', './BerforeDeathMarkerComp.ts', './SkeletonViewComp.ts'], function (exports) {
  var _inherits, _createSuper, _classCallCheck, _defineProperty, _assertThisInitialized, _createClass, cclegacy, ecs, EntityType, RoleAnimType, DamageFlyTextComp, FactionTypeComp, AfterDeathMarkerComp, BerforeDeathMarkerComp, SkeletonViewComp;
  return {
    setters: [function (module) {
      _inherits = module.inherits;
      _createSuper = module.createSuper;
    ...
    execute: function () {
      ...
      var HpComp = exports('HpComp', (_dec = ecs.register('HpComp'), _dec(_class = /*#__PURE__*/function (_ecs$Comp) {
        _inherits(HpComp, _ecs$Comp);
        var _super = _createSuper(HpComp);
        function HpComp() {
          var _this;
          _classCallCheck(this, HpComp);
          for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
            args[_key] = arguments[_key];
          }
          _this = _super.call.apply(_super, [this].concat(args));
          _defineProperty(_assertThisInitialized(_this), "hp", 0);
          //变化的血量
          _defineProperty(_assertThisInitialized(_this), "changeHp", []);
          return _this;
        }
        _createClass(HpComp, [{
          key: "init",
          ...
          key: "addHp",
          value: function addHp(data) {
            this.changeHp.push(data);
          }
        }, {
          key: "clearChangeHp",
          value: function clearChangeHp() {
            this.changeHp = [];
          }
        }, {
          key: "reset",
      ...
      var HpSystem = exports('HpSystem', /*#__PURE__*/function (_ecs$ComblockSystem) {
        _inherits(HpSystem, _ecs$ComblockSystem);
        var _super2 = _createSuper(HpSystem);
        function HpSystem() {
          _classCallCheck(this, HpSystem);
          return _super2.call(this);
        }
        _createClass(HpSystem, [{
          key: "filter",
          value: function filter() {
...
System.register("chunks:///_virtual/InfiniteMapCom.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './ECS.ts', './app.ts', './ConstType.ts', './PositionComp.ts', './MapModelComp.ts'], function (exports) {
  var _inherits, _createSuper, _classCallCheck, _defineProperty, _assertThisInitialized, _createClass, _slicedToArray, cclegacy, _decorator, Size, view, Node, Sprite, UITransform, SpriteFrame, ecs, app, MapLayersType, PositionComp, MapModelComp;
  return {
    setters: [function (module) {
      _inherits = module.inherits;
      _createSuper = module.createSuper;
    ...
    execute: function () {
      ...
      var InfiniteMapCom = exports('InfiniteMapCom', (_dec = ccclass('InfiniteMapCom'), _dec2 = ecs.register('InfiniteMapCom'), _dec(_class = _dec2(_class = /*#__PURE__*/function (_ecs$Comp) {
        _inherits(InfiniteMapCom, _ecs$Comp);
        var _super = _createSuper(InfiniteMapCom);
        function InfiniteMapCom() {
          var _this;
          _classCallCheck(this, InfiniteMapCom);
          for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
            args[_key] = arguments[_key];
          }
          _this = _super.call.apply(_super, [this].concat(args));
          // 视图大小
          _defineProperty(_assertThisInitialized(_this), "viewSize", new Size(0, 0));
          // 地图块大小
          _defineProperty(_assertThisInitialized(_this), "chunkSize", 512);
          // 已加载的地图块
          _defineProperty(_assertThisInitialized(_this), "loadedChunks", new Map());
          //地图块对象池
          _defineProperty(_assertThisInitialized(_this), "chunkPool", []);
          return _this;
        }
        _createClass(InfiniteMapCom, [{
          key: "reset",
          value: function reset() {
      ...
      var InfiniteMapSystem = exports('InfiniteMapSystem', /*#__PURE__*/function (_ref) {
        _inherits(InfiniteMapSystem, _ref);
        var _super2 = _createSuper(InfiniteMapSystem);
        function InfiniteMapSystem() {
          _classCallCheck(this, InfiniteMapSystem);
          return _super2.call(this);
        }
        _createClass(InfiniteMapSystem, [{
          key: "filter",
          value: function filter() {
          ...
          key: "getSurroundingChunks",
          value: function getSurroundingChunks(playerPos, viewSize, chunkSize) {
            ...
            for (var x = startX; x <= endX; x++) {
              for (var y = startY; y <= endY; y++) {
                surroundingChunks.add("".concat(x, "&").concat(y));
              }
            }
          ...
          key: "loadChunk",
          value: function loadChunk(comp, chunkKey) {
            var node;
            ...
            var _chunkKey$split$map = chunkKey.split('&').map(Number),
              _chunkKey$split$map2 = _slicedToArray(_chunkKey$split$map, 2),
              x = _chunkKey$split$map2[0],
              y = _chunkKey$split$map2[1];
          ...
          key: "unloadChunk",
          value: function unloadChunk(comp, chunkKey) {
  ...
  return {
    ...
    execute: function () {
      ...
      var IsDropComp = exports('IsDropComp', (_dec = ecs.register('IsDropComp'), _dec(_class = /*#__PURE__*/function (_ecs$Comp) {
        _inherits(IsDropComp, _ecs$Comp);
        var _super = _createSuper(IsDropComp);
        function IsDropComp() {
          _classCallCheck(this, IsDropComp);
          return _super.apply(this, arguments);
        }
        _createClass(IsDropComp, [{
          key: "reset",
          value: function reset() {}
        }]);
        return IsDropComp;
  ...
  return {
    ...
    execute: function () {
      ...
      var IsPlayerComp = exports('IsPlayerComp', (_dec = ecs.register('IsPlayerComp'), _dec(_class = /*#__PURE__*/function (_ecs$Comp) {
        _inherits(IsPlayerComp, _ecs$Comp);
        var _super = _createSuper(IsPlayerComp);
        function IsPlayerComp() {
          _classCallCheck(this, IsPlayerComp);
          return _super.apply(this, arguments);
        }
        _createClass(IsPlayerComp, [{
          key: "reset",
          value: function reset() {}
        }]);
        return IsPlayerComp;
  ...
  return {
    ...
    execute: function () {
      ...
      var IsRoleComp = exports('IsRoleComp', (_dec = ecs.register('IsRoleComp'), _dec(_class = /*#__PURE__*/function (_ecs$Comp) {
        _inherits(IsRoleComp, _ecs$Comp);
        var _super = _createSuper(IsRoleComp);
        function IsRoleComp() {
          _classCallCheck(this, IsRoleComp);
          return _super.apply(this, arguments);
        }
        _createClass(IsRoleComp, [{
          key: "reset",
          value: function reset() {}
        }]);
        return IsRoleComp;
  ...
  return {
    ...
    execute: function () {
      ...
      var IsSkillComp = exports('IsSkillComp', (_dec = ecs.register('IsSkillComp'), _dec(_class = /*#__PURE__*/function (_ecs$Comp) {
        _inherits(IsSkillComp, _ecs$Comp);
        var _super = _createSuper(IsSkillComp);
        function IsSkillComp() {
          _classCallCheck(this, IsSkillComp);
          return _super.apply(this, arguments);
        }
        _createClass(IsSkillComp, [{
          key: "reset",
          value: function reset() {}
        }]);
        return IsSkillComp;
      ...
      var IsSkillSystem = exports('IsSkillSystem', /*#__PURE__*/function (_ecs$ComblockSystem) {
        _inherits(IsSkillSystem, _ecs$ComblockSystem);
        var _super2 = _createSuper(IsSkillSystem);
        function IsSkillSystem() {
          _classCallCheck(this, IsSkillSystem);
          return _super2.call(this);
        }
        _createClass(IsSkillSystem, [{
          key: "filter",
          value: function filter() {
  ...
  return {
    ...
    execute: function () {
      ...
      var IsWeaponComp = exports('IsWeaponComp', (_dec = ecs.register('IsWeaponComp'), _dec(_class = /*#__PURE__*/function (_ecs$Comp) {
        _inherits(IsWeaponComp, _ecs$Comp);
        var _super = _createSuper(IsWeaponComp);
        function IsWeaponComp() {
          _classCallCheck(this, IsWeaponComp);
          return _super.apply(this, arguments);
        }
        _createClass(IsWeaponComp, [{
          key: "reset",
          value: function reset() {}
        }]);
        return IsWeaponComp;
...
System.register("chunks:///_virtual/ItemPrefab.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './ConstType.ts', './SkillPluginConfig.ts', './WeaponConfig.ts', './app.ts'], function (exports) {
  var _applyDecoratedDescriptor, _inherits, _createSuper, _classCallCheck, _initializerDefineProperty, _assertThisInitialized, _defineProperty, _createClass, cclegacy, _decorator, Node, Label, Button, SpriteFrame, Sprite, Component, ItemType, DB_SkillPluginConfig, DB_WeaponConfig, app;
  return {
    setters: [function (module) {
      _applyDecoratedDescriptor = module.applyDecoratedDescriptor;
      _inherits = module.inherits;
    ...
    execute: function () {
      ...
      var ItemPrefab = exports('ItemPrefab', (_dec = ccclass('ItemPrefab'), _dec2 = property(Node), _dec3 = property(Node), _dec4 = property(Label), _dec5 = property(Node), _dec(_class = (_class2 = /*#__PURE__*/function (_Component) {
        _inherits(ItemPrefab, _Component);
        var _super = _createSuper(ItemPrefab);
        function ItemPrefab() {
          var _this;
          _classCallCheck(this, ItemPrefab);
          for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
            args[_key] = arguments[_key];
          }
          _this = _super.call.apply(_super, [this].concat(args));
          _initializerDefineProperty(_assertThisInitialized(_this), "boxNode", _descriptor, _assertThisInitialized(_this));
          _initializerDefineProperty(_assertThisInitialized(_this), "iconNode", _descriptor2, _assertThisInitialized(_this));
          _initializerDefineProperty(_assertThisInitialized(_this), "nameLab", _descriptor3, _assertThisInitialized(_this));
          _initializerDefineProperty(_assertThisInitialized(_this), "selectNode", _descriptor4, _assertThisInitialized(_this));
          _defineProperty(_assertThisInitialized(_this), "_clickCb", void 0);
          return _this;
        }
        _createClass(ItemPrefab, [{
          key: "onLoad",
          value: function onLoad() {
            var _this2 = this;
          ...
          key: "updateUI",
          value: function updateUI(data, clickCb) {
            var _this3 = this;
...
System.register("chunks:///_virtual/LinearSkillMoveComp.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './SkillMoveComp.ts', './ECS.ts', './DirectionComp.ts', './SkillModelComp.ts'], function (exports) {
  var _inherits, _createSuper, _classCallCheck, _defineProperty, _assertThisInitialized, _createClass, cclegacy, _decorator, SkillMoveComp, ecs, DirectionComp, SkillModelComp;
  return {
    setters: [function (module) {
      _inherits = module.inherits;
      _createSuper = module.createSuper;
    ...
    execute: function () {
      ...
      var LinearSkillMoveComp = exports('LinearSkillMoveComp', (_dec = ccclass('LinearMoveComp'), _dec2 = ecs.register('LinearMoveComp'), _dec(_class = _dec2(_class = /*#__PURE__*/function (_SkillMoveComp) {
        _inherits(LinearSkillMoveComp, _SkillMoveComp);
        var _super = _createSuper(LinearSkillMoveComp);
        function LinearSkillMoveComp() {
          var _this;
          _classCallCheck(this, LinearSkillMoveComp);
          for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
            args[_key] = arguments[_key];
          }
          _this = _super.call.apply(_super, [this].concat(args));
        ...
        _createClass(LinearSkillMoveComp, [{
          key: "reset",
          value: function reset() {}
        }]);
      ...
      var LinearMoveSystem = exports('LinearMoveSystem', /*#__PURE__*/function (_ref) {
        _inherits(LinearMoveSystem, _ref);
        var _super2 = _createSuper(LinearMoveSystem);
        function LinearMoveSystem() {
          _classCallCheck(this, LinearMoveSystem);
          return _super2.call(this);
        }
        _createClass(LinearMoveSystem, [{
          key: "filter",
          value: function filter() {
...
System.register("chunks:///_virtual/MapCompEntity.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './ECS.ts', './BaseEntity.ts'], function (exports) {
  var _inherits, _createSuper, _classCallCheck, _createClass, _get, _getPrototypeOf, cclegacy, ecs, BaseEntity;
  return {
    setters: [function (module) {
      _inherits = module.inherits;
      _createSuper = module.createSuper;
    ...
    execute: function () {
      ...
      var MapCompEntity = exports('MapCompEntity', (_dec = ecs.register('MapCompEntity'), _dec(_class = /*#__PURE__*/function (_BaseEntity) {
        _inherits(MapCompEntity, _BaseEntity);
        var _super = _createSuper(MapCompEntity);
        function MapCompEntity() {
          _classCallCheck(this, MapCompEntity);
          return _super.apply(this, arguments);
        }
        _createClass(MapCompEntity, [{
          key: "init",
          value: function init() {
            _get(_getPrototypeOf(MapCompEntity.prototype), "init", this).call(this);
            this.addComponents();
          }
        }]);
...
System.register("chunks:///_virtual/MapEntity.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './ECS.ts', './BaseEntity.ts', './CameraFollowComp.ts', './MapModelComp.ts'], function (exports) {
  var _inherits, _createSuper, _classCallCheck, _createClass, _get, _getPrototypeOf, cclegacy, ecs, BaseEntity, CameraFollowComp, MapModelComp;
  return {
    setters: [function (module) {
      _inherits = module.inherits;
      _createSuper = module.createSuper;
    ...
    execute: function () {
      ...
      var MapEntity = exports('MapEntity', (_dec = ecs.register('MapEntity'), _dec(_class = /*#__PURE__*/function (_BaseEntity) {
        _inherits(MapEntity, _BaseEntity);
        var _super = _createSuper(MapEntity);
        function MapEntity() {
          _classCallCheck(this, MapEntity);
          return _super.apply(this, arguments);
        }
        _createClass(MapEntity, [{
          key: "init",
          value: function init() {
            _get(_getPrototypeOf(MapEntity.prototype), "init", this).call(this);
      ...
      var MapSystem = exports('MapSystem', /*#__PURE__*/function (_ecs$System) {
        _inherits(MapSystem, _ecs$System);
        var _super2 = _createSuper(MapSystem);
        function MapSystem() {
          _classCallCheck(this, MapSystem);
          return _super2.call(this);
        }
        return _createClass(MapSystem);
      }(ecs.System));
      cclegacy._RF.pop();
    }
  };
...
System.register("chunks:///_virtual/MapLoadComp.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './MapConfig.ts', './ECS.ts', './RoleEntity.ts', './RoleModelComp.ts', './ConstType.ts', './FactionTypeComp.ts', './PositionComp.ts', './PlayerShowComp.ts', './MapCompEntity.ts', './CompConfig.ts', './MapModelComp.ts', './CreateTaskComp.ts', './app.ts'], function (exports) {
  var _inherits, _createSuper, _classCallCheck, _defineProperty, _assertThisInitialized, _createClass, cclegacy, UITransform, Widget, v3, js, DB_MapConfig, ecs, RoleEntity, RoleModelComp, FactionType, EntityType, FactionTypeComp, PositionComp, PlayerShowComp, MapCompEntity, DB_CompConfig, MapModelComp, CreateTaskComp, app;
  return {
    setters: [function (module) {
      _inherits = module.inherits;
      _createSuper = module.createSuper;
    ...
    execute: function () {
      ...
      var MapLoadComp = exports('MapLoadComp', (_dec = ecs.register('MapLoadComp'), _dec(_class = /*#__PURE__*/function (_ecs$Comp) {
        _inherits(MapLoadComp, _ecs$Comp);
        var _super = _createSuper(MapLoadComp);
        function MapLoadComp() {
          var _this;
          _classCallCheck(this, MapLoadComp);
          for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
            args[_key] = arguments[_key];
          }
          _this = _super.call.apply(_super, [this].concat(args));
          _defineProperty(_assertThisInitialized(_this), "loadData", void 0);
          return _this;
        }
        _createClass(MapLoadComp, [{
          key: "init",
          value: function init(data) {
            var _data$mapLv;
            data.mapLv = (_data$mapLv = data.mapLv) !== null && _data$mapLv !== void 0 ? _data$mapLv : app.store.player.lv;
            this.loadData = data;
          }
        }, {
          key: "reset",
      ...
      var MapLoadSystem = exports('MapLoadSystem', /*#__PURE__*/function (_ecs$ComblockSystem) {
        _inherits(MapLoadSystem, _ecs$ComblockSystem);
        var _super2 = _createSuper(MapLoadSystem);
        function MapLoadSystem() {
          _classCallCheck(this, MapLoadSystem);
          return _super2.call(this);
        }
        _createClass(MapLoadSystem, [{
          key: "filter",
          value: function filter() {
  ...
  return {
    ...
    execute: function () {
      ...
      var MapModelComp = exports('MapModelComp', (_dec = ecs.register('MapModelComp'), _dec(_class = /*#__PURE__*/function (_ecs$Comp) {
        _inherits(MapModelComp, _ecs$Comp);
        var _super = _createSuper(MapModelComp);
        function MapModelComp() {
          var _this;
          _classCallCheck(this, MapModelComp);
          for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
            args[_key] = arguments[_key];
          }
          _this = _super.call.apply(_super, [this].concat(args));
          /** 地图名 */
          _defineProperty(_assertThisInitialized(_this), "name", 'map');
          /**地图id */
          _defineProperty(_assertThisInitialized(_this), "mapId", 0);
          /**地图等级 */
          _defineProperty(_assertThisInitialized(_this), "mapLv", 0);
          /**难度 */
          _defineProperty(_assertThisInitialized(_this), "difficulty", 1);
          /** 地形宽度 */
          _defineProperty(_assertThisInitialized(_this), "width", 5120);
          /** 地形高度 */
          _defineProperty(_assertThisInitialized(_this), "height", 5120);
          /**角色额外组件 */
          _defineProperty(_assertThisInitialized(_this), "roleExtraComp", []);
          /**技能额外组件 */
          _defineProperty(_assertThisInitialized(_this), "skillExtraComp", []);
          /**地图经验 */
          _defineProperty(_assertThisInitialized(_this), "exp", 0);
          /**是否是新地图 */
          _defineProperty(_assertThisInitialized(_this), "isNew", true);
          return _this;
        }
        _createClass(MapModelComp, [{
          key: "reset",
          value: function reset() {
            this.name = null;
            this.width = 0;
      ...
      var MapModelSystem = exports('MapModelSystem', /*#__PURE__*/function (_ecs$ComblockSystem) {
        _inherits(MapModelSystem, _ecs$ComblockSystem);
        var _super2 = _createSuper(MapModelSystem);
        function MapModelSystem() {
          _classCallCheck(this, MapModelSystem);
          return _super2.call(this);
        }
        _createClass(MapModelSystem, [{
          key: "filter",
          value: function filter() {
  ...
  return {
    ...
    execute: function () {
      ...
      var MasterComp = exports('MasterComp', (_dec = ecs.register('MasterComp'), _dec(_class = /*#__PURE__*/function (_ecs$Comp) {
        _inherits(MasterComp, _ecs$Comp);
        var _super = _createSuper(MasterComp);
        function MasterComp() {
          var _this;
           ...
           * 主人
           */
          _defineProperty(_assertThisInitialized(_this), "_master", void 0);
          return _this;
        }
  ...
  return {
    ...
    execute: function () {
      ...
      var MonsterFactoryComp = exports('MonsterFactoryComp', (_dec = ecs.register('MonsterFactoryComp'), _dec(_class = /*#__PURE__*/function (_ecs$Comp) {
        _inherits(MonsterFactoryComp, _ecs$Comp);
        var _super = _createSuper(MonsterFactoryComp);
        function MonsterFactoryComp() {
          var _this;
          _classCallCheck(this, MonsterFactoryComp);
          for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
            args[_key] = arguments[_key];
          }
          _this = _super.call.apply(_super, [this].concat(args));
          ...
          /**等级 */
          _defineProperty(_assertThisInitialized(_this), "lv", 0);
          /**一共怪物数量 */
          _defineProperty(_assertThisInitialized(_this), "totalSpawnCount", 0);
          /**当前怪物数量 */
          _defineProperty(_assertThisInitialized(_this), "currentSpawnCount", 0);
          /**当前冷却时间 */
          _defineProperty(_assertThisInitialized(_this), "currentCoolTime", 0);
          /**当前游戏时间 */
          _defineProperty(_assertThisInitialized(_this), "currentGameTime", 0);
          /**当前消灭怪物数量 */
          _defineProperty(_assertThisInitialized(_this), "currentKillCount", 0);
          /**当前积分 */
          _defineProperty(_assertThisInitialized(_this), "currentIntegral", 0);
          /**boss状态，未出现，出现，死亡 */
          _defineProperty(_assertThisInitialized(_this), "bossState", 'NotAppeared');
          return _this;
        }
        _createClass(MonsterFactoryComp, [{
          key: "reset",
          value: function reset() {}
        }, {
          key: "init",
      ...
      var MonsterFactorySystem = exports('MonsterFactorySystem', /*#__PURE__*/function (_ecs$ComblockSystem) {
        _inherits(MonsterFactorySystem, _ecs$ComblockSystem);
        var _super2 = _createSuper(MonsterFactorySystem);
        function MonsterFactorySystem() {
          _classCallCheck(this, MonsterFactorySystem);
          return _super2.call(this);
        }
        _createClass(MonsterFactorySystem, [{
          key: "filter",
          value: function filter() {
          ...
          key: "spawnMonster",
          value: function spawnMonster(comp, type) {
            // let config = DB_MonsterFactoryConfig[comp.id];
          ...
          key: "getMonsterByProbability",
          value: function getMonsterByProbability(monster) {
            var total = 0;
...
System.register("chunks:///_virtual/MoveComp.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './ECS.ts', './AfterDeathMarkerComp.ts', './PositionComp.ts', './SpeedComp.ts'], function (exports) {
  var _inherits, _createSuper, _classCallCheck, _createClass, cclegacy, v3, ecs, AfterDeathMarkerComp, PositionComp, SpeedComp;
  return {
    setters: [function (module) {
      _inherits = module.inherits;
      _createSuper = module.createSuper;
    ...
    execute: function () {
      ...
      var MoveComp = exports('MoveComp', (_dec = ecs.register('MoveComp'), _dec(_class = /*#__PURE__*/function (_ecs$Comp) {
        _inherits(MoveComp, _ecs$Comp);
        var _super = _createSuper(MoveComp);
        function MoveComp() {
          _classCallCheck(this, MoveComp);
          return _super.apply(this, arguments);
        }
        _createClass(MoveComp, [{
          key: "reset",
          value: function reset() {}
        }]);
        return MoveComp;
      ...
      var MoveSystem = exports('MoveSystem', /*#__PURE__*/function (_ecs$ComblockSystem) {
        _inherits(MoveSystem, _ecs$ComblockSystem);
        var _super2 = _createSuper(MoveSystem);
        function MoveSystem() {
  ...
  return {
    ...
    execute: function () {
      ...
      var MoveOnTileComp = exports('MoveOnTileComp', (_dec = ecs.register('MoveOnTileComp'), _dec(_class = /*#__PURE__*/function (_ecs$Comp) {
        _inherits(MoveOnTileComp, _ecs$Comp);
        var _super = _createSuper(MoveOnTileComp);
        function MoveOnTileComp() {
          _classCallCheck(this, MoveOnTileComp);
          return _super.apply(this, arguments);
        }
        _createClass(MoveOnTileComp, [{
          key: "reset",
          value: function reset() {}
        }]);
      ...
      var MoveOnTileSystem = exports('MoveOnTileSystem', /*#__PURE__*/function (_ecs$ComblockSystem) {
        _inherits(MoveOnTileSystem, _ecs$ComblockSystem);
        var _super2 = _createSuper(MoveOnTileSystem);
        function MoveOnTileSystem() {
          _classCallCheck(this, MoveOnTileSystem);
          return _super2.call(this);
        }
        _createClass(MoveOnTileSystem, [{
          key: "filter",
          value: function filter() {
...
System.register("chunks:///_virtual/MpComp.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './ECS.ts', './ConstType.ts', './WeaponModelComp.ts', './WeaponDepotComp.ts'], function (exports) {
  var _inherits, _createSuper, _classCallCheck, _defineProperty, _assertThisInitialized, _createClass, cclegacy, ecs, WeaponAttributeType, WeaponModelComp, WeaponDepotComp;
  return {
    setters: [function (module) {
      _inherits = module.inherits;
      _createSuper = module.createSuper;
    ...
    execute: function () {
      ...
      var MpComp = exports('MpComp', (_dec = ecs.register('MpComp'), _dec(_class = /*#__PURE__*/function (_ecs$Comp) {
        _inherits(MpComp, _ecs$Comp);
        var _super = _createSuper(MpComp);
        function MpComp() {
          var _this;
          _classCallCheck(this, MpComp);
          for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
            args[_key] = arguments[_key];
          }
          _this = _super.call.apply(_super, [this].concat(args));
          _defineProperty(_assertThisInitialized(_this), "mp", 0);
          return _this;
        }
        _createClass(MpComp, [{
          key: "reset",
      ...
      var MpSystem = exports('MpSystem', /*#__PURE__*/function (_ecs$ComblockSystem) {
        _inherits(MpSystem, _ecs$ComblockSystem);
        var _super2 = _createSuper(MpSystem);
        function MpSystem() {
          _classCallCheck(this, MpSystem);
          return _super2.call(this);
        }
        _createClass(MpSystem, [{
          key: "filter",
          value: function filter() {
...
System.register("chunks:///_virtual/MpRecoverComp.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './ECS.ts', './RoleModelComp.ts'], function (exports) {
  var _inherits, _createSuper, _classCallCheck, _createClass, cclegacy, ecs, RoleModelComp;
  return {
    setters: [function (module) {
      _inherits = module.inherits;
      _createSuper = module.createSuper;
    ...
    execute: function () {
      ...
      var MpRecoverComp = exports('MpRecoverComp', (_dec = ecs.register('MpRecoverComp'), _dec(_class = /*#__PURE__*/function (_ecs$Comp) {
        _inherits(MpRecoverComp, _ecs$Comp);
        var _super = _createSuper(MpRecoverComp);
        function MpRecoverComp() {
          _classCallCheck(this, MpRecoverComp);
          return _super.apply(this, arguments);
        }
        _createClass(MpRecoverComp, [{
          key: "reset",
          value: function reset() {}
        }]);
      ...
      var MpRecoverSystem = exports('MpRecoverSystem', /*#__PURE__*/function (_ecs$ComblockSystem) {
        _inherits(MpRecoverSystem, _ecs$ComblockSystem);
        var _super2 = _createSuper(MpRecoverSystem);
        function MpRecoverSystem() {
          _classCallCheck(this, MpRecoverSystem);
          return _super2.call(this);
        }
        _createClass(MpRecoverSystem, [{
          key: "filter",
          value: function filter() {
...
System.register("chunks:///_virtual/NormalAtkComp.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './ECS.ts', './ConstType.ts', './AtkDetectorComp.ts', './EnabledComp.ts', './HpComp.ts', './PositionComp.ts', './StateMachineComp.ts', './MasterComp.ts', './SkeletonViewComp.ts', './RestrictMoveComp.ts', './BattleUtil.ts', './RoleAtkMarkerComp.ts'], function (exports) {
  var _inherits, _createSuper, _classCallCheck, _defineProperty, _assertThisInitialized, _createClass, cclegacy, _decorator, ecs, RoleAnimType, RoleStateMachineType, AtkDetectorComp, EnabledComp, HpComp, PositionComp, StateMachineComp, MasterComp, SkeletonViewComp, RestrictMoveComp, BattleUtil, RoleAtkMarkerComp;
  return {
    setters: [function (module) {
      _inherits = module.inherits;
      _createSuper = module.createSuper;
    ...
    execute: function () {
      ...
      var NormalAtkComp = exports('NormalAtkComp', (_dec = ccclass('NormalAtkComp'), _dec2 = ecs.register('NormalAtkComp'), _dec(_class = _dec2(_class = /*#__PURE__*/function (_ecs$Comp) {
        _inherits(NormalAtkComp, _ecs$Comp);
        var _super = _createSuper(NormalAtkComp);
        function NormalAtkComp() {
          var _this;
          _classCallCheck(this, NormalAtkComp);
          for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
            args[_key] = arguments[_key];
          }
          _this = _super.call.apply(_super, [this].concat(args));
          //攻击目标
          _defineProperty(_assertThisInitialized(_this), "_pursueEntity", null);
          //冷却时间
          _defineProperty(_assertThisInitialized(_this), "coolTime", 5);
          //当前时间
          _defineProperty(_assertThisInitialized(_this), "curTime", 0);
          return _this;
        }
      ...
      var NormalAtkSystem = exports('NormalAtkSystem', /*#__PURE__*/function (_ecs$ComblockSystem) {
        _inherits(NormalAtkSystem, _ecs$ComblockSystem);
        var _super2 = _createSuper(NormalAtkSystem);
        function NormalAtkSystem() {
          _classCallCheck(this, NormalAtkSystem);
          return _super2.apply(this, arguments);
        }
        _createClass(NormalAtkSystem, [{
          key: "filter",
          value: function filter() {
...
System.register("chunks:///_virtual/NotOutBoundsComp.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './ECS.ts', './MapModelComp.ts', './PositionComp.ts', './SpeedComp.ts', './app.ts'], function (exports) {
  var _inherits, _createSuper, _classCallCheck, _createClass, cclegacy, _decorator, ecs, MapModelComp, PositionComp, SpeedComp, app;
  return {
    setters: [function (module) {
      _inherits = module.inherits;
      _createSuper = module.createSuper;
    ...
    execute: function () {
      ...
      var NotOutBoundsComp = exports('NotOutBoundsComp', (_dec = ccclass('NotOutBoundsComp'), _dec2 = ecs.register('NotOutBoundsComp'), _dec(_class = _dec2(_class = /*#__PURE__*/function (_ecs$Comp) {
        _inherits(NotOutBoundsComp, _ecs$Comp);
        var _super = _createSuper(NotOutBoundsComp);
        function NotOutBoundsComp() {
          _classCallCheck(this, NotOutBoundsComp);
          return _super.apply(this, arguments);
        }
        _createClass(NotOutBoundsComp, [{
          key: "reset",
          value: function reset() {}
        }]);
      ...
      var NotOutBoundsSystem = exports('NotOutBoundsSystem', /*#__PURE__*/function (_ecs$ComblockSystem) {
        _inherits(NotOutBoundsSystem, _ecs$ComblockSystem);
        var _super2 = _createSuper(NotOutBoundsSystem);
        function NotOutBoundsSystem() {
          _classCallCheck(this, NotOutBoundsSystem);
          return _super2.call(this);
        }
        _createClass(NotOutBoundsSystem, [{
          key: "filter",
          value: function filter() {
...
System.register("chunks:///_virtual/NPCInteractionMenuComp.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './BattleController.ts', './ECS.ts'], function (exports) {
  var _inherits, _createSuper, _classCallCheck, _defineProperty, _assertThisInitialized, _createClass, _objectSpread2, cclegacy, BattleController, ecs;
  return {
    setters: [function (module) {
      _inherits = module.inherits;
      _createSuper = module.createSuper;
      ...
      _assertThisInitialized = module.assertThisInitialized;
      _createClass = module.createClass;
      _objectSpread2 = module.objectSpread2;
    }, function (module) {
      cclegacy = module.cclegacy;
    }, function (module) {
      BattleController = module.BattleController;
    ...
    execute: function () {
      ...
      var NPCInteractionMenuComp = exports('NPCInteractionMenuComp', (_dec = ecs.register('NPCInteractionMenuComp'), _dec(_class = /*#__PURE__*/function (_ecs$Comp) {
        _inherits(NPCInteractionMenuComp, _ecs$Comp);
        var _super = _createSuper(NPCInteractionMenuComp);
        function NPCInteractionMenuComp() {
          var _this;
          _classCallCheck(this, NPCInteractionMenuComp);
          for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
            args[_key] = arguments[_key];
          }
          _this = _super.call.apply(_super, [this].concat(args));
          ...
          //是否刷新
          _defineProperty(_assertThisInitialized(_this), "isRefresh", false);
          return _this;
        }
        _createClass(NPCInteractionMenuComp, [{
          key: "addInteraction",
          value: /**权重是小的优先 */
          function addInteraction(interactionData) {
            ...
            if (shouldUpdate) {
              ...
              this.data = _objectSpread2({}, interactionData); // 创建新对象，避免引用问题
            }
          }
      ...
      var NPCInteractionMenuSystem = exports('NPCInteractionMenuSystem', /*#__PURE__*/function (_ecs$ComblockSystem) {
        _inherits(NPCInteractionMenuSystem, _ecs$ComblockSystem);
        var _super2 = _createSuper(NPCInteractionMenuSystem);
        function NPCInteractionMenuSystem() {
          _classCallCheck(this, NPCInteractionMenuSystem);
          return _super2.call(this);
        }
        _createClass(NPCInteractionMenuSystem, [{
          key: "filter",
          value: function filter() {
...
System.register("chunks:///_virtual/PlayerDeathComp.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './DeathComp.ts', './ECS.ts', './app.ts'], function (exports) {
  var _inherits, _createSuper, _classCallCheck, _createClass, cclegacy, DeathComp, ecs, app;
  return {
    setters: [function (module) {
      _inherits = module.inherits;
      _createSuper = module.createSuper;
    ...
    execute: function () {
      ...
      var PlayerDeathComp = exports('PlayerDeathComp', (_dec = ecs.register('PlayerDeathComp'), _dec(_class = /*#__PURE__*/function (_ecs$Comp) {
        _inherits(PlayerDeathComp, _ecs$Comp);
        var _super = _createSuper(PlayerDeathComp);
        function PlayerDeathComp() {
          _classCallCheck(this, PlayerDeathComp);
          return _super.apply(this, arguments);
        }
        _createClass(PlayerDeathComp, [{
          key: "reset",
          value: function reset() {}
        }]);
      ...
      var PlaayerDeathSystem = exports('PlaayerDeathSystem', /*#__PURE__*/function (_ecs$ComblockSystem) {
        _inherits(PlaayerDeathSystem, _ecs$ComblockSystem);
        var _super2 = _createSuper(PlaayerDeathSystem);
        function PlaayerDeathSystem() {
          _classCallCheck(this, PlaayerDeathSystem);
          return _super2.call(this);
        }
        _createClass(PlaayerDeathSystem, [{
          key: "filter",
          value: function filter() {
...
System.register("chunks:///_virtual/PlayerShowComp.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './ECS.ts', './CameraFollowComp.ts', './PositionComp.ts', './UnitComp.ts', './app.ts'], function (exports) {
  var _inherits, _createSuper, _classCallCheck, _defineProperty, _assertThisInitialized, _createClass, cclegacy, ecs, CameraFollowComp, PositionComp, UnitComp, app;
  return {
    setters: [function (module) {
      _inherits = module.inherits;
      _createSuper = module.createSuper;
    ...
    execute: function () {
      ...
      var PlayerShowComp = exports('PlayerShowComp', (_dec = ecs.register('PlayerShowComp'), _dec(_class = /*#__PURE__*/function (_ecs$Comp) {
        _inherits(PlayerShowComp, _ecs$Comp);
        var _super = _createSuper(PlayerShowComp);
        function PlayerShowComp() {
          var _this;
          _classCallCheck(this, PlayerShowComp);
          for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
            args[_key] = arguments[_key];
          }
          _this = _super.call.apply(_super, [this].concat(args));
      ...
      var PlayerShowSystem = exports('PlayerShowSystem', /*#__PURE__*/function (_ecs$ComblockSystem) {
        _inherits(PlayerShowSystem, _ecs$ComblockSystem);
        var _super2 = _createSuper(PlayerShowSystem);
        function PlayerShowSystem() {
          _classCallCheck(this, PlayerShowSystem);
          return _super2.call(this);
        }
        _createClass(PlayerShowSystem, [{
          key: "filter",
          value: function filter() {
...
System.register("chunks:///_virtual/PositionComp.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './ECS.ts', './UnitComp.ts', './DirectionComp.ts', './IsWeaponComp.ts', './MasterComp.ts'], function (exports) {
  var _inherits, _createSuper, _classCallCheck, _defineProperty, _assertThisInitialized, _createClass, cclegacy, Vec3, ecs, UnitComp, DirectionComp, IsWeaponComp, MasterComp;
  return {
    setters: [function (module) {
      _inherits = module.inherits;
      _createSuper = module.createSuper;
    ...
    execute: function () {
      ...
      var PositionComp = exports('PositionComp', (_dec = ecs.register('PositionComp'), _dec(_class = /*#__PURE__*/function (_ecs$Comp) {
        _inherits(PositionComp, _ecs$Comp);
        var _super = _createSuper(PositionComp);
        function PositionComp() {
          var _this;
          _classCallCheck(this, PositionComp);
          for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
            args[_key] = arguments[_key];
          }
          _this = _super.call.apply(_super, [this].concat(args));
          ...
          //身体角度
          _defineProperty(_assertThisInitialized(_this), "bodyAngle", 0);
          return _this;
        }
        _createClass(PositionComp, [{
          key: "reset",
          value: function reset() {
          ...
          key: "setPosition",
          value: function setPosition(xOrPos, yOrIsRefresh, isRefresh) {
            // 处理传入数字坐标的情况
            if (typeof xOrPos === 'number' && typeof yOrIsRefresh === 'number') {
              var _isRefresh;
              this.position.set(xOrPos, yOrIsRefresh, 0);
              isRefresh = (_isRefresh = isRefresh) !== null && _isRefresh !== void 0 ? _isRefresh : false;
            }
            // 处理传入Vec3向量的情况
            else if (xOrPos instanceof Vec3) {
              var _ref;
              this.position.set(xOrPos);
              isRefresh = (_ref = yOrIsRefresh) !== null && _ref !== void 0 ? _ref : false;
            }
            // 处理无效参数的情况
            else {
      ...
      var PositionSystem = exports('PositionSystem', /*#__PURE__*/function (_ecs$ComblockSystem) {
        _inherits(PositionSystem, _ecs$ComblockSystem);
        var _super2 = _createSuper(PositionSystem);
        function PositionSystem() {
          _classCallCheck(this, PositionSystem);
          return _super2.call(this);
        }
        _createClass(PositionSystem, [{
          key: "filter",
          value: function filter() {
      ...
      var WeaponPositionSystem = exports('WeaponPositionSystem', /*#__PURE__*/function (_ecs$ComblockSystem2) {
        _inherits(WeaponPositionSystem, _ecs$ComblockSystem2);
        var _super3 = _createSuper(WeaponPositionSystem);
        function WeaponPositionSystem() {
          _classCallCheck(this, WeaponPositionSystem);
          return _super3.call(this);
        }
        _createClass(WeaponPositionSystem, [{
          key: "filter",
          value: function filter() {
...
System.register("chunks:///_virtual/PursueComp.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './ECS.ts', './ConstType.ts', './AtkDetectorComp.ts', './DirectionComp.ts', './EnabledComp.ts', './PositionComp.ts', './StateMachineComp.ts'], function (exports) {
  var _inherits, _createSuper, _classCallCheck, _defineProperty, _assertThisInitialized, _createClass, cclegacy, ecs, RoleStateMachineType, AtkDetectorComp, DirectionComp, EnabledComp, PositionComp, StateMachineComp;
  return {
    setters: [function (module) {
      _inherits = module.inherits;
      _createSuper = module.createSuper;
    ...
    execute: function () {
      ...
      var PursueComp = exports('PursueComp', (_dec = ecs.register('PursueComp'), _dec(_class = /*#__PURE__*/function (_ecs$Comp) {
        _inherits(PursueComp, _ecs$Comp);
        var _super = _createSuper(PursueComp);
        function PursueComp() {
          var _this;
          _classCallCheck(this, PursueComp);
          for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
            args[_key] = arguments[_key];
          }
          _this = _super.call.apply(_super, [this].concat(args));
          _defineProperty(_assertThisInitialized(_this), "pursueEntity", null);
          return _this;
        }
        _createClass(PursueComp, [{
          key: "reset",
          value: function reset() {}
        }]);
        return PursueComp;
      ...
      var PursueSystem = exports('PursueSystem', /*#__PURE__*/function (_ecs$ComblockSystem) {
        _inherits(PursueSystem, _ecs$ComblockSystem);
        var _super2 = _createSuper(PursueSystem);
        function PursueSystem() {
          _classCallCheck(this, PursueSystem);
          return _super2.call(this);
        }
        _createClass(PursueSystem, [{
          key: "filter",
          value: function filter() {
...
System.register("chunks:///_virtual/PursueEnemyMoveComp.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './SkillMoveComp.ts', './ECS.ts', './DirectionComp.ts', './PositionComp.ts', './BattleUtil.ts', './FactionTypeComp.ts', './LinearSkillMoveComp.ts'], function (exports) {
  var _inherits, _createSuper, _classCallCheck, _defineProperty, _assertThisInitialized, _createClass, cclegacy, _decorator, SkillMoveComp, ecs, DirectionComp, PositionComp, BattleUtil, FactionTypeComp, LinearSkillMoveComp;
  return {
    setters: [function (module) {
      _inherits = module.inherits;
      _createSuper = module.createSuper;
    ...
    execute: function () {
      ...
      var PursueEnemyMoveComp = exports('PursueEnemyMoveComp', (_dec = ccclass('PursueEnemyMoveComp'), _dec2 = ecs.register('PursueEnemyMoveComp'), _dec(_class = _dec2(_class = /*#__PURE__*/function (_SkillMoveComp) {
        _inherits(PursueEnemyMoveComp, _SkillMoveComp);
        var _super = _createSuper(PursueEnemyMoveComp);
        function PursueEnemyMoveComp() {
          var _this;
          _classCallCheck(this, PursueEnemyMoveComp);
          for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
            args[_key] = arguments[_key];
          }
          _this = _super.call.apply(_super, [this].concat(args));
          /**追踪目标 */
          _defineProperty(_assertThisInitialized(_this), "pursueEntity", void 0);
          return _this;
        }
        _createClass(PursueEnemyMoveComp, [{
          key: "reset",
          value: function reset() {}
        }]);
      ...
      var PursueEnemyMoveSystem = exports('PursueEnemyMoveSystem', /*#__PURE__*/function (_ref) {
        _inherits(PursueEnemyMoveSystem, _ref);
        var _super2 = _createSuper(PursueEnemyMoveSystem);
        function PursueEnemyMoveSystem() {
          _classCallCheck(this, PursueEnemyMoveSystem);
          return _super2.call(this);
        }
        _createClass(PursueEnemyMoveSystem, [{
          key: "filter",
          value: function filter() {
...
System.register("chunks:///_virtual/PursuePlayerMoveComp.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './ECS.ts', './PositionComp.ts', './DirectionComp.ts', './app.ts'], function (exports) {
  var _inherits, _createSuper, _classCallCheck, _createClass, cclegacy, ecs, PositionComp, DirectionComp, app;
  return {
    setters: [function (module) {
      _inherits = module.inherits;
      _createSuper = module.createSuper;
    ...
    execute: function () {
      ...
      var PursuePlayerMoveComp = exports('PursuePlayerMoveComp', (_dec = ecs.register('PursuePlayerMoveComp'), _dec(_class = /*#__PURE__*/function (_ecs$Comp) {
        _inherits(PursuePlayerMoveComp, _ecs$Comp);
        var _super = _createSuper(PursuePlayerMoveComp);
        function PursuePlayerMoveComp() {
          _classCallCheck(this, PursuePlayerMoveComp);
          return _super.apply(this, arguments);
        }
        _createClass(PursuePlayerMoveComp, [{
          key: "reset",
          value: function reset() {}
        }]);
      ...
      var PursuePlayerMoveSystem = exports('PursuePlayerMoveSystem', /*#__PURE__*/function (_ecs$ComblockSystem) {
        _inherits(PursuePlayerMoveSystem, _ecs$ComblockSystem);
        var _super2 = _createSuper(PursuePlayerMoveSystem);
        function PursuePlayerMoveSystem() {
          _classCallCheck(this, PursuePlayerMoveSystem);
          return _super2.call(this);
        }
        _createClass(PursuePlayerMoveSystem, [{
          key: "filter",
          value: function filter() {
...
System.register("chunks:///_virtual/RandomlyGenerateMonsterComp.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './ECS.ts', './BattleUtil.ts', './MapModelComp.ts', './MonsterFactoryConfig.ts', './CreateRoleComp.ts', './TaskConfig.ts', './TaskModelComp.ts', './app.ts', './ConstType.ts', './PositionComp.ts'], function (exports) {
  var _inherits, _createSuper, _classCallCheck, _defineProperty, _assertThisInitialized, _createClass, cclegacy, _decorator, v3, ecs, BattleUtil, MapModelComp, DB_MonsterFactoryConfig, CreateRoleComp, DB_TaskConfig, TaskModelComp, app, FactionType, PositionComp;
  return {
    setters: [function (module) {
      _inherits = module.inherits;
      _createSuper = module.createSuper;
    ...
    execute: function () {
      ...
      var RandomlyGenerateMonsterComp = exports('RandomlyGenerateMonsterComp', (_dec = ccclass('RandomlyGenerateMonsterComp'), _dec2 = ecs.register('RandomlyGenerateMonsterComp'), _dec(_class = _dec2(_class = /*#__PURE__*/function (_ecs$Comp) {
        _inherits(RandomlyGenerateMonsterComp, _ecs$Comp);
        var _super = _createSuper(RandomlyGenerateMonsterComp);
        function RandomlyGenerateMonsterComp() {
          var _this;
          _classCallCheck(this, RandomlyGenerateMonsterComp);
          for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
            args[_key] = arguments[_key];
          }
          _this = _super.call.apply(_super, [this].concat(args));
          /**敌人生成时间间隔 */
          _defineProperty(_assertThisInitialized(_this), "enemySpawnInterval", 1);
          /**敌人当前生成时间 */
          _defineProperty(_assertThisInitialized(_this), "currentEnemySpawnTime", 0);
          /**敌人最大存在数量 */
          _defineProperty(_assertThisInitialized(_this), "maxEnemyCount", 30);
          return _this;
        }
        _createClass(RandomlyGenerateMonsterComp, [{
          key: "reset",
          value: function reset() {
      ...
      var RandomlyGenerateMonsterSystem = exports('RandomlyGenerateMonsterSystem', /*#__PURE__*/function (_ecs$ComblockSystem) {
        _inherits(RandomlyGenerateMonsterSystem, _ecs$ComblockSystem);
        var _super2 = _createSuper(RandomlyGenerateMonsterSystem);
        function RandomlyGenerateMonsterSystem() {
          _classCallCheck(this, RandomlyGenerateMonsterSystem);
          return _super2.call(this);
        }
        _createClass(RandomlyGenerateMonsterSystem, [{
          key: "filter",
          value: function filter() {
...
System.register("chunks:///_virtual/RestrictMoveComp.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './ECS.ts', './DirectionComp.ts'], function (exports) {
  var _inherits, _createSuper, _classCallCheck, _defineProperty, _assertThisInitialized, _createClass, cclegacy, Vec3, ecs, DirectionComp;
  return {
    setters: [function (module) {
      _inherits = module.inherits;
      _createSuper = module.createSuper;
    ...
    execute: function () {
      ...
      var RestrictMoveComp = exports('RestrictMoveComp', (_dec = ecs.register('RestrictMoveComp'), _dec(_class = /*#__PURE__*/function (_ecs$Comp) {
        _inherits(RestrictMoveComp, _ecs$Comp);
        var _super = _createSuper(RestrictMoveComp);
        function RestrictMoveComp() {
          var _this;
          _classCallCheck(this, RestrictMoveComp);
          for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
            args[_key] = arguments[_key];
          }
          _this = _super.call.apply(_super, [this].concat(args));
      ...
      var RestrictMoveSystem = exports('RestrictMoveSystem', /*#__PURE__*/function (_ecs$ComblockSystem) {
        _inherits(RestrictMoveSystem, _ecs$ComblockSystem);
        var _super2 = _createSuper(RestrictMoveSystem);
        function RestrictMoveSystem() {
          _classCallCheck(this, RestrictMoveSystem);
          return _super2.call(this);
        }
        _createClass(RestrictMoveSystem, [{
          key: "filter",
          value: function filter() {
...
System.register("chunks:///_virtual/RoleAfterDeathComp.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './AfterDeathMarkerComp.ts', './ECS.ts', './ConstType.ts', './SkeletonViewComp.ts', './StateMachineComp.ts'], function (exports) {
  var _inherits, _createSuper, _classCallCheck, _defineProperty, _assertThisInitialized, _createClass, cclegacy, AfterDeathMarkerComp, ecs, RoleAnimType, RoleStateMachineType, SkeletonViewComp, StateMachineComp;
  return {
    setters: [function (module) {
      _inherits = module.inherits;
      _createSuper = module.createSuper;
    ...
    execute: function () {
      ...
      var RoleAfterDeathComp = exports('RoleAfterDeathComp', (_dec = ecs.register('RoleAfterDeathComp'), _dec(_class = /*#__PURE__*/function (_ecs$Comp) {
        _inherits(RoleAfterDeathComp, _ecs$Comp);
        var _super = _createSuper(RoleAfterDeathComp);
        function RoleAfterDeathComp() {
          var _this;
          _classCallCheck(this, RoleAfterDeathComp);
          for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
            args[_key] = arguments[_key];
          }
          _this = _super.call.apply(_super, [this].concat(args));
        ...
        _createClass(RoleAfterDeathComp, [{
          key: "reset",
          value: function reset() {}
        }]);
      ...
      var RoleAfterDeathSystem = exports('RoleAfterDeathSystem', /*#__PURE__*/function (_ecs$ComblockSystem) {
        _inherits(RoleAfterDeathSystem, _ecs$ComblockSystem);
        var _super2 = _createSuper(RoleAfterDeathSystem);
        function RoleAfterDeathSystem() {
          _classCallCheck(this, RoleAfterDeathSystem);
          return _super2.call(this);
        }
        _createClass(RoleAfterDeathSystem, [{
          key: "filter",
          value: function filter() {
...
System.register("chunks:///_virtual/RoleAtkMarkerComp.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './ECS.ts', './StateMachineComp.ts', './ConstType.ts'], function (exports) {
  var _inherits, _createSuper, _classCallCheck, _defineProperty, _assertThisInitialized, _createClass, cclegacy, _decorator, ecs, StateMachineComp, RoleStateMachineType;
  return {
    setters: [function (module) {
      _inherits = module.inherits;
      _createSuper = module.createSuper;
    ...
    execute: function () {
      ...
      var RoleAtkMarkerComp = exports('RoleAtkMarkerComp', (_dec = ccclass('RoleAtkMarkerComp'), _dec2 = ecs.register('RoleAtkMarkerComp'), _dec(_class = _dec2(_class = /*#__PURE__*/function (_ecs$Comp) {
        _inherits(RoleAtkMarkerComp, _ecs$Comp);
        var _super = _createSuper(RoleAtkMarkerComp);
        function RoleAtkMarkerComp() {
          var _this;
          _classCallCheck(this, RoleAtkMarkerComp);
          for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
            args[_key] = arguments[_key];
          }
          _this = _super.call.apply(_super, [this].concat(args));
          //当前时间
          _defineProperty(_assertThisInitialized(_this), "curTime", 1);
          return _this;
        }
        _createClass(RoleAtkMarkerComp, [{
          key: "reset",
          value: function reset() {
            this.curTime = 1;
          }
      ...
      var RoleAtkMarkerSystem = exports('RoleAtkMarkerSystem', /*#__PURE__*/function (_ref) {
        _inherits(RoleAtkMarkerSystem, _ref);
        var _super2 = _createSuper(RoleAtkMarkerSystem);
        function RoleAtkMarkerSystem() {
          _classCallCheck(this, RoleAtkMarkerSystem);
          return _super2.apply(this, arguments);
        }
        _createClass(RoleAtkMarkerSystem, [{
          key: "filter",
          value: function filter() {
...
System.register("chunks:///_virtual/RoleAutoCastComp.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './ECS.ts', './WeaponAutoCastComp.ts', './WeaponDepotComp.ts'], function (exports) {
  var _inherits, _createSuper, _classCallCheck, _defineProperty, _assertThisInitialized, _createClass, cclegacy, ecs, WeaponAutoCastComp, WeaponDepotComp;
  return {
    setters: [function (module) {
      _inherits = module.inherits;
      _createSuper = module.createSuper;
    ...
    execute: function () {
      ...
      var RoleAutoCastComp = exports('RoleAutoCastComp', (_dec = ecs.register('RoleAutoCastComp'), _dec(_class = /*#__PURE__*/function (_ecs$Comp) {
        _inherits(RoleAutoCastComp, _ecs$Comp);
        var _super = _createSuper(RoleAutoCastComp);
        function RoleAutoCastComp() {
          var _this;
          _classCallCheck(this, RoleAutoCastComp);
          for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
            args[_key] = arguments[_key];
          }
          _this = _super.call.apply(_super, [this].concat(args));
          _defineProperty(_assertThisInitialized(_this), "atkEntity", null);
          return _this;
        }
        _createClass(RoleAutoCastComp, [{
          key: "reset",
          value: function reset() {}
        }]);
      ...
      var RoleAutoCastSystem = exports('RoleAutoCastSystem', /*#__PURE__*/function (_ecs$ComblockSystem) {
        _inherits(RoleAutoCastSystem, _ecs$ComblockSystem);
        var _super2 = _createSuper(RoleAutoCastSystem);
        function RoleAutoCastSystem() {
          _classCallCheck(this, RoleAutoCastSystem);
          return _super2.call(this);
        }
        _createClass(RoleAutoCastSystem, [{
          key: "filter",
          value: function filter() {
...
System.register("chunks:///_virtual/RoleCastComp.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './ECS.ts', './WeaponCastComp.ts', './WeaponDepotComp.ts'], function (exports) {
  var _inherits, _createSuper, _classCallCheck, _createClass, cclegacy, ecs, WeaponCastComp, WeaponDepotComp;
  return {
    setters: [function (module) {
      _inherits = module.inherits;
      _createSuper = module.createSuper;
    ...
    execute: function () {
      ...
      var RoleCastComp = exports('RoleCastComp', (_dec = ecs.register('RoleCastComp'), _dec(_class = /*#__PURE__*/function (_ecs$Comp) {
        _inherits(RoleCastComp, _ecs$Comp);
        var _super = _createSuper(RoleCastComp);
        function RoleCastComp() {
          _classCallCheck(this, RoleCastComp);
          return _super.apply(this, arguments);
        }
        _createClass(RoleCastComp, [{
          key: "reset",
          value: function reset() {}
        }]);
        return RoleCastComp;
      ...
      var RoleCastSystem = exports('RoleCastSystem', /*#__PURE__*/function (_ecs$ComblockSystem) {
        _inherits(RoleCastSystem, _ecs$ComblockSystem);
        var _super2 = _createSuper(RoleCastSystem);
        function RoleCastSystem() {
          _classCallCheck(this, RoleCastSystem);
          return _super2.call(this);
        }
        _createClass(RoleCastSystem, [{
          key: "filter",
          value: function filter() {
...
System.register("chunks:///_virtual/RoleEntity.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './ECS.ts', './BaseEntity.ts', './CollisionComp.ts', './DamageFlyTextComp.ts', './DirectionComp.ts', './EnabledComp.ts', './FactionTypeComp.ts', './HpComp.ts', './MoveComp.ts', './UnitComp.ts', './PositionComp.ts', './RoleModelComp.ts', './RoleViewLoadComp.ts', './SpeedComp.ts', './StateMachineComp.ts', './WeaponDepotComp.ts', './RoleAfterDeathComp.ts', './MpComp.ts', './IsRoleComp.ts', './RoleMapExtraCompComp.ts', './RoleTaskExtraCompComp.ts'], function (exports) {
  var _inherits, _createSuper, _classCallCheck, _createClass, _get, _getPrototypeOf, cclegacy, ecs, BaseEntity, CollisionComp, DamageFlyTextComp, DirectionComp, EnabledComp, FactionTypeComp, HpComp, MoveComp, UnitComp, PositionComp, RoleModelComp, RoleViewLoadComp, SpeedComp, StateMachineComp, WeaponDepotComp, RoleAfterDeathComp, MpComp, IsRoleComp, RoleMapExtraCompComp, RoleTaskExtraCompComp;
  return {
    setters: [function (module) {
      _inherits = module.inherits;
      _createSuper = module.createSuper;
    ...
    execute: function () {
      ...
      var RoleEntity = exports('RoleEntity', (_dec = ecs.register('RoleEntity'), _dec(_class = /*#__PURE__*/function (_BaseEntity) {
        ...
        var _super = _createSuper(RoleEntity);
        function RoleEntity() {
          _classCallCheck(this, RoleEntity);
          return _super.apply(this, arguments);
        }
        _createClass(RoleEntity, [{
          key: "init",
          value: function init() {
            _get(_getPrototypeOf(RoleEntity.prototype), "init", this).call(this);
...
System.register("chunks:///_virtual/RoleMapExtraCompComp.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './CompConfig.ts', './ECS.ts', './MapModelComp.ts', './app.ts'], function (exports) {
  var _inherits, _createSuper, _classCallCheck, _defineProperty, _assertThisInitialized, _createClass, cclegacy, js, DB_CompConfig, ecs, MapModelComp, app;
  return {
    setters: [function (module) {
      _inherits = module.inherits;
      _createSuper = module.createSuper;
    ...
    execute: function () {
      ...
      var RoleMapExtraCompComp = exports('RoleMapExtraCompComp', (_dec = ecs.register('RoleMapExtraCompComp'), _dec(_class = /*#__PURE__*/function (_ecs$Comp) {
        _inherits(RoleMapExtraCompComp, _ecs$Comp);
        var _super = _createSuper(RoleMapExtraCompComp);
        function RoleMapExtraCompComp() {
          var _this;
          _classCallCheck(this, RoleMapExtraCompComp);
          for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
            args[_key] = arguments[_key];
          }
          _this = _super.call.apply(_super, [this].concat(args));
          _defineProperty(_assertThisInitialized(_this), "extraComps", []);
          return _this;
        }
        _createClass(RoleMapExtraCompComp, [{
          key: "reset",
          value: function reset() {}
        }]);
      ...
      var RoleMapExtraCompSystem = exports('RoleMapExtraCompSystem', /*#__PURE__*/function (_ref) {
        _inherits(RoleMapExtraCompSystem, _ref);
        var _super2 = _createSuper(RoleMapExtraCompSystem);
        function RoleMapExtraCompSystem() {
          _classCallCheck(this, RoleMapExtraCompSystem);
          return _super2.call(this);
        }
        _createClass(RoleMapExtraCompSystem, [{
          key: "filter",
          value: function filter() {
          ...
          key: "addExtraComp",
          value: function addExtraComp(e) {
            var mapModel = app.manager.battle.mapEntity.get(MapModelComp);
            var roleExtraComp = mapModel.roleExtraComp;
            if (roleExtraComp) {
              for (var i = 0; i < roleExtraComp.length; i++) {
                var _DB_CompConfig$roleEx;
                var compNme = (_DB_CompConfig$roleEx = DB_CompConfig[roleExtraComp[i]]) === null || _DB_CompConfig$roleEx === void 0 ? void 0 : _DB_CompConfig$roleEx.className;
                if (compNme) {
          ...
          key: "removeExtraComp",
          value: function removeExtraComp(e) {
...
System.register("chunks:///_virtual/RoleModelComp.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './CompConfig.ts', './RoleConfig.ts', './ECS.ts', './RoleNumericMap.ts', './ConstType.ts', './HpComp.ts', './TriggerNPCInteractionMenuComp.ts', './BattleUtil.ts'], function (exports) {
  var _inherits, _createSuper, _classCallCheck, _defineProperty, _assertThisInitialized, _createClass, cclegacy, js, DB_CompConfig, DB_RoleConfig, ecs, RoleNumericMap, AttributeType, HpComp, TriggerNPCInteractionMenuComp, BattleUtil;
  return {
    setters: [function (module) {
      _inherits = module.inherits;
      _createSuper = module.createSuper;
    ...
    execute: function () {
      ...
      var RoleModelComp = exports('RoleModelComp', (_dec = ecs.register('RoleModelComp'), _dec(_class = /*#__PURE__*/function (_ecs$Comp) {
        _inherits(RoleModelComp, _ecs$Comp);
        var _super = _createSuper(RoleModelComp);
        function RoleModelComp() {
          var _this;
          _classCallCheck(this, RoleModelComp);
          for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
            args[_key] = arguments[_key];
          }
          _this = _super.call.apply(_super, [this].concat(args));
          /** 角色属性 */
          _defineProperty(_assertThisInitialized(_this), "attributes", null);
          /**角色id */
          _defineProperty(_assertThisInitialized(_this), "roleId", void 0);
          /**角色等级 */
          _defineProperty(_assertThisInitialized(_this), "lv", void 0);
          return _this;
        }
        _createClass(RoleModelComp, [{
          key: "init",
          value:
          /**
           * 初始化角色数据
          ...
          key: "initAttributes",
          value: function initAttributes(lv, difficulty) {
          ...
          key: "addCorrection",
          value: function addCorrection(type, data) {
      ...
      var RoleModelSystem = exports('RoleModelSystem', /*#__PURE__*/function (_ecs$ComblockSystem) {
        _inherits(RoleModelSystem, _ecs$ComblockSystem);
        var _super2 = _createSuper(RoleModelSystem);
        function RoleModelSystem() {
          _classCallCheck(this, RoleModelSystem);
          return _super2.call(this);
        }
        _createClass(RoleModelSystem, [{
          key: "filter",
          value: function filter() {
...
System.register("chunks:///_virtual/RoleNumeric.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './ConstType.ts'], function (exports) {
  var _createClass, _classCallCheck, _defineProperty, cclegacy, CorrectionType;
  return {
    setters: [function (module) {
      _createClass = module.createClass;
      _classCallCheck = module.classCallCheck;
    ...
    execute: function () {
      ...
      var RoleNumeric = exports('RoleNumeric', /*#__PURE__*/function () {
        function RoleNumeric(type) {
          _classCallCheck(this, RoleNumeric);
          /** 属性类型 */
          _defineProperty(this, "type", null);
          /**基础 */
          _defineProperty(this, "base", 0);
          /**成长 */
          _defineProperty(this, "growth", []);
          /**修饰器 */
          _defineProperty(this, "modifier", []);
          /**固定 */
          _defineProperty(this, "fixed", null);
          /** 缓存的属性最大值 */
          _defineProperty(this, "cachedMaxValue", null);
          /** 缓存的属性真实值 */
          _defineProperty(this, "cachedValue", null);
          this.type = type;
        }
        _createClass(RoleNumeric, [{
          ...
          key: "addCorrection",
          value: function addCorrection(data) {
          ...
          value: function removeCorrection(data) {
            if (data.type === CorrectionType.GROWTH) {
...
System.register("chunks:///_virtual/RoleNumericMap.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './RoleNumeric.ts'], function (exports) {
  var _createClass, _classCallCheck, _defineProperty, cclegacy, RoleNumeric;
  return {
    setters: [function (module) {
      _createClass = module.createClass;
      _classCallCheck = module.classCallCheck;
    ...
    execute: function () {
      ...
      /** 角色数值装饰器 */
      var RoleNumericDecorator = exports('RoleNumericDecorator', /*#__PURE__*/_createClass(function RoleNumericDecorator() {
        _classCallCheck(this, RoleNumericDecorator);
        /** 属性类型 */
        _defineProperty(this, "attribute", null);
        /** 属性数值 */
      ...
      var RoleNumericMap = exports('RoleNumericMap', /*#__PURE__*/function () {
        function RoleNumericMap() {
          _classCallCheck(this, RoleNumericMap);
          /** 角色属性 */
          _defineProperty(this, "attributes", new Map());
        }
        _createClass(RoleNumericMap, [{
          key: "init",
          value: function init(data) {
            for (var key in data) {
              var dataKey = key;
          ...
          key: "removeCorrection",
          value: function removeCorrection(type, data) {
            var attr = this.get(type);
...
System.register("chunks:///_virtual/RoleShowAnimation1Comp.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './ECS.ts', './RoleShowMarkerComp.ts', './UnitComp.ts'], function (exports) {
  var _inherits, _createSuper, _classCallCheck, _createClass, cclegacy, ecs, RoleShowMarkerComp, UnitComp;
  return {
    setters: [function (module) {
      _inherits = module.inherits;
      _createSuper = module.createSuper;
    ...
    execute: function () {
      ...
      var RoleShowAnimation1Comp = exports('RoleShowAnimation1Comp', (_dec = ecs.register('RoleShowAnimation1Comp'), _dec(_class = /*#__PURE__*/function (_ecs$Comp) {
        _inherits(RoleShowAnimation1Comp, _ecs$Comp);
        var _super = _createSuper(RoleShowAnimation1Comp);
        function RoleShowAnimation1Comp() {
          _classCallCheck(this, RoleShowAnimation1Comp);
          return _super.apply(this, arguments);
        }
        _createClass(RoleShowAnimation1Comp, [{
          key: "reset",
          value: function reset() {}
        }]);
  ...
  return {
    ...
    execute: function () {
      ...
      var RoleShowMarkerComp = exports('RoleShowMarkerComp', (_dec = ecs.register('RoleShowMarkerComp'), _dec(_class = /*#__PURE__*/function (_ecs$Comp) {
        _inherits(RoleShowMarkerComp, _ecs$Comp);
        var _super = _createSuper(RoleShowMarkerComp);
        function RoleShowMarkerComp() {
          _classCallCheck(this, RoleShowMarkerComp);
          return _super.apply(this, arguments);
        }
        _createClass(RoleShowMarkerComp, [{
          key: "reset",
          value: function reset() {}
        }]);
...
System.register("chunks:///_virtual/RoleStateComp.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './ECS.ts', './ConstType.ts'], function (exports) {
  var _inherits, _createSuper, _classCallCheck, _defineProperty, _assertThisInitialized, _createClass, cclegacy, ecs, RoleStateType;
  return {
    setters: [function (module) {
      _inherits = module.inherits;
      _createSuper = module.createSuper;
    ...
    execute: function () {
      ...
      var RoleStateComp = exports('RoleStateComp', (_dec = ecs.register('RoleStateComp'), _dec(_class = /*#__PURE__*/function (_ecs$Comp) {
        _inherits(RoleStateComp, _ecs$Comp);
        var _super = _createSuper(RoleStateComp);
        function RoleStateComp() {
          var _this;
          _classCallCheck(this, RoleStateComp);
          for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
            args[_key] = arguments[_key];
          }
          _this = _super.call.apply(_super, [this].concat(args));
          _defineProperty(_assertThisInitialized(_this), "state", RoleStateType.Idle);
          return _this;
        }
        _createClass(RoleStateComp, [{
          key: "reset",
          value: function reset() {
            console.log('HpComp reset');
          }
      ...
      var RoleStateSystem = exports('RoleStateSystem', /*#__PURE__*/function (_ecs$ComblockSystem) {
        _inherits(RoleStateSystem, _ecs$ComblockSystem);
        var _super2 = _createSuper(RoleStateSystem);
        function RoleStateSystem() {
          _classCallCheck(this, RoleStateSystem);
          return _super2.call(this);
        }
        _createClass(RoleStateSystem, [{
          key: "filter",
          value: function filter() {
...
System.register("chunks:///_virtual/RoleTaskExtraCompComp.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './CompConfig.ts', './ECS.ts', './TaskModelComp.ts', './TaskConfig.ts', './app.ts'], function (exports) {
  var _inherits, _createSuper, _classCallCheck, _defineProperty, _assertThisInitialized, _createClass, cclegacy, js, DB_CompConfig, ecs, TaskModelComp, DB_TaskConfig, app;
  return {
    setters: [function (module) {
      _inherits = module.inherits;
      _createSuper = module.createSuper;
    ...
    execute: function () {
      ...
      var RoleTaskExtraCompComp = exports('RoleTaskExtraCompComp', (_dec = ecs.register('RoleTaskExtraCompComp'), _dec(_class = /*#__PURE__*/function (_ecs$Comp) {
        _inherits(RoleTaskExtraCompComp, _ecs$Comp);
        var _super = _createSuper(RoleTaskExtraCompComp);
        function RoleTaskExtraCompComp() {
          var _this;
          _classCallCheck(this, RoleTaskExtraCompComp);
          for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
            args[_key] = arguments[_key];
          }
          _this = _super.call.apply(_super, [this].concat(args));
        ...
        _createClass(RoleTaskExtraCompComp, [{
          key: "reset",
          value: function reset() {}
        }]);
      ...
      var RoleTaskExtraCompSystem = exports('RoleTaskExtraCompSystem', /*#__PURE__*/function (_ref) {
        _inherits(RoleTaskExtraCompSystem, _ref);
        var _super2 = _createSuper(RoleTaskExtraCompSystem);
        function RoleTaskExtraCompSystem() {
          _classCallCheck(this, RoleTaskExtraCompSystem);
          return _super2.call(this);
        }
        _createClass(RoleTaskExtraCompSystem, [{
          key: "filter",
          value: function filter() {
          ...
          value: function addExtraComp(e) {
            ...
            if (taskEntity) {
              ...
              if (taskModel) {
                ...
                var roleExtraComp = (_DB_TaskConfig$taskMo = DB_TaskConfig[taskModel.taskId]) === null || _DB_TaskConfig$taskMo === void 0 ? void 0 : _DB_TaskConfig$taskMo.roleExtraComp;
                if (roleExtraComp) {
                  for (var i = 0; i < roleExtraComp.length; i++) {
...
System.register("chunks:///_virtual/RoleViewComp.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './ECS.ts', './FactionTypeComp.ts', './SkeletonViewComp.ts', './AtkDetectorComp.ts', './RoleModelComp.ts', './RoleConfig.ts', './CollisionComp.ts', './IsDropComp.ts', './BaseUnit.ts'], function (exports) {
  var _applyDecoratedDescriptor, _inherits, _createSuper, _classCallCheck, _initializerDefineProperty, _assertThisInitialized, _createClass, _get, _getPrototypeOf, cclegacy, _decorator, v3, PhysicsSystem, ecs, FactionTypeComp, SkeletonViewComp, AtkDetectorComp, RoleModelComp, DB_RoleConfig, CollisionComp, IsDropComp, BaaseUnit;
  return {
    setters: [function (module) {
      _applyDecoratedDescriptor = module.applyDecoratedDescriptor;
      _inherits = module.inherits;
    ...
    execute: function () {
      ...
      var RoleViewComp = exports('RoleViewComp', (_dec = ccclass('RoleViewComp'), _dec2 = ecs.register('RoleViewComp', false), _dec3 = property(SkeletonViewComp), _dec4 = property(AtkDetectorComp), _dec(_class = _dec2(_class = (_class2 = /*#__PURE__*/function (_BaaseUnit) {
        _inherits(RoleViewComp, _BaaseUnit);
        var _super = _createSuper(RoleViewComp);
        function RoleViewComp() {
          var _this;
          _classCallCheck(this, RoleViewComp);
          for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
            args[_key] = arguments[_key];
          }
          _this = _super.call.apply(_super, [this].concat(args));
          _initializerDefineProperty(_assertThisInitialized(_this), "skeletonComp", _descriptor, _assertThisInitialized(_this));
          _initializerDefineProperty(_assertThisInitialized(_this), "detector", _descriptor2, _assertThisInitialized(_this));
          return _this;
        }
        _createClass(RoleViewComp, [{
          key: "onLoad",
          value: function onLoad() {
            this.group = this.ent.get(FactionTypeComp).group;
            ...
            this.trigger = true;
            this.agent = true;
            _get(_getPrototypeOf(RoleViewComp.prototype), "onLoad", this).call(this);
            this.addCommonComp();
          }
...
System.register("chunks:///_virtual/RoleViewLoadComp.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './RoleModelComp.ts', './ECS.ts', './ConstType.ts', './app.ts', './BaseUnit.ts', './EnabledComp.ts', './IsPlayerComp.ts', './PositionComp.ts', './RoleViewComp.ts', './SkeletonViewComp.ts', './SpeedObstacleAvoidanceComp.ts', './UnitComp.ts'], function (exports) {
  var _inherits, _createSuper, _classCallCheck, _createClass, cclegacy, Prefab, instantiate, RoleModelComp, ecs, MapLayersType, RoleAnimType, app, BaaseUnit, EnabledComp, IsPlayerComp, PositionComp, RoleViewComp, SkeletonViewComp, SpeedObstacleAvoidanceComp, UnitComp;
  return {
    setters: [function (module) {
      _inherits = module.inherits;
      _createSuper = module.createSuper;
    ...
    execute: function () {
      ...
      var RoleViewLoadComp = exports('RoleViewLoadComp', (_dec = ecs.register('RoleViewLoadComp'), _dec(_class = /*#__PURE__*/function (_ecs$Comp) {
        _inherits(RoleViewLoadComp, _ecs$Comp);
        var _super = _createSuper(RoleViewLoadComp);
        function RoleViewLoadComp() {
          _classCallCheck(this, RoleViewLoadComp);
          return _super.apply(this, arguments);
        }
        _createClass(RoleViewLoadComp, [{
          key: "reset",
          value: function reset() {}
        }]);
      ...
      var RoleViewLoadSystem = exports('RoleViewLoadSystem', /*#__PURE__*/function (_ecs$ComblockSystem) {
        _inherits(RoleViewLoadSystem, _ecs$ComblockSystem);
        var _super2 = _createSuper(RoleViewLoadSystem);
        function RoleViewLoadSystem() {
          _classCallCheck(this, RoleViewLoadSystem);
          return _super2.call(this);
        }
        _createClass(RoleViewLoadSystem, [{
          key: "filter",
          value: function filter() {
...
System.register("chunks:///_virtual/ShowTaskComp.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './BattleController.ts', './ECS.ts'], function (exports) {
  var _inherits, _createSuper, _classCallCheck, _defineProperty, _assertThisInitialized, _createClass, cclegacy, BattleController, ecs;
  return {
    setters: [function (module) {
      _inherits = module.inherits;
      _createSuper = module.createSuper;
    ...
    execute: function () {
      ...
      var ShowTaskComp = exports('ShowTaskComp', (_dec = ecs.register('ShowTaskComp'), _dec(_class = /*#__PURE__*/function (_ecs$Comp) {
        _inherits(ShowTaskComp, _ecs$Comp);
        var _super = _createSuper(ShowTaskComp);
        function ShowTaskComp() {
          var _this;
          _classCallCheck(this, ShowTaskComp);
          for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
            args[_key] = arguments[_key];
          }
          _this = _super.call.apply(_super, [this].concat(args));
          /**展示倒计时 */
          _defineProperty(_assertThisInitialized(_this), "showCountDown", 2);
          return _this;
        }
        _createClass(ShowTaskComp, [{
          key: "reset",
          value: function reset() {}
        }]);
        return ShowTaskComp;
      ...
      var ShowTaskSystem = exports('ShowTaskSystem', /*#__PURE__*/function (_ecs$ComblockSystem) {
        _inherits(ShowTaskSystem, _ecs$ComblockSystem);
        var _super2 = _createSuper(ShowTaskSystem);
        function ShowTaskSystem() {
          _classCallCheck(this, ShowTaskSystem);
          return _super2.call(this);
        }
        _createClass(ShowTaskSystem, [{
          key: "filter",
          value: function filter() {
...
System.register("chunks:///_virtual/SkeletonViewComp.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './ConstType.ts', './RoleConfig.ts', './ECS.ts', './RoleModelComp.ts', './app.ts'], function (exports) {
  var _defineProperty, _inherits, _createSuper, _classCallCheck, _createClass, _assertThisInitialized, cclegacy, _decorator, Component, sp, isValid, RoleAnimType, RoleAnimLoop, DB_RoleConfig, ecs, RoleModelComp, app;
  return {
    setters: [function (module) {
      _defineProperty = module.defineProperty;
      _inherits = module.inherits;
    ...
    execute: function () {
      ...
      var SkeletonViewComp = exports('SkeletonViewComp', (_dec = ccclass('SkeletonViewComp'), _dec2 = ecs.register('SkeletonViewComp', false), _dec(_class = _dec2(_class = (_class2 = /*#__PURE__*/function (_Component) {
        _inherits(SkeletonViewComp, _Component);
        var _super = _createSuper(SkeletonViewComp);
        function SkeletonViewComp() {
          var _this;
          _classCallCheck(this, SkeletonViewComp);
          for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
            args[_key] = arguments[_key];
          }
          _this = _super.call.apply(_super, [this].concat(args));
          ...
          /**下一个动画 */
          _defineProperty(_assertThisInitialized(_this), "nextAnim", void 0);
          _defineProperty(_assertThisInitialized(_this), "skeletonView", void 0);
          return _this;
        }
        _createClass(SkeletonViewComp, [{
          key: "reset",
          value: function reset() {}
        }, {
          key: "loadView",
          ...
          key: "playAnim",
          value: function playAnim(name) {
            if (this.curAnim == name) return;
            this.nextAnim = name;
          }
        }]);
        return SkeletonViewComp;
      }(Component), _defineProperty(_class2, "tid", -1), _defineProperty(_class2, "compName", void 0), _class2)) || _class) || _class));

      /**骨骼动画系统 */
      var SkeletonViewSystem = exports('SkeletonViewSystem', /*#__PURE__*/function (_ref) {
        _inherits(SkeletonViewSystem, _ref);
        var _super2 = _createSuper(SkeletonViewSystem);
        function SkeletonViewSystem() {
          _classCallCheck(this, SkeletonViewSystem);
          return _super2.call(this);
        }
        _createClass(SkeletonViewSystem, [{
          key: "filter",
          value: function filter() {
  ...
  return {
    ...
    execute: function () {
      ...
      var SkillAfterDeathComp = exports('SkillAfterDeathComp', (_dec = ecs.register('SkillAfterDeathComp'), _dec(_class = /*#__PURE__*/function (_ecs$Comp) {
        _inherits(SkillAfterDeathComp, _ecs$Comp);
        var _super = _createSuper(SkillAfterDeathComp);
        function SkillAfterDeathComp() {
          var _this;
          _classCallCheck(this, SkillAfterDeathComp);
          for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
            args[_key] = arguments[_key];
          }
          _this = _super.call.apply(_super, [this].concat(args));
        ...
        _createClass(SkillAfterDeathComp, [{
          key: "reset",
          value: function reset() {}
        }]);
      ...
      var SkillAfterDeathSystem = exports('SkillAfterDeathSystem', /*#__PURE__*/function (_ecs$ComblockSystem) {
        _inherits(SkillAfterDeathSystem, _ecs$ComblockSystem);
        var _super2 = _createSuper(SkillAfterDeathSystem);
        function SkillAfterDeathSystem() {
          _classCallCheck(this, SkillAfterDeathSystem);
          return _super2.call(this);
        }
        _createClass(SkillAfterDeathSystem, [{
          key: "filter",
          value: function filter() {
...
System.register("chunks:///_virtual/SkillCompManagerComp.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './SkillPluginConfig.ts', './ECS.ts'], function (exports) {
  var _inherits, _createSuper, _classCallCheck, _defineProperty, _assertThisInitialized, _createClass, cclegacy, js, DB_SkillPluginConfig, ecs;
  return {
    setters: [function (module) {
      _inherits = module.inherits;
      _createSuper = module.createSuper;
    ...
    execute: function () {
      ...
      var SkillCompManagerComp = exports('SkillCompManagerComp', (_dec = ecs.register('SkillCompManagerComp'), _dec(_class = /*#__PURE__*/function (_ecs$Comp) {
        _inherits(SkillCompManagerComp, _ecs$Comp);
        var _super = _createSuper(SkillCompManagerComp);
        function SkillCompManagerComp() {
          var _this;
          _classCallCheck(this, SkillCompManagerComp);
          for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
            args[_key] = arguments[_key];
          }
          _this = _super.call.apply(_super, [this].concat(args));
          /**技能id */
          _defineProperty(_assertThisInitialized(_this), "compIdsMap", new Map());
          /**技能id */
          _defineProperty(_assertThisInitialized(_this), "compIds", []);
          return _this;
        }
        _createClass(SkillCompManagerComp, [{
          key: "reset",
          value: function reset() {}
        }, {
          key: "init",
          ...
          key: "addCompByid",
          value: function addCompByid(id) {
            var config = DB_SkillPluginConfig[id];
            this.ent.add(js.getClassByName(config.className));
          }
        }, {
          key: "addCompsByIds",
          value: function addCompsByIds(ids) {}
        }]);
      ...
      var SkillCompManagerSystem = exports('SkillCompManagerSystem', /*#__PURE__*/function (_ecs$ComblockSystem) {
        _inherits(SkillCompManagerSystem, _ecs$ComblockSystem);
        var _super2 = _createSuper(SkillCompManagerSystem);
        function SkillCompManagerSystem() {
          _classCallCheck(this, SkillCompManagerSystem);
          return _super2.call(this);
        }
        _createClass(SkillCompManagerSystem, [{
          key: "filter",
          value: function filter() {
...
System.register("chunks:///_virtual/SkillEntity.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './ECS.ts', './BaseEntity.ts', './DirectionComp.ts', './EnabledComp.ts', './FactionTypeComp.ts', './MoveComp.ts', './UnitComp.ts', './PositionComp.ts', './SpeedComp.ts', './SkillCompManagerComp.ts', './SkillManagerComp.ts', './SkillModelComp.ts', './HpComp.ts', './MasterComp.ts', './CollisionComp.ts', './SkillAfterDeathComp.ts', './SkillLifeTimeComp.ts', './SkillLifeOverstepBoundaryComp.ts', './IsSkillComp.ts', './MapModelComp.ts', './app.ts', './CompConfig.ts'], function (exports) {
  var _inherits, _createSuper, _classCallCheck, _createClass, _get, _getPrototypeOf, cclegacy, js, ecs, BaseEntity, DirectionComp, EnabledComp, FactionTypeComp, MoveComp, UnitComp, PositionComp, SpeedComp, SkillCompManagerComp, SkillManagerComp, SkillModelComp, HpComp, MasterComp, CollisionComp, SkillAfterDeathComp, SkillLifeTimeComp, SkillLifeOverstepBoundaryComp, IsSkillComp, MapModelComp, app, DB_CompConfig;
  return {
    setters: [function (module) {
      _inherits = module.inherits;
      _createSuper = module.createSuper;
    ...
    execute: function () {
      ...
      var SkillEntity = exports('SkillEntity', (_dec = ecs.register('SkillEntity'), _dec(_class = /*#__PURE__*/function (_BaseEntity) {
        _inherits(SkillEntity, _BaseEntity);
        var _super = _createSuper(SkillEntity);
        function SkillEntity() {
          _classCallCheck(this, SkillEntity);
          return _super.apply(this, arguments);
        }
        _createClass(SkillEntity, [{
          key: "init",
          value: function init() {
            _get(_getPrototypeOf(SkillEntity.prototype), "init", this).call(this);
...
System.register("chunks:///_virtual/SkillLifeOverstepBoundaryComp.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './app.ts', './ECS.ts', './PositionComp.ts'], function (exports) {
  var _inherits, _createSuper, _classCallCheck, _defineProperty, _assertThisInitialized, _createClass, cclegacy, app, ecs, PositionComp;
  return {
    setters: [function (module) {
      _inherits = module.inherits;
      _createSuper = module.createSuper;
    ...
    execute: function () {
      ...
      var SkillLifeOverstepBoundaryComp = exports('SkillLifeOverstepBoundaryComp', (_dec = ecs.register('SkillLifeOverstepBoundaryComp'), _dec(_class = /*#__PURE__*/function (_ecs$Comp) {
        _inherits(SkillLifeOverstepBoundaryComp, _ecs$Comp);
        var _super = _createSuper(SkillLifeOverstepBoundaryComp);
        function SkillLifeOverstepBoundaryComp() {
          var _this;
          _classCallCheck(this, SkillLifeOverstepBoundaryComp);
          for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
            args[_key] = arguments[_key];
          }
          _this = _super.call.apply(_super, [this].concat(args));
          /**技能生命周期 */
          _defineProperty(_assertThisInitialized(_this), "lifeTime", 0);
          return _this;
        }
        _createClass(SkillLifeOverstepBoundaryComp, [{
          key: "reset",
          value: function reset() {}
        }]);
      ...
      var SkillLifeOverstepBoundarySystem = exports('SkillLifeOverstepBoundarySystem', /*#__PURE__*/function (_ecs$ComblockSystem) {
        _inherits(SkillLifeOverstepBoundarySystem, _ecs$ComblockSystem);
        var _super2 = _createSuper(SkillLifeOverstepBoundarySystem);
        function SkillLifeOverstepBoundarySystem() {
          _classCallCheck(this, SkillLifeOverstepBoundarySystem);
          return _super2.call(this);
        }
        _createClass(SkillLifeOverstepBoundarySystem, [{
          key: "filter",
          value: function filter() {
...
System.register("chunks:///_virtual/SkillLifeTimeComp.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './ECS.ts', './ConstType.ts', './BerforeDeathMarkerComp.ts', './SkillModelComp.ts'], function (exports) {
  var _inherits, _createSuper, _classCallCheck, _defineProperty, _assertThisInitialized, _createClass, cclegacy, ecs, SkillAttributeType, BerforeDeathMarkerComp, SkillModelComp;
  return {
    setters: [function (module) {
      _inherits = module.inherits;
      _createSuper = module.createSuper;
    ...
    execute: function () {
      ...
      var SkillLifeTimeComp = exports('SkillLifeTimeComp', (_dec = ecs.register('SkillLifeTimeComp'), _dec(_class = /*#__PURE__*/function (_ecs$Comp) {
        _inherits(SkillLifeTimeComp, _ecs$Comp);
        var _super = _createSuper(SkillLifeTimeComp);
        function SkillLifeTimeComp() {
          var _this;
          _classCallCheck(this, SkillLifeTimeComp);
          for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
            args[_key] = arguments[_key];
          }
          _this = _super.call.apply(_super, [this].concat(args));
        ...
        _createClass(SkillLifeTimeComp, [{
          key: "reset",
          value: function reset() {}
        }]);
      ...
      var SkillLifeTimeSystem = exports('SkillLifeTimeSystem', /*#__PURE__*/function (_ref) {
        _inherits(SkillLifeTimeSystem, _ref);
        var _super2 = _createSuper(SkillLifeTimeSystem);
        function SkillLifeTimeSystem() {
          _classCallCheck(this, SkillLifeTimeSystem);
          return _super2.call(this);
        }
        _createClass(SkillLifeTimeSystem, [{
          key: "filter",
          value: function filter() {
...
System.register("chunks:///_virtual/SkillManagerComp.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './SkillPluginConfig.ts', './ECS.ts', './ConstType.ts'], function (exports) {
  var _inherits, _createSuper, _classCallCheck, _defineProperty, _assertThisInitialized, _createClass, cclegacy, js, DB_SkillPluginConfig, ecs, SkillPluginInfluence;
  return {
    setters: [function (module) {
      _inherits = module.inherits;
      _createSuper = module.createSuper;
    ...
    execute: function () {
      ...
      var SkillManagerComp = exports('SkillManagerComp', (_dec = ecs.register('SkillManagerComp'), _dec(_class = /*#__PURE__*/function (_ecs$Comp) {
        _inherits(SkillManagerComp, _ecs$Comp);
        var _super = _createSuper(SkillManagerComp);
        function SkillManagerComp() {
          var _this;
          _classCallCheck(this, SkillManagerComp);
          for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
            args[_key] = arguments[_key];
          }
          _this = _super.call.apply(_super, [this].concat(args));
          /**按照类型分组的已经添加的技能组件 */
          _defineProperty(_assertThisInitialized(_this), "skillCompByType", new Map());
          return _this;
        }
        _createClass(SkillManagerComp, [{
          key: "addSkillNewComp",
          value: function addSkillNewComp(comp) {
            var _this$skillCompByType;
            var config = DB_SkillPluginConfig[comp.skillId];
            var typeComp = (_this$skillCompByType = this.skillCompByType.get(config.type)) !== null && _this$skillCompByType !== void 0 ? _this$skillCompByType : [];
          ...
          key: "addSkillComp",
          value: function addSkillComp(comp) {
            var _this$skillCompByType2;
            var config = DB_SkillPluginConfig[comp.skillId];
            var typeComp = (_this$skillCompByType2 = this.skillCompByType.get(config.type)) !== null && _this$skillCompByType2 !== void 0 ? _this$skillCompByType2 : [];
            if (config.influence == SkillPluginInfluence.move && typeComp.length > 0) {
              console.log('唯一技能组件已经存在');
              return;
            }
          ...
          key: "addSkillCompById",
          value: function addSkillCompById(id) {
            var config = DB_SkillPluginConfig[id];
...
System.register("chunks:///_virtual/SkillModelComp.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './ECS.ts', './SkillNumericMap.ts', './ConstType.ts', './HpComp.ts'], function (exports) {
  var _inherits, _createSuper, _classCallCheck, _defineProperty, _assertThisInitialized, _createClass, cclegacy, Vec3, ecs, SkillNumericMap, SkillAttributeType, HpComp;
  return {
    setters: [function (module) {
      _inherits = module.inherits;
      _createSuper = module.createSuper;
    ...
    execute: function () {
      ...
      var SkillModelComp = exports('SkillModelComp', (_dec = ecs.register('SkillModelComp'), _dec(_class = /*#__PURE__*/function (_ecs$Comp) {
        _inherits(SkillModelComp, _ecs$Comp);
        var _super = _createSuper(SkillModelComp);
        function SkillModelComp() {
          var _this;
          _classCallCheck(this, SkillModelComp);
          for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
            args[_key] = arguments[_key];
          }
          _this = _super.call.apply(_super, [this].concat(args));
          ...
          /**散射角度 */
          _defineProperty(_assertThisInitialized(_this), "scatteringAngle", 0);
          return _this;
        }
        _createClass(SkillModelComp, [{
          key: "init",
          value: function init(data) {
      ...
      var SkillModelSystem = exports('SkillModelSystem', /*#__PURE__*/function (_ecs$ComblockSystem) {
        _inherits(SkillModelSystem, _ecs$ComblockSystem);
        var _super2 = _createSuper(SkillModelSystem);
        function SkillModelSystem() {
          _classCallCheck(this, SkillModelSystem);
          return _super2.call(this);
        }
        _createClass(SkillModelSystem, [{
          key: "filter",
          value: function filter() {
  ...
  return {
    ...
    execute: function () {
      ...
      var SkillMoveComp = exports('SkillMoveComp', /*#__PURE__*/function (_ecs$Comp) {
        _inherits(SkillMoveComp, _ecs$Comp);
        var _super = _createSuper(SkillMoveComp);
        function SkillMoveComp() {
          _classCallCheck(this, SkillMoveComp);
          return _super.apply(this, arguments);
        }
        _createClass(SkillMoveComp, [{
          key: "reset",
          value: function reset() {}
        }]);
    ...
    execute: function () {
      ...
      var SkillNumeric = exports('SkillNumeric', /*#__PURE__*/function () {
        function SkillNumeric(type) {
          _classCallCheck(this, SkillNumeric);
          /** 属性类型 */
          _defineProperty(this, "type", null);
          /**基础 */
          _defineProperty(this, "base", 0);
...
System.register("chunks:///_virtual/SkillNumericMap.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './SkillNumeric.ts'], function (exports) {
  var _createClass, _classCallCheck, _defineProperty, cclegacy, SkillNumeric;
  return {
    setters: [function (module) {
      _createClass = module.createClass;
      _classCallCheck = module.classCallCheck;
    ...
    execute: function () {
      ...
      /** 武器数值装饰器 */
      var SkillNumericDecorator = exports('SkillNumericDecorator', /*#__PURE__*/_createClass(function SkillNumericDecorator() {
        _classCallCheck(this, SkillNumericDecorator);
        /** 属性类型 */
        _defineProperty(this, "attribute", null);
        /** 属性数值 */
        _defineProperty(this, "value", 0);
      ...
      var SkillNumericMap = exports('SkillNumericMap', /*#__PURE__*/function () {
        function SkillNumericMap() {
          _classCallCheck(this, SkillNumericMap);
          /** 武器属性 */
          _defineProperty(this, "attributes", new Map());
        }
        _createClass(SkillNumericMap, [{
          key: "init",
          value: function init(data) {
            for (var key in data) {
              var dataKey = key;
...
System.register("chunks:///_virtual/SkillRenderComp.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './BaseSkillComp.ts'], function (exports) {
  var _inherits, _createSuper, _classCallCheck, _createClass, cclegacy, BaseSkillComp;
  return {
    setters: [function (module) {
      _inherits = module.inherits;
      _createSuper = module.createSuper;
    ...
    execute: function () {
      ...
      var SkillRenderComp = exports('SkillRenderComp', /*#__PURE__*/function (_BaseSkillComp) {
        _inherits(SkillRenderComp, _BaseSkillComp);
        var _super = _createSuper(SkillRenderComp);
        function SkillRenderComp() {
          _classCallCheck(this, SkillRenderComp);
          return _super.apply(this, arguments);
        }
        _createClass(SkillRenderComp, [{
          key: "reset",
          value: function reset() {}
        }]);
...
System.register("chunks:///_virtual/SkillRenderLoadComp.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './ECS.ts', './app.ts', './ConstType.ts', './BaseUnit.ts', './EnabledComp.ts', './UnitComp.ts'], function (exports) {
  var _inherits, _createSuper, _classCallCheck, _defineProperty, _assertThisInitialized, _createClass, cclegacy, Prefab, instantiate, ecs, app, MapLayersType, BaaseUnit, EnabledComp, UnitComp;
  return {
    setters: [function (module) {
      _inherits = module.inherits;
      _createSuper = module.createSuper;
    ...
    execute: function () {
      ...
      var SkillRenderLoadComp = exports('SkillRenderLoadComp', (_dec = ecs.register('SkillRenderLoadComp'), _dec(_class = /*#__PURE__*/function (_ecs$Comp) {
        _inherits(SkillRenderLoadComp, _ecs$Comp);
        var _super = _createSuper(SkillRenderLoadComp);
        function SkillRenderLoadComp() {
          var _this;
          _classCallCheck(this, SkillRenderLoadComp);
          for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
            args[_key] = arguments[_key];
          }
          _this = _super.call.apply(_super, [this].concat(args));
        ...
        _createClass(SkillRenderLoadComp, [{
          key: "reset",
          value: function reset() {}
        }]);
      ...
      var SkillRenderLoadSystem = exports('SkillRenderLoadSystem', /*#__PURE__*/function (_ecs$ComblockSystem) {
        _inherits(SkillRenderLoadSystem, _ecs$ComblockSystem);
        var _super2 = _createSuper(SkillRenderLoadSystem);
        function SkillRenderLoadSystem() {
          _classCallCheck(this, SkillRenderLoadSystem);
          return _super2.call(this);
        }
        _createClass(SkillRenderLoadSystem, [{
          key: "filter",
          value: function filter() {
...
System.register("chunks:///_virtual/SpeedComp.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './ECS.ts', './RoleModelComp.ts', './ConstType.ts', './DirectionComp.ts', './SkillModelComp.ts'], function (exports) {
  var _inherits, _createSuper, _classCallCheck, _defineProperty, _assertThisInitialized, _createClass, cclegacy, v3, ecs, RoleModelComp, AttributeType, SkillAttributeType, DirectionComp, SkillModelComp;
  return {
    setters: [function (module) {
      _inherits = module.inherits;
      _createSuper = module.createSuper;
    ...
    execute: function () {
      ...
      var SpeedComp = exports('SpeedComp', (_dec = ecs.register('SpeedComp'), _dec(_class = /*#__PURE__*/function (_ecs$Comp) {
        _inherits(SpeedComp, _ecs$Comp);
        var _super = _createSuper(SpeedComp);
        function SpeedComp() {
          var _this;
          _classCallCheck(this, SpeedComp);
          for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
            args[_key] = arguments[_key];
          }
          _this = _super.call.apply(_super, [this].concat(args));
          /**1帧的速度，具有方向性 */
          _defineProperty(_assertThisInitialized(_this), "_speed", v3(0, 0, 0));
          return _this;
        }
      ...
      var SpeedSystem = exports('SpeedSystem', /*#__PURE__*/function (_ecs$ComblockSystem) {
        _inherits(SpeedSystem, _ecs$ComblockSystem);
        var _super2 = _createSuper(SpeedSystem);
        function SpeedSystem() {
          _classCallCheck(this, SpeedSystem);
          return _super2.call(this);
        }
        _createClass(SpeedSystem, [{
          key: "filter",
          value: function filter() {
...
System.register("chunks:///_virtual/SpeedObstacleAvoidanceComp.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './ECS.ts', './UnitComp.ts', './SpeedComp.ts'], function (exports) {
  var _inherits, _createSuper, _classCallCheck, _defineProperty, _assertThisInitialized, _createClass, cclegacy, ecs, UnitComp, SpeedComp;
  return {
    setters: [function (module) {
      _inherits = module.inherits;
      _createSuper = module.createSuper;
    ...
    execute: function () {
      ...
      var SpeedObstacleAvoidanceComp = exports('SpeedObstacleAvoidanceComp', (_dec = ecs.register('SpeedObstacleAvoidanceComp'), _dec(_class = /*#__PURE__*/function (_ecs$Comp) {
        _inherits(SpeedObstacleAvoidanceComp, _ecs$Comp);
        var _super = _createSuper(SpeedObstacleAvoidanceComp);
        function SpeedObstacleAvoidanceComp() {
          var _this;
          _classCallCheck(this, SpeedObstacleAvoidanceComp);
          for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
            args[_key] = arguments[_key];
          }
          _this = _super.call.apply(_super, [this].concat(args));
          /**避障时间间隔 */
          _defineProperty(_assertThisInitialized(_this), "avoidTime", 0.2);
          /**当前避障时间 */
          _defineProperty(_assertThisInitialized(_this), "curAvoidTime", 0);
          return _this;
        }
        _createClass(SpeedObstacleAvoidanceComp, [{
          key: "reset",
          value: function reset() {}
        }]);
      ...
      var SpeedObstacleAvoidanceSystem = exports('SpeedObstacleAvoidanceSystem', /*#__PURE__*/function (_ecs$ComblockSystem) {
        _inherits(SpeedObstacleAvoidanceSystem, _ecs$ComblockSystem);
        var _super2 = _createSuper(SpeedObstacleAvoidanceSystem);
        function SpeedObstacleAvoidanceSystem() {
          _classCallCheck(this, SpeedObstacleAvoidanceSystem);
          return _super2.call(this);
        }
        _createClass(SpeedObstacleAvoidanceSystem, [{
          key: "filter",
          value: function filter() {
...
System.register("chunks:///_virtual/StateMachineComp.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './ECS.ts', './AfterDeathMarkerComp.ts'], function (exports) {
  var _inherits, _createSuper, _classCallCheck, _defineProperty, _assertThisInitialized, _createClass, cclegacy, ecs, AfterDeathMarkerComp;
  return {
    setters: [function (module) {
      _inherits = module.inherits;
      _createSuper = module.createSuper;
    ...
    execute: function () {
      ...
      var StateMachineComp = exports('StateMachineComp', (_dec = ecs.register('StateMachineComp'), _dec(_class = /*#__PURE__*/function (_ecs$Comp) {
        _inherits(StateMachineComp, _ecs$Comp);
        var _super = _createSuper(StateMachineComp);
        function StateMachineComp() {
          var _this;
          _classCallCheck(this, StateMachineComp);
          for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
            args[_key] = arguments[_key];
          }
          _this = _super.call.apply(_super, [this].concat(args));
          _defineProperty(_assertThisInitialized(_this), "states", new Map());
          /**当前状态 */
          _defineProperty(_assertThisInitialized(_this), "currentState", void 0);
          /**当前状态类型 */
          _defineProperty(_assertThisInitialized(_this), "currentStateType", void 0);
          /**下一个状态类型 */
          _defineProperty(_assertThisInitialized(_this), "nextStateType", void 0);
          /**下一个状态会用到的数据 */
          _defineProperty(_assertThisInitialized(_this), "nextData", void 0);
          return _this;
        }
        _createClass(StateMachineComp, [{
          key: "addState",
          value: function addState(state, stateBase) {
      ...
      var StateMachineSystem = exports('StateMachineSystem', /*#__PURE__*/function (_ecs$ComblockSystem) {
        _inherits(StateMachineSystem, _ecs$ComblockSystem);
        var _super2 = _createSuper(StateMachineSystem);
        function StateMachineSystem() {
          _classCallCheck(this, StateMachineSystem);
          return _super2.call(this);
        }
        _createClass(StateMachineSystem, [{
          key: "filter",
          value: function filter() {
          ...
          value: function update(e) {
            ...
            if (stateMachineComp.nextStateType && stateMachineComp.states.has(stateMachineComp.nextStateType)) {
              ...
              (_stateMachineComp$cur = stateMachineComp.currentState) === null || _stateMachineComp$cur === void 0 || _stateMachineComp$cur.exit();
              stateMachineComp.currentState = stateMachineComp.states.get(stateMachineComp.nextStateType);
              (_stateMachineComp$cur2 = stateMachineComp.currentState) === null || _stateMachineComp$cur2 === void 0 || _stateMachineComp$cur2.enter();
              stateMachineComp.currentStateType = stateMachineComp.nextStateType;
              stateMachineComp.nextStateType = undefined;
            }
            (_stateMachineComp$cur3 = stateMachineComp.currentState) === null || _stateMachineComp$cur3 === void 0 || _stateMachineComp$cur3.update(this.dt);
          }
        }]);
...
System.register("chunks:///_virtual/TaskEntity.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './ECS.ts', './BaseEntity.ts', './TaskModelComp.ts'], function (exports) {
  var _inherits, _createSuper, _classCallCheck, _createClass, _get, _getPrototypeOf, cclegacy, ecs, BaseEntity, TaskModelComp;
  return {
    setters: [function (module) {
      _inherits = module.inherits;
      _createSuper = module.createSuper;
    ...
    execute: function () {
      ...
      var TaskEntity = exports('TaskEntity', (_dec = ecs.register('TaskEntity'), _dec(_class = /*#__PURE__*/function (_BaseEntity) {
        _inherits(TaskEntity, _BaseEntity);
        var _super = _createSuper(TaskEntity);
        function TaskEntity() {
          _classCallCheck(this, TaskEntity);
          return _super.apply(this, arguments);
        }
        _createClass(TaskEntity, [{
          key: "init",
          value: function init() {
            _get(_getPrototypeOf(TaskEntity.prototype), "init", this).call(this);
...
System.register("chunks:///_virtual/TaskExpComp.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './ECS.ts', './TaskModelComp.ts'], function (exports) {
  var _inherits, _createSuper, _classCallCheck, _defineProperty, _assertThisInitialized, _createClass, cclegacy, _decorator, ecs, TaskModelComp;
  return {
    setters: [function (module) {
      _inherits = module.inherits;
      _createSuper = module.createSuper;
    ...
    execute: function () {
      ...
      var TaskExpComp = exports('TaskExpComp', (_dec = ccclass('TaskExpComp'), _dec2 = ecs.register('TaskExpComp'), _dec(_class = _dec2(_class = /*#__PURE__*/function (_ecs$Comp) {
        _inherits(TaskExpComp, _ecs$Comp);
        var _super = _createSuper(TaskExpComp);
        function TaskExpComp() {
          var _this;
          _classCallCheck(this, TaskExpComp);
          for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
            args[_key] = arguments[_key];
          }
          _this = _super.call.apply(_super, [this].concat(args));
          _defineProperty(_assertThisInitialized(_this), "totalProgress", 10);
          return _this;
        }
        _createClass(TaskExpComp, [{
          key: "reset",
          value: function reset() {}
        }]);
        return TaskExpComp;
      ...
      var TaskExpSystem = exports('TaskExpSystem', /*#__PURE__*/function (_ecs$ComblockSystem) {
        _inherits(TaskExpSystem, _ecs$ComblockSystem);
        var _super2 = _createSuper(TaskExpSystem);
        function TaskExpSystem() {
          _classCallCheck(this, TaskExpSystem);
          return _super2.call(this);
        }
        _createClass(TaskExpSystem, [{
          key: "filter",
          value: function filter() {
...
System.register("chunks:///_virtual/TaskModelComp.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './BattleController.ts', './app.ts', './TaskConfig.ts', './ECS.ts', './CreateTaskComp.ts'], function (exports) {
  var _inherits, _createSuper, _classCallCheck, _defineProperty, _assertThisInitialized, _createClass, cclegacy, BattleController, app, DB_TaskConfig, ecs, CreateTaskComp;
  return {
    setters: [function (module) {
      _inherits = module.inherits;
      _createSuper = module.createSuper;
    ...
    execute: function () {
      ...
      var TaskModelComp = exports('TaskModelComp', (_dec = ecs.register('TaskModelComp'), _dec(_class = /*#__PURE__*/function (_ecs$Comp) {
        _inherits(TaskModelComp, _ecs$Comp);
        var _super = _createSuper(TaskModelComp);
        function TaskModelComp() {
          var _this;
          _classCallCheck(this, TaskModelComp);
          for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
            args[_key] = arguments[_key];
          }
          _this = _super.call.apply(_super, [this].concat(args));
          ...
          _defineProperty(_assertThisInitialized(_this), "taskId", void 0);
          /**任务总进度 */
          _defineProperty(_assertThisInitialized(_this), "totalProgress", 0);
          /**任务当前进度 */
          _defineProperty(_assertThisInitialized(_this), "currentProgress", 0);
          /**是否是新任务 */
          _defineProperty(_assertThisInitialized(_this), "isNew", true);
          return _this;
        }
        _createClass(TaskModelComp, [{
          key: "reset",
          value: function reset() {
      ...
      var TaskModelSystem = exports('TaskModelSystem', /*#__PURE__*/function (_ecs$ComblockSystem) {
        _inherits(TaskModelSystem, _ecs$ComblockSystem);
        var _super2 = _createSuper(TaskModelSystem);
        function TaskModelSystem() {
          _classCallCheck(this, TaskModelSystem);
          return _super2.call(this);
        }
        _createClass(TaskModelSystem, [{
          key: "filter",
          value: function filter() {
...
System.register("chunks:///_virtual/TaskRoleComp.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './ECS.ts', './TaskModelComp.ts', './RoleModelComp.ts', './ConstType.ts', './HpComp.ts', './app.ts'], function (exports) {
  var _inherits, _createSuper, _classCallCheck, _createClass, cclegacy, _decorator, ecs, TaskModelComp, RoleModelComp, AttributeType, HpComp, app;
  return {
    setters: [function (module) {
      _inherits = module.inherits;
      _createSuper = module.createSuper;
    ...
    execute: function () {
      ...
      var TaskRoleComp = exports('TaskRoleComp', (_dec = ccclass('TaskRoleComp'), _dec2 = ecs.register('TaskRoleComp'), _dec(_class = _dec2(_class = /*#__PURE__*/function (_ecs$Comp) {
        _inherits(TaskRoleComp, _ecs$Comp);
        var _super = _createSuper(TaskRoleComp);
        function TaskRoleComp() {
          _classCallCheck(this, TaskRoleComp);
          return _super.apply(this, arguments);
        }
        _createClass(TaskRoleComp, [{
          key: "reset",
          value: function reset() {}
        }]);
        return TaskRoleComp;
      ...
      var TaskRoleSystem = exports('TaskRoleSystem', /*#__PURE__*/function (_ref) {
        _inherits(TaskRoleSystem, _ref);
        var _super2 = _createSuper(TaskRoleSystem);
        function TaskRoleSystem() {
          _classCallCheck(this, TaskRoleSystem);
          return _super2.call(this);
        }
        _createClass(TaskRoleSystem, [{
          key: "filter",
          value: function filter() {
...
System.register("chunks:///_virtual/TaskRoleDeathComp.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './ECS.ts', './BerforeDeathMarkerComp.ts', './IsPlayerComp.ts', './TaskModelComp.ts', './app.ts'], function (exports) {
  var _inherits, _createSuper, _classCallCheck, _createClass, cclegacy, _decorator, ecs, BerforeDeathMarkerComp, IsPlayerComp, TaskModelComp, app;
  return {
    setters: [function (module) {
      _inherits = module.inherits;
      _createSuper = module.createSuper;
    ...
    execute: function () {
      ...
      var TaskRoleDeathComp = exports('TaskRoleDeathComp', (_dec = ecs.register('TaskRoleDeathComp'), _dec(_class = /*#__PURE__*/function (_ecs$Comp) {
        _inherits(TaskRoleDeathComp, _ecs$Comp);
        var _super = _createSuper(TaskRoleDeathComp);
        function TaskRoleDeathComp() {
          _classCallCheck(this, TaskRoleDeathComp);
          return _super.apply(this, arguments);
        }
        _createClass(TaskRoleDeathComp, [{
          key: "reset",
          value: function reset() {}
        }]);
      ...
      var TaskRoleDeathSystem = exports('TaskRoleDeathSystem', /*#__PURE__*/function (_ecs$ComblockSystem) {
        _inherits(TaskRoleDeathSystem, _ecs$ComblockSystem);
        var _super2 = _createSuper(TaskRoleDeathSystem);
        function TaskRoleDeathSystem() {
          _classCallCheck(this, TaskRoleDeathSystem);
          return _super2.call(this);
        }
        _createClass(TaskRoleDeathSystem, [{
          key: "filter",
          value: function filter() {
...
System.register("chunks:///_virtual/TriggerNPCInteractionMenuComp.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './app.ts', './RoleConfig.ts', './ECS.ts', './NPCInteractionMenuComp.ts', './PositionComp.ts', './RoleModelComp.ts'], function (exports) {
  var _inherits, _createSuper, _classCallCheck, _defineProperty, _assertThisInitialized, _createClass, cclegacy, app, DB_RoleConfig, ecs, NPCInteractionMenuComp, PositionComp, RoleModelComp;
  return {
    setters: [function (module) {
      _inherits = module.inherits;
      _createSuper = module.createSuper;
    ...
    execute: function () {
      ...
      var TriggerNPCInteractionMenuComp = exports('TriggerNPCInteractionMenuComp', (_dec = ecs.register('TriggerNPCInteractionMenuComp'), _dec(_class = /*#__PURE__*/function (_ecs$Comp) {
        _inherits(TriggerNPCInteractionMenuComp, _ecs$Comp);
        var _super = _createSuper(TriggerNPCInteractionMenuComp);
        function TriggerNPCInteractionMenuComp() {
          var _this;
          _classCallCheck(this, TriggerNPCInteractionMenuComp);
          for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
            args[_key] = arguments[_key];
          }
          _this = _super.call.apply(_super, [this].concat(args));
          //触发距离
          _defineProperty(_assertThisInitialized(_this), "distance", 300);
          return _this;
        }
        _createClass(TriggerNPCInteractionMenuComp, [{
          key: "reset",
          value: function reset() {}
        }]);
      ...
      var TriggerNPCInteractionMenuSystem = exports('TriggerNPCInteractionMenuSystem', /*#__PURE__*/function (_ref) {
        _inherits(TriggerNPCInteractionMenuSystem, _ref);
        var _super2 = _createSuper(TriggerNPCInteractionMenuSystem);
        function TriggerNPCInteractionMenuSystem() {
          _classCallCheck(this, TriggerNPCInteractionMenuSystem);
          return _super2.call(this);
        }
        _createClass(TriggerNPCInteractionMenuSystem, [{
          key: "filter",
          value: function filter() {
  ...
  return {
    ...
    execute: function () {
      ...
      var UnitComp = exports('UnitComp', (_dec = ecs.register('UnitComp'), _dec(_class = /*#__PURE__*/function (_ecs$Comp) {
        _inherits(UnitComp, _ecs$Comp);
        var _super = _createSuper(UnitComp);
        function UnitComp() {
          var _this;
          _classCallCheck(this, UnitComp);
          for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
            args[_key] = arguments[_key];
          }
          _this = _super.call.apply(_super, [this].concat(args));
          /**单位节点 */
          _defineProperty(_assertThisInitialized(_this), "unit", null);
          return _this;
        }
        _createClass(UnitComp, [{
          key: "reset",
          value: function reset() {
            var _this$unit;
            (_this$unit = this.unit) === null || _this$unit === void 0 || _this$unit.node.destroy();
            this.unit = null;
          }
        }]);
        return UnitComp;
...
System.register("chunks:///_virtual/UpgradeComp.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './ECS.ts', './RoleModelComp.ts', './app.ts'], function (exports) {
  var _inherits, _createSuper, _classCallCheck, _createClass, cclegacy, _decorator, ecs, RoleModelComp, app;
  return {
    setters: [function (module) {
      _inherits = module.inherits;
      _createSuper = module.createSuper;
    ...
    execute: function () {
      ...
      var UpgradeComp = exports('UpgradeComp', (_dec = ecs.register('UpgradeComp'), _dec(_class = /*#__PURE__*/function (_ecs$Comp) {
        _inherits(UpgradeComp, _ecs$Comp);
        var _super = _createSuper(UpgradeComp);
        function UpgradeComp() {
          _classCallCheck(this, UpgradeComp);
          return _super.apply(this, arguments);
        }
        _createClass(UpgradeComp, [{
          key: "reset",
          value: function reset() {}
        }]);
        return UpgradeComp;
      ...
      var UpgradeSystem = exports('UpgradeSystem', /*#__PURE__*/function (_ecs$ComblockSystem) {
        _inherits(UpgradeSystem, _ecs$ComblockSystem);
        var _super2 = _createSuper(UpgradeSystem);
        function UpgradeSystem() {
          _classCallCheck(this, UpgradeSystem);
          return _super2.call(this);
        }
        _createClass(UpgradeSystem, [{
          key: "filter",
          value: function filter() {
...
System.register("chunks:///_virtual/WeaponAutoCastComp.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './ECS.ts', './WeaponCastMarkerComp.ts', './WeaponChargeSuccessfulMarkerComp.ts', './WeaponSilenceMarkerComp.ts', './WeaponCastComp.ts'], function (exports) {
  var _inherits, _createSuper, _classCallCheck, _createClass, cclegacy, ecs, WeaponCastMarkerComp, WeaponChargeSuccessfulMarkerComp, WeaponSilenceMarkerComp, WeaponCastComp;
  return {
    setters: [function (module) {
      _inherits = module.inherits;
      _createSuper = module.createSuper;
    ...
    execute: function () {
      ...
      var WeaponAutoCastComp = exports('WeaponAutoCastComp', (_dec = ecs.register('WeaponAutoCastComp'), _dec(_class = /*#__PURE__*/function (_ecs$Comp) {
        _inherits(WeaponAutoCastComp, _ecs$Comp);
        var _super = _createSuper(WeaponAutoCastComp);
        function WeaponAutoCastComp() {
          _classCallCheck(this, WeaponAutoCastComp);
          return _super.apply(this, arguments);
        }
        _createClass(WeaponAutoCastComp, [{
          key: "reset",
          value: function reset() {}
        }]);
      ...
      var WeaponAutoCastSystem = exports('WeaponAutoCastSystem', /*#__PURE__*/function (_ecs$ComblockSystem) {
        _inherits(WeaponAutoCastSystem, _ecs$ComblockSystem);
        var _super2 = _createSuper(WeaponAutoCastSystem);
        function WeaponAutoCastSystem() {
          _classCallCheck(this, WeaponAutoCastSystem);
          return _super2.apply(this, arguments);
        }
        _createClass(WeaponAutoCastSystem, [{
          key: "filter",
          value: function filter() {
...
System.register("chunks:///_virtual/WeaponCastComp.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './ECS.ts', './WeaponManagerComp.ts', './SkillEntity.ts', './SkillManagerComp.ts', './WeaponDepotComp.ts', './SkillModelComp.ts', './ConstType.ts', './SkillPluginConfig.ts', './FactionTypeComp.ts', './MasterComp.ts', './PositionComp.ts', './MpComp.ts', './WeaponModelComp.ts', './WeaponDirectionComp.ts'], function (exports) {
  var _inherits, _createSuper, _classCallCheck, _defineProperty, _assertThisInitialized, _createClass, cclegacy, ecs, WeaponManagerComp, SkillEntity, SkillManagerComp, WeaponDepotComp, SkillModelComp, WeaponAttributeType, SkillAttributeType, EntityType, DB_SkillPluginConfig, FactionTypeComp, MasterComp, PositionComp, MpComp, WeaponModelComp, WeaponDirectionComp;
  return {
    setters: [function (module) {
      _inherits = module.inherits;
      _createSuper = module.createSuper;
    ...
    execute: function () {
      ...
      var WeaponCastComp = exports('WeaponCastComp', (_dec = ecs.register('WeaponCastComp'), _dec(_class = /*#__PURE__*/function (_ecs$Comp) {
        _inherits(WeaponCastComp, _ecs$Comp);
        var _super = _createSuper(WeaponCastComp);
        function WeaponCastComp() {
          var _this;
          _classCallCheck(this, WeaponCastComp);
          for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
            args[_key] = arguments[_key];
          }
          _this = _super.call.apply(_super, [this].concat(args));
      ...
      var WeaponCastSystem = exports('WeaponCastSystem', /*#__PURE__*/function (_ecs$ComblockSystem) {
        _inherits(WeaponCastSystem, _ecs$ComblockSystem);
        var _super2 = _createSuper(WeaponCastSystem);
        function WeaponCastSystem() {
          _classCallCheck(this, WeaponCastSystem);
          return _super2.call(this);
        }
        _createClass(WeaponCastSystem, [{
          key: "filter",
          value: function filter() {
              ...
              if (skillPlugin.length > 0) {
                ...
                if (costMp <= e.get(MpComp).mp) {
                  ...
                  for (var _i2 = 0; _i2 < skillPlugin.length; _i2++) {
                    ...
                    skillEntity.get(SkillModelComp).init({
                      att: (_att = {}, _defineProperty(_att, SkillAttributeType.hp, _config.pierce), _defineProperty(_att, SkillAttributeType.atk, _config.damage), _defineProperty(_att, SkillAttributeType.speed, _config.speed), _defineProperty(_att, SkillAttributeType.crit, _config.crit), _defineProperty(_att, SkillAttributeType.critDamage, _config.critDamage), _defineProperty(_att, SkillAttributeType.lifeTime, _config.lifeTime), _att),
  ...
  return {
    ...
    execute: function () {
      ...
      var WeaponCastMarkerComp = exports('WeaponCastMarkerComp', (_dec = ecs.register('WeaponCastMarkerComp'), _dec(_class = /*#__PURE__*/function (_ecs$Comp) {
        _inherits(WeaponCastMarkerComp, _ecs$Comp);
        var _super = _createSuper(WeaponCastMarkerComp);
        function WeaponCastMarkerComp() {
          _classCallCheck(this, WeaponCastMarkerComp);
          return _super.apply(this, arguments);
        }
        _createClass(WeaponCastMarkerComp, [{
          key: "reset",
          value: function reset() {}
        }]);
  ...
  return {
    ...
    execute: function () {
      ...
      var WeaponChargeSuccessfulMarkerComp = exports('WeaponChargeSuccessfulMarkerComp', (_dec = ecs.register('WeaponChargeSuccessfulMarkerComp'), _dec(_class = /*#__PURE__*/function (_ecs$Comp) {
        _inherits(WeaponChargeSuccessfulMarkerComp, _ecs$Comp);
        var _super = _createSuper(WeaponChargeSuccessfulMarkerComp);
        function WeaponChargeSuccessfulMarkerComp() {
          _classCallCheck(this, WeaponChargeSuccessfulMarkerComp);
          return _super.apply(this, arguments);
        }
        _createClass(WeaponChargeSuccessfulMarkerComp, [{
          key: "reset",
          value: function reset() {}
        }]);
...
System.register("chunks:///_virtual/WeaponCompManagerComp.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './SkillPluginConfig.ts', './ECS.ts'], function (exports) {
  var _inherits, _createSuper, _classCallCheck, _defineProperty, _assertThisInitialized, _createClass, _createForOfIteratorHelper, cclegacy, js, DB_SkillPluginConfig, ecs;
  return {
    setters: [function (module) {
      _inherits = module.inherits;
      _createSuper = module.createSuper;
    ...
    execute: function () {
      ...
      var WeaponCompManagerComp = exports('WeaponCompManagerComp', (_dec = ecs.register('WeaponCompManagerComp'), _dec(_class = /*#__PURE__*/function (_ecs$Comp) {
        _inherits(WeaponCompManagerComp, _ecs$Comp);
        var _super = _createSuper(WeaponCompManagerComp);
        function WeaponCompManagerComp() {
          var _this;
          _classCallCheck(this, WeaponCompManagerComp);
          for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
            args[_key] = arguments[_key];
          }
          _this = _super.call.apply(_super, [this].concat(args));
        ...
        _createClass(WeaponCompManagerComp, [{
          key: "reset",
          value: function reset() {}
        }, {
          key: "init",
      ...
      var WeaponCompManagerSystem = exports('WeaponCompManagerSystem', /*#__PURE__*/function (_ecs$ComblockSystem) {
        _inherits(WeaponCompManagerSystem, _ecs$ComblockSystem);
        var _super2 = _createSuper(WeaponCompManagerSystem);
        function WeaponCompManagerSystem() {
          _classCallCheck(this, WeaponCompManagerSystem);
          return _super2.call(this);
        }
        _createClass(WeaponCompManagerSystem, [{
          key: "filter",
          value: function filter() {
          ...
          value: function update(e) {
            ...
            var _iterator = _createForOfIteratorHelper(comp.compIds),
              _step;
            try {
              for (_iterator.s(); !(_step = _iterator.n()).done;) {
                var id = _step.value;
...
System.register("chunks:///_virtual/WeaponDepotComp.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './WeaponModelComp.ts', './ECS.ts', './MasterComp.ts', './WeaponEntity.ts', './FixedEntPositionComp.ts'], function (exports) {
  var _inherits, _createSuper, _classCallCheck, _defineProperty, _assertThisInitialized, _createClass, cclegacy, WeaponModelComp, ecs, MasterComp, WeaponEntity, FixedEntPositionComp;
  return {
    setters: [function (module) {
      _inherits = module.inherits;
      _createSuper = module.createSuper;
    ...
    execute: function () {
      ...
      var WeaponDepotComp = exports('WeaponDepotComp', (_dec = ecs.register('WeaponDepotComp'), _dec(_class = /*#__PURE__*/function (_ecs$Comp) {
        _inherits(WeaponDepotComp, _ecs$Comp);
        var _super = _createSuper(WeaponDepotComp);
        function WeaponDepotComp() {
          var _this;
          _classCallCheck(this, WeaponDepotComp);
          for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
            args[_key] = arguments[_key];
          }
          _this = _super.call.apply(_super, [this].concat(args));
          /**武器集合 */
          _defineProperty(_assertThisInitialized(_this), "weaponArr", []);
          /**当前使用的武器 */
          _defineProperty(_assertThisInitialized(_this), "curWeapon", void 0);
          /** 当前使用武器索引 */
          _defineProperty(_assertThisInitialized(_this), "curWeaponIndex", -1);
          /**下一个切换的武器索引 */
          _defineProperty(_assertThisInitialized(_this), "nextWeaponIndex", 0);
          return _this;
        }
        _createClass(WeaponDepotComp, [{
          key: "addMoreWeapon",
          value: function addMoreWeapon(weaponData) {
          ...
          key: "addOneWeapon",
          value: function addOneWeapon(weaponData) {
      ...
      var WeaponDepotSystem = exports('WeaponDepotSystem', /*#__PURE__*/function (_ecs$ComblockSystem) {
        _inherits(WeaponDepotSystem, _ecs$ComblockSystem);
        var _super2 = _createSuper(WeaponDepotSystem);
        function WeaponDepotSystem() {
          _classCallCheck(this, WeaponDepotSystem);
          return _super2.call(this);
        }
        _createClass(WeaponDepotSystem, [{
          key: "filter",
          value: function filter() {
...
System.register("chunks:///_virtual/WeaponDirectionComp.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './ECS.ts'], function (exports) {
  var _inherits, _createSuper, _classCallCheck, _defineProperty, _assertThisInitialized, _createClass, cclegacy, v3, ecs;
  return {
    setters: [function (module) {
      _inherits = module.inherits;
      _createSuper = module.createSuper;
    ...
    execute: function () {
      ...
      var WeaponDirectionComp = exports('WeaponDirectionComp', (_dec = ecs.register('WeaponDirectionComp'), _dec(_class = /*#__PURE__*/function (_ecs$Comp) {
        _inherits(WeaponDirectionComp, _ecs$Comp);
        var _super = _createSuper(WeaponDirectionComp);
        function WeaponDirectionComp() {
          var _this;
          _classCallCheck(this, WeaponDirectionComp);
          for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
            args[_key] = arguments[_key];
          }
          _this = _super.call.apply(_super, [this].concat(args));
      ...
      var WeaponDirectionSystem = exports('WeaponDirectionSystem', /*#__PURE__*/function (_ecs$ComblockSystem) {
        _inherits(WeaponDirectionSystem, _ecs$ComblockSystem);
        var _super2 = _createSuper(WeaponDirectionSystem);
        function WeaponDirectionSystem() {
          _classCallCheck(this, WeaponDirectionSystem);
          return _super2.call(this);
        }
        _createClass(WeaponDirectionSystem, [{
          key: "filter",
          value: function filter() {
...
System.register("chunks:///_virtual/WeaponEntity.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './ECS.ts', './BaseEntity.ts', './FixedEntPositionComp.ts', './PositionComp.ts', './UnitComp.ts', './WeaponDirectionComp.ts', './IsWeaponComp.ts', './MasterComp.ts', './WeaponCompManagerComp.ts', './WeaponManagerComp.ts', './WeaponModelComp.ts'], function (exports) {
  var _inherits, _createSuper, _classCallCheck, _createClass, _get, _getPrototypeOf, cclegacy, ecs, BaseEntity, FixedEntPositionComp, PositionComp, UnitComp, WeaponDirectionComp, IsWeaponComp, MasterComp, WeaponCompManagerComp, WeaponManagerComp, WeaponModelComp;
  return {
    setters: [function (module) {
      _inherits = module.inherits;
      _createSuper = module.createSuper;
    ...
    execute: function () {
      ...
      var WeaponEntity = exports('WeaponEntity', (_dec = ecs.register('WeaponEntity'), _dec(_class = /*#__PURE__*/function (_BaseEntity) {
        _inherits(WeaponEntity, _BaseEntity);
        var _super = _createSuper(WeaponEntity);
        function WeaponEntity() {
          _classCallCheck(this, WeaponEntity);
          return _super.apply(this, arguments);
        }
        _createClass(WeaponEntity, [{
          key: "init",
          value: function init() {
            _get(_getPrototypeOf(WeaponEntity.prototype), "init", this).call(this);
...
System.register("chunks:///_virtual/WeaponManagerComp.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './SkillPluginConfig.ts', './ECS.ts', './BattleUtil.ts', './ConstType.ts', './WeaponModelComp.ts'], function (exports) {
  var _inherits, _createSuper, _classCallCheck, _defineProperty, _assertThisInitialized, _createClass, cclegacy, js, DB_SkillPluginConfig, ecs, BattleUtil, SkillPluginType, WeaponAttributeType, WeaponModelComp;
  return {
    setters: [function (module) {
      _inherits = module.inherits;
      _createSuper = module.createSuper;
    ...
    execute: function () {
      ...
      var WeaponManagerComp = exports('WeaponManagerComp', (_dec = ecs.register('WeaponManagerComp'), _dec(_class = /*#__PURE__*/function (_ecs$Comp) {
        _inherits(WeaponManagerComp, _ecs$Comp);
        var _super = _createSuper(WeaponManagerComp);
        function WeaponManagerComp() {
          var _this;
          _classCallCheck(this, WeaponManagerComp);
          for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
            args[_key] = arguments[_key];
          }
          _this = _super.call.apply(_super, [this].concat(args));
          /**法术组件id */
          _defineProperty(_assertThisInitialized(_this), "skillIdArr", []);
          /**施法位置 */
          _defineProperty(_assertThisInitialized(_this), "skillIndex", 999);
          /**回绕位置 */
          _defineProperty(_assertThisInitialized(_this), "skillBackIndex", 0);
          /**施法延迟 */
          _defineProperty(_assertThisInitialized(_this), "skillDelay", 0);
          /**施法数量 */
          _defineProperty(_assertThisInitialized(_this), "castNum", 0);
          /**最大施法延迟，用于界面展示 */
          _defineProperty(_assertThisInitialized(_this), "maxSkillDelay", 0);
          return _this;
        }
        _createClass(WeaponManagerComp, [{
          key: "getSkill",
          value: /**获取一个法术或者修正 */
      ...
      var WeaponManagerSystem = exports('WeaponManagerSystem', /*#__PURE__*/function (_ecs$ComblockSystem) {
        _inherits(WeaponManagerSystem, _ecs$ComblockSystem);
        var _super2 = _createSuper(WeaponManagerSystem);
        function WeaponManagerSystem() {
          _classCallCheck(this, WeaponManagerSystem);
          return _super2.call(this);
        }
        _createClass(WeaponManagerSystem, [{
          key: "filter",
          value: function filter() {
          ...
          key: "updateWeapinSkillIds",
          value: function updateWeapinSkillIds(e) {
            var comp = e.get(WeaponManagerComp);
  ...
  return {
    ...
    execute: function () {
      ...
      var WeaponModelComp = exports('WeaponModelComp', (_dec = ecs.register('WeaponModelComp'), _dec(_class = /*#__PURE__*/function (_ecs$Comp) {
        _inherits(WeaponModelComp, _ecs$Comp);
        var _super = _createSuper(WeaponModelComp);
        function WeaponModelComp() {
          var _this;
          _classCallCheck(this, WeaponModelComp);
          for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
            args[_key] = arguments[_key];
          }
          _this = _super.call.apply(_super, [this].concat(args));
    ...
    execute: function () {
      ...
      var WeaponNumeric = exports('WeaponNumeric', /*#__PURE__*/function () {
        function WeaponNumeric(type) {
          _classCallCheck(this, WeaponNumeric);
          /** 属性类型 */
          _defineProperty(this, "type", null);
          /**基础 */
          _defineProperty(this, "base", 0);
...
System.register("chunks:///_virtual/WeaponNumericMap.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './WeaponNumeric.ts'], function (exports) {
  var _createClass, _classCallCheck, _defineProperty, cclegacy, WeaponNumeric;
  return {
    setters: [function (module) {
      _createClass = module.createClass;
      _classCallCheck = module.classCallCheck;
    ...
    execute: function () {
      ...
      /** 武器数值装饰器 */
      var WeaponNumericDecorator = exports('WeaponNumericDecorator', /*#__PURE__*/_createClass(function WeaponNumericDecorator() {
        _classCallCheck(this, WeaponNumericDecorator);
        /** 属性类型 */
        _defineProperty(this, "attribute", null);
        /** 属性数值 */
        _defineProperty(this, "value", 0);
      ...
      var WeaponNumericMap = exports('WeaponNumericMap', /*#__PURE__*/function () {
        function WeaponNumericMap() {
          _classCallCheck(this, WeaponNumericMap);
          /** 武器属性 */
          _defineProperty(this, "attributes", new Map());
        }
        _createClass(WeaponNumericMap, [{
          key: "init",
          value: function init(data) {
            for (var key in data) {
              var dataKey = key;
  ...
  return {
    ...
    execute: function () {
      ...
      var WeaponSilenceMarkerComp = exports('WeaponSilenceMarkerComp', (_dec = ecs.register('WeaponSilenceMarkerComp'), _dec(_class = /*#__PURE__*/function (_ecs$Comp) {
        _inherits(WeaponSilenceMarkerComp, _ecs$Comp);
        var _super = _createSuper(WeaponSilenceMarkerComp);
        function WeaponSilenceMarkerComp() {
          _classCallCheck(this, WeaponSilenceMarkerComp);
          return _super.apply(this, arguments);
        }
        _createClass(WeaponSilenceMarkerComp, [{
          key: "reset",
          value: function reset() {}
        }]);
