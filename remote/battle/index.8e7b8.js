...
System.register("chunks:///_virtual/BattleUtil.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './app.ts', './MapModelComp.ts', './PositionComp.ts', './DamageFlyText.ts', './export.type.ts', './IconConfig.ts', './EquipConfig.ts', './WeaponConfig.ts', './MagicStoneConfig.ts', './ResourceConfig.ts', './SkillPluginConfig.ts', './EnabledComp.ts', './FactionTypeComp.ts'], function (exports) {
  var _createForOfIteratorHelperLoose, cclegacy, Vec3, SpriteFrame, Sprite, instantiate, app, MapModelComp, PositionComp, DamageFlyText, MapLayersType, ItemType, DB_IconConfig, DB_EquipConfig, DB_WeaponConfig, DB_MagicStoneConfig, DB_ResourceConfig, DB_SkillPluginConfig, EnabledComp, FactionTypeComp;
  return {
    setters: [function (module) {
    ...
    execute: function () {
      ...
      var BattleUtil = exports('default', /*#__PURE__*/function () {
        ...
        BattleUtil.getNearestEnemy = function getNearestEnemy(role) {
          ...
          var enemyFaction = app.store.help.getEnemyFaction(faction);
          ...
          if (Math.random() < app.config.game.EquipmentDropRate) {
            ...
            if (dropEquip.length > 0) {
              ...
              if (_equipment) {
                ...
                var equipmentData = app.store.help.createEquipment(_equipment.id);
...
System.register("chunks:///_virtual/DropMoneyComp.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './DropModelComp.ts', './DropEntity.ts', './IsPlayerComp.ts', './BerforeDeathMarkerComp.ts', './PositionComp.ts', './app.ts', './ECS.ts', './export.type.ts'], function (exports) {
  var _inheritsLoose, cclegacy, _decorator, DropModelComp, DropEntity, IsPlayerComp, BerforeDeathMarkerComp, PositionComp, app, ecs, ItemType;
  return {
    setters: [function (module) {
      _inheritsLoose = module.inheritsLoose;
    }, function (module) {
      ...
      var DropMoneySystem = exports('DropMoneySystem', /*#__PURE__*/function (_ecs$ComblockSystem) {
        ...
        _proto2.entityEnter = function entityEnter(e) {
          ...
          if (Math.random() < app.config.game.MoneyDropRate) {
            //掉落
            console.log('掉落金钱');
            var num = app.store.help.randomBetweenTwoValues(app.config.game.MoneyDropRange[0], app.config.game.MoneyDropRange[1]);
            var dropEntity = ecs.getEntity(DropEntity);
            dropEntity.get(DropModelComp).init({
              id: 100101,
              num: num,
          ...
          if (Math.random() < app.config.game.WeaponDropRate) {
            ...
            if (dropWeapon.length > 0) {
              ...
              if (_weapon) {
                ...
                var dropEntity = ecs.getEntity(DropEntity);
                var weaponData = app.store.help.createWeapon(_weapon.id);
                dropEntity.get(DropModelComp).init({
                  id: _weapon.id,
...
System.register("chunks:///_virtual/NormalAtkComp.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './ECS.ts', './AtkDetectorComp.ts', './EnabledComp.ts', './HpComp.ts', './PositionComp.ts', './StateMachineComp.ts', './MasterComp.ts', './SkeletonViewComp.ts', './RestrictMoveComp.ts', './RoleAtkMarkerComp.ts', './export.type.ts', './BattleUtil.ts'], function (exports) {
  var _inheritsLoose, _createClass, cclegacy, _decorator, ecs, AtkDetectorComp, EnabledComp, HpComp, PositionComp, StateMachineComp, MasterComp, SkeletonViewComp, RestrictMoveComp, RoleAtkMarkerComp, RoleAnimType, RoleStateMachineType, BattleUtil;
  return {
    setters: [function (module) {
      _inheritsLoose = module.inheritsLoose;
      _createClass = module.createClass;
...
System.register("chunks:///_virtual/PursueEnemyMoveComp.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './SkillMoveComp.ts', './ECS.ts', './DirectionComp.ts', './PositionComp.ts', './FactionTypeComp.ts', './LinearSkillMoveComp.ts', './BattleUtil.ts'], function (exports) {
  var _inheritsLoose, cclegacy, _decorator, SkillMoveComp, ecs, DirectionComp, PositionComp, FactionTypeComp, LinearSkillMoveComp, BattleUtil;
  return {
    setters: [function (module) {
      _inheritsLoose = module.inheritsLoose;
    }, function (module) {
...
System.register("chunks:///_virtual/RoleModelComp.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './CompConfig.ts', './RoleConfig.ts', './ECS.ts', './RoleNumericMap.ts', './HpComp.ts', './TriggerNPCInteractionMenuComp.ts', './export.type.ts', './app.ts'], function (exports) {
  var _inheritsLoose, cclegacy, js, DB_CompConfig, DB_RoleConfig, ecs, RoleNumericMap, HpComp, TriggerNPCInteractionMenuComp, AttributeType, app;
  return {
    setters: [function (module) {
      _inheritsLoose = module.inheritsLoose;
    }, function (module) {
    ...
    execute: function () {
      ...
      var RoleModelComp = exports('RoleModelComp', (_dec = ecs.register('RoleModelComp'), _dec(_class = /*#__PURE__*/function (_ecs$Comp) {
        ...
        _proto.initAttributes = function initAttributes(lv, difficulty) {
          this.attributes.init(app.store.help.getRoleAttribute(this.roleId, lv, difficulty));
