...
System.register("chunks:///_virtual/AssassinMsComp.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './ECS.ts', './RoleModelComp.ts', './export.type.ts'], function (exports) {
  ...
  return {
    ...
    execute: function () {
      ...
      /**刺客之石系统 */
      var AssassinMsSystem = exports('AssassinMsSystem', /*#__PURE__*/function (_ref) {
        _inheritsLoose(AssassinMsSystem, _ref);
        var _proto2 = AssassinMsSystem.prototype;
        _proto2.filter = function filter() {
          return ecs.allOf(AssassinMsComp);
        };
        function AssassinMsSystem() {
...
System.register("chunks:///_virtual/AtkDetectorComp.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './Object.ts', './ECS.ts', './FactionTypeComp.ts', './Collider.ts', './Shape.ts', './StateMachineComp.ts', './DeathComp.ts', './BaseUnit.ts', './AfterDeathMarkerComp.ts', './export.type.ts'], function (exports) {
  var _inheritsLoose, cclegacy, _decorator, PhysicsSystem, Vec3, Dirty, cObject, ecs, FactionTypeComp, cCollider, ShapeType, StateMachineComp, DeathComp, BaaseUnit, AfterDeathMarkerComp, EntityType, RoleStateMachineType;
  return {
    setters: [function (module) {
      _inheritsLoose = module.inheritsLoose;
    }, function (module) {
      ...
      var AtkDetectorComp = exports('AtkDetectorComp', (_dec = ccclass('AtkDetectorComp'), _dec2 = ecs.register('AtkDetectorComp', false), _dec(_class = _dec2(_class = (_class2 = /*#__PURE__*/function (_cObject) {
        ...
        _proto.onTriggerStay = function onTriggerStay(b) {
          ...
          if (this.ent && this.ent.get(FactionTypeComp).type == EntityType.ROLE) {
            ...
            //攻击半径
            if (enemyEnt && enemyEnt.get(FactionTypeComp).type == EntityType.ROLE && state.currentStateType != RoleStateMachineType.Pursue && state.currentStateType != RoleStateMachineType.Atk && !this.ent.get(DeathComp) && !this.ent.get(AfterDeathMarkerComp)) {
              if (lengthSqr < this.pursueRadius * this.pursueRadius) {
                //追踪敌人
                ...
                this.ent.get(StateMachineComp).changeState(RoleStateMachineType.Move);
              }
            }
          }
        }
...
System.register("chunks:///_virtual/BattleUtil.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './app.ts', './MapModelComp.ts', './PositionComp.ts', './FactionTypeComp.ts', './EnabledComp.ts', './DamageFlyText.ts', './RoleConfig.ts', './export.type.ts', './IconConfig.ts', './EquipConfig.ts', './WeaponConfig.ts', './MagicStoneConfig.ts', './ResourceConfig.ts', './SkillPluginConfig.ts'], function (exports) {
  var _createForOfIteratorHelperLoose, cclegacy, Vec3, SpriteFrame, Sprite, instantiate, app, MapModelComp, PositionComp, FactionTypeComp, EnabledComp, DamageFlyText, DB_RoleConfig, FactionType, AttributeType, WeaponAttributeType, MapLayersType, ItemType, DB_IconConfig, DB_EquipConfig, DB_WeaponConfig, DB_MagicStoneConfig, DB_ResourceConfig, DB_SkillPluginConfig;
  return {
    setters: [function (module) {
    ...
    execute: function () {
      ...
      var BattleUtil = exports('default', /*#__PURE__*/function () {
        ...
        BattleUtil.deepClone = function deepClone(obj) {
          ...
          for (var _key in obj) {
            if (Object.prototype.hasOwnProperty.call(obj, _key)) {
              clonedObj[_key] = BattleUtil.deepClone(obj[_key]);
            }
          }
          return clonedObj;
        }
         ...
         * @param config 配置
         */;
        BattleUtil.loadIcon = function loadIcon(sp, id, config) {
          var iconId = config[id].icon;
         ...
         * 根据装备id创建装备
         */;
        BattleUtil.createEquipment = function createEquipment(equipId) {
          //生成属性值
          var attrValues = {
            id: 0,
            equipmentId: 0,
          ...
          for (var _i = 0; _i < attrCount; _i++) {
            ...
            if (attr in configData) {
              ...
              if (Array.isArray(configData[attr])) {
                ...
                value = BattleUtil.randomBetweenTwoValues(value1, value2);
              } else {
        ...
        /**根据id创建法杖 */;
        BattleUtil.createWeapon = function createWeapon(weaponId) {
          var _attrValues;
        ...
        BattleUtil.randomBetweenTwoValues = function randomBetweenTwoValues(min, max) {
        ...
        BattleUtil.generateUniqueId = function generateUniqueId() {
          //TODO:后面优化
        ...
        BattleUtil.getItemConfigByTypeAndId = function getItemConfigByTypeAndId(id, type) {
          var config = null;
...
System.register("chunks:///_virtual/BombComp.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './SkillRenderComp.ts', './EnabledComp.ts', './PositionComp.ts', './UnitComp.ts', './app.ts', './ECS.ts', './BaseUnit.ts', './export.type.ts'], function (exports) {
  var _inheritsLoose, cclegacy, _decorator, Prefab, instantiate, SkillRenderComp, EnabledComp, PositionComp, UnitComp, app, ecs, BaaseUnit, MapLayersType;
  return {
    setters: [function (module) {
      _inheritsLoose = module.inheritsLoose;
    }, function (module) {
...
System.register("chunks:///_virtual/BombExplosionComp.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './SkillRenderComp.ts', './EnabledComp.ts', './PositionComp.ts', './UnitComp.ts', './SkillAfterDeathComp.ts', './app.ts', './ECS.ts', './BaseUnit.ts', './export.type.ts'], function (exports) {
  var _inheritsLoose, cclegacy, _decorator, Prefab, instantiate, SkillRenderComp, EnabledComp, PositionComp, UnitComp, SkillAfterDeathComp, app, ecs, BaaseUnit, MapLayersType;
  return {
    setters: [function (module) {
      _inheritsLoose = module.inheritsLoose;
    }, function (module) {
    ...
    execute: function () {
      ...
      var CameraFollowSystem = exports('CameraFollowSystem', /*#__PURE__*/function (_ref) {
        ...
        _proto2.noOutBounds = function noOutBounds(e) {
          ...
          if (mapModel.width < app.config.game.InfiniteMapSize) {
            //不要超出界外
            var comp = e.get(CameraFollowComp);
...
System.register("chunks:///_virtual/ChainSawComp.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './ECS.ts', './SkillRenderComp.ts', './CollisionMotionlessComp.ts', './CollisionReboundComp.ts', './app.ts', './BaseUnit.ts', './EnabledComp.ts', './PositionComp.ts', './UnitComp.ts', './export.type.ts'], function (exports) {
  var _inheritsLoose, cclegacy, _decorator, Prefab, instantiate, ecs, SkillRenderComp, CollisionMotionlessComp, CollisionReboundComp, app, BaaseUnit, EnabledComp, PositionComp, UnitComp, MapLayersType;
  return {
    setters: [function (module) {
      _inheritsLoose = module.inheritsLoose;
    }, function (module) {
...
System.register("chunks:///_virtual/CloseCombatAtkComp.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './ECS.ts', './AtkDetectorComp.ts', './EnabledComp.ts', './HpComp.ts', './PositionComp.ts', './SkeletonViewComp.ts', './RestrictMoveComp.ts', './RoleAtkMarkerComp.ts', './export.type.ts', './RoleModelComp.ts'], function (exports) {
  var _inheritsLoose, _createClass, cclegacy, _decorator, ecs, AtkDetectorComp, EnabledComp, HpComp, PositionComp, SkeletonViewComp, RestrictMoveComp, RoleAtkMarkerComp, RoleAnimType, RoleModelComp;
  return {
    setters: [function (module) {
      _inheritsLoose = module.inheritsLoose;
    ...
    execute: function () {
      var _dec, _dec2, _class;
      cclegacy._RF.push({}, "63c50tX3zJFvZxlZm1CUCW4", "CloseCombatAtkComp", undefined);
      var ccclass = _decorator.ccclass,
        property = _decorator.property;

      /**近战攻击 */
      var CloseCombatAtkComp = exports('CloseCombatAtkComp', (_dec = ccclass('CloseCombatAtkComp'), _dec2 = ecs.register('CloseCombatAtkComp'), _dec(_class = _dec2(_class = /*#__PURE__*/function (_ecs$Comp) {
        _inheritsLoose(CloseCombatAtkComp, _ecs$Comp);
        function CloseCombatAtkComp() {
          var _this;
          for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
            args[_key] = arguments[_key];
          }
        ...
        var _proto = CloseCombatAtkComp.prototype;
        _proto.reset = function reset() {};
        _createClass(CloseCombatAtkComp, [{
          key: "pursueEntity",
          get: function get() {
        ...
        return CloseCombatAtkComp;
      }(ecs.Comp)) || _class) || _class));

      /**近战攻击系统 */
      var CloseCombatAtkSystem = exports('CloseCombatAtkSystem', /*#__PURE__*/function (_ecs$ComblockSystem) {
        _inheritsLoose(CloseCombatAtkSystem, _ecs$ComblockSystem);
        function CloseCombatAtkSystem() {
          return _ecs$ComblockSystem.apply(this, arguments) || this;
        }
        var _proto2 = CloseCombatAtkSystem.prototype;
        _proto2.filter = function filter() {
          return ecs.allOf(CloseCombatAtkComp, RoleModelComp, SkeletonViewComp);
        };
        _proto2.update = function update(e) {
          var closeCombatAtkComp = e.get(CloseCombatAtkComp);
          var atkEntity = closeCombatAtkComp.pursueEntity;
          if (atkEntity && atkEntity.get(EnabledComp)) {
            ...
            closeCombatAtkComp.curTime -= this.dt;
            if (closeCombatAtkComp.curTime <= 0) {
              closeCombatAtkComp.curTime = closeCombatAtkComp.coolTime;
              var distance = pos.subtract(pursuePos).length();
              var detector = e.get(AtkDetectorComp);
              if (detector && distance <= detector.attackRadius) {
                var valueData = e.get(RoleModelComp).attributes.getAtk();
                atkEntity.get(HpComp).addHp({
                  isCrit: valueData.isCrit,
                  value: -valueData.value,
                  isShow: true
                });
              }
              e.get(SkeletonViewComp).playAnim(RoleAnimType.atk);
              e.add(RestrictMoveComp).coolTime = 1;
              e.add(RoleAtkMarkerComp);
            }
            return;
          }
...
System.register("chunks:///_virtual/CollisionComp.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './export.type.ts', './SkillPluginConfig.ts', './ECS.ts', './CollisionMarkerComp.ts', './SkillModelComp.ts', './EnabledComp.ts', './FactionTypeComp.ts', './HpComp.ts', './RoleModelComp.ts'], function (exports) {
  var _inheritsLoose, cclegacy, EntityType, AttributeType, DB_SkillPluginConfig, ecs, CollisionMarkerComp, SkillModelComp, EnabledComp, FactionTypeComp, HpComp, RoleModelComp;
  return {
    setters: [function (module) {
      _inheritsLoose = module.inheritsLoose;
    }, function (module) {
...
System.register("chunks:///_virtual/CollisionFireballComp.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './ECS.ts', './SkillRenderComp.ts', './PositionComp.ts', './SkillPluginConfig.ts', './SkillManagerComp.ts', './app.ts', './BaseUnit.ts', './EnabledComp.ts', './UnitComp.ts', './export.type.ts'], function (exports) {
  var _inheritsLoose, cclegacy, _decorator, js, Prefab, instantiate, ecs, SkillRenderComp, PositionComp, DB_SkillPluginConfig, SkillManagerComp, app, BaaseUnit, EnabledComp, UnitComp, MapLayersType;
  return {
    setters: [function (module) {
      _inheritsLoose = module.inheritsLoose;
    }, function (module) {
...
System.register("chunks:///_virtual/CollisionTriggerComp.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './ECS.ts', './SkillRenderComp.ts', './SkillPluginConfig.ts', './BerforeDeathMarkerComp.ts', './FactionTypeComp.ts', './PositionComp.ts', './SkillEntity.ts', './MasterComp.ts', './SkillModelComp.ts', './SkillManagerComp.ts', './BattleUtil.ts', './export.type.ts'], function (exports) {
  var _inheritsLoose, cclegacy, _decorator, Vec3, ecs, SkillRenderComp, DB_SkillPluginConfig, BerforeDeathMarkerComp, FactionTypeComp, PositionComp, SkillEntity, MasterComp, SkillModelComp, SkillManagerComp, BattleUtil, SkillAttributeType, EntityType;
  return {
    setters: [function (module) {
      _inheritsLoose = module.inheritsLoose;
    }, function (module) {
...
System.register("chunks:///_virtual/ControlSystem.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './ECS.ts', './CameraFollowComp.ts', './CollisionComp.ts', './DamageFlyTextComp.ts', './DeathComp.ts', './DirectionComp.ts', './Enemy1FsmComp.ts', './HpComp.ts', './AfterDeathMarkerComp.ts', './BerforeDeathMarkerComp.ts', './RoleAtkMarkerComp.ts', './MoveComp.ts', './MpComp.ts', './NormalAtkComp.ts', './PositionComp.ts', './PursueComp.ts', './PursuePlayerMoveComp.ts', './RestrictMoveComp.ts', './RoleAfterDeathComp.ts', './RoleAutoCastComp.ts', './RoleCastComp.ts', './RoleViewLoadComp.ts', './SkeletonViewComp.ts', './SpeedComp.ts', './SpeedObstacleAvoidanceComp.ts', './StateMachineComp.ts', './WeaponDepotComp.ts', './LinearSkillMoveComp.ts', './PursueEnemyMoveComp.ts', './FireballComp.ts', './SkillAfterDeathComp.ts', './SkillLifeOverstepBoundaryComp.ts', './SkillLifeTimeComp.ts', './WeaponAutoCastComp.ts', './WeaponCastComp.ts', './WeaponCompManagerComp.ts', './WeaponManagerComp.ts', './ColliderComp.ts', './MonsterFactoryComp.ts', './PlayerShowComp.ts', './BombExplosionComp.ts', './BombComp.ts', './CreateBombExplosionComp.ts', './DeathBombExplosionComp.ts', './IsSkillComp.ts', './CollisionFireballComp.ts', './CollisionTriggerComp.ts', './CollisionReboundComp.ts', './ChainSawComp.ts', './CollisionMarkerComp.ts', './CollisionMotionlessComp.ts', './DropSkillPluginComp.ts', './DropViewComp.ts', './CollectDropComp.ts', './DropItemAfterDeathComp.ts', './TriggerNPCInteractionMenuComp.ts', './NPCInteractionMenuComp.ts', './MapLoadComp.ts', './InfiniteMapCom.ts', './NotOutBoundsComp.ts', './BigMapComp.ts', './RandomlyGenerateMonsterComp.ts', './ShowTaskComp.ts', './TaskExpComp.ts', './CreateTaskComp.ts', './TaskModelComp.ts', './RoleMapExtraCompComp.ts', './MapModelComp.ts', './CreateRoleComp.ts', './DropTaskExpComp.ts', './RoleTaskExtraCompComp.ts', './GenerateOneRoleComp.ts', './TaskRoleComp.ts', './DropPlayerExpComp.ts', './UpgradeComp.ts', './PrecisionMsComp.ts', './AssassinMsComp.ts', './CloseCombatAtkComp.ts', './DropMagicStoneComp.ts', './DropWeaponComp.ts', './DropMoneyComp.ts', './DropEquipmentComp.ts'], function (exports) {
  ...
  return {
    setters: [function (module) {
      ...
      DropSkillPluginSystem = module.DropSkillPluginSystem;
    }, function (module) {
      ...
      PrecisionMsSystem = module.PrecisionMsSystem;
    }, function (module) {
      AssassinMsSystem = module.AssassinMsSystem;
    }, function (module) {
      CloseCombatAtkSystem = module.CloseCombatAtkSystem;
    }, function (module) {
      DropMagicStoneSystem = module.DropMagicStoneSystem;
    }, function (module) {
      DropWeaponSystem = module.DropWeaponSystem;
    }, function (module) {
      DropMoneySystem = module.DropMoneySystem;
    }, function (module) {
      DropEquipmentSystem = module.DropEquipmentSystem;
    }],
    execute: function () {
      ...
      var ControlSystem = exports('ControlSystem', /*#__PURE__*/function (_ecs$System) {
        ...
        function ControlSystem() {
          ...
          //--------这里放关于死亡的系统--------
          _this.add(new DropMagicStoneSystem());
          _this.add(new DropWeaponSystem());
          _this.add(new DropSkillPluginSystem());
          _this.add(new DropMoneySystem());
          _this.add(new DropEquipmentSystem());
          _this.add(new DropMoneySystem());
          ...
          _this.add(new PrecisionMsSystem());
          _this.add(new AssassinMsSystem());
          _this.add(new CloseCombatAtkSystem());
          return _this;
        }
...
System.register("chunks:///_virtual/CreateBombExplosionComp.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './ECS.ts', './SkillRenderComp.ts', './PositionComp.ts', './SkillEntity.ts', './SkillPluginConfig.ts', './FactionTypeComp.ts', './MasterComp.ts', './SkillModelComp.ts', './export.type.ts'], function (exports) {
  var _inheritsLoose, cclegacy, _decorator, Vec3, js, ecs, SkillRenderComp, PositionComp, SkillEntity, DB_SkillPluginConfig, FactionTypeComp, MasterComp, SkillModelComp, SkillAttributeType, EntityType;
  return {
    setters: [function (module) {
      _inheritsLoose = module.inheritsLoose;
    }, function (module) {
...
System.register("chunks:///_virtual/CreateRoleComp.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './ECS.ts', './RoleEntity.ts', './app.ts', './DeathComp.ts', './EnabledComp.ts', './FactionTypeComp.ts', './AfterDeathMarkerComp.ts', './PositionComp.ts', './RoleModelComp.ts', './RoleShowAnimation1Comp.ts', './MapModelComp.ts', './export.type.ts'], function (exports) {
  var _inheritsLoose, _createForOfIteratorHelperLoose, cclegacy, _decorator, ecs, RoleEntity, app, DeathComp, EnabledComp, FactionTypeComp, AfterDeathMarkerComp, PositionComp, RoleModelComp, RoleShowAnimation1Comp, MapModelComp, EntityType;
  return {
    setters: [function (module) {
      _inheritsLoose = module.inheritsLoose;
      _createForOfIteratorHelperLoose = module.createForOfIteratorHelperLoose;
...
System.register("chunks:///_virtual/CreateTaskComp.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './CompConfig.ts', './TaskConfig.ts', './ECS.ts', './EnabledComp.ts', './ShowTaskComp.ts', './TaskModelComp.ts', './TaskEntity.ts', './app.ts', './BattleController.ts'], function (exports) {
  var _inheritsLoose, cclegacy, js, DB_CompConfig, DB_TaskConfig, ecs, EnabledComp, ShowTaskComp, TaskModelComp, TaskEntity, app, BattleController;
  return {
    setters: [function (module) {
      _inheritsLoose = module.inheritsLoose;
    }, function (module) {
        ...
        _proto2.entityEnter = function entityEnter(e) {
          ...
          if (taskConfig && taskConfig.comps) {
            ...
            for (var i = 0; i < taskConfig.comps.length; i++) {
              ...
              var comp = js.getClassByName(DB_CompConfig[compId].className);
              taskEntity.add(comp);
            }
            taskEntity.add(ShowTaskComp);
          } else {
            BattleController.inst.hideTask();
          }
...
System.register("chunks:///_virtual/DeathBombExplosionComp.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './ECS.ts', './SkillRenderComp.ts', './PositionComp.ts', './BerforeDeathMarkerComp.ts', './SkillModelComp.ts', './CreateBombExplosionComp.ts', './export.type.ts'], function (exports) {
  var _inheritsLoose, cclegacy, _decorator, ecs, SkillRenderComp, PositionComp, BerforeDeathMarkerComp, SkillModelComp, CreateBombExplosionComp, SkillAttributeType;
  return {
    setters: [function (module) {
      _inheritsLoose = module.inheritsLoose;
    }, function (module) {
...
System.register("chunks:///_virtual/Drop.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './cc-comp-frame-animation.ts', './ECS.ts', './IconPrefab.ts', './DropModelComp.ts', './BaseUnit.ts', './FrameAnimation.ts'], function (exports) {
  var _applyDecoratedDescriptor, _inheritsLoose, _initializerDefineProperty, _assertThisInitialized, cclegacy, _decorator, Node, ecs, IconPrefab, DropModelComp, BaaseUnit, FrameAnimation;
  return {
    setters: [function (module) {
      _applyDecoratedDescriptor = module.applyDecoratedDescriptor;
      _inheritsLoose = module.inheritsLoose;
...
System.register("chunks:///_virtual/DropEquipmentComp.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './DropModelComp.ts', './DropEntity.ts', './IsPlayerComp.ts', './BerforeDeathMarkerComp.ts', './PositionComp.ts', './BattleUtil.ts', './app.ts', './ECS.ts', './export.type.ts', './EquipConfig.ts'], function (exports) {
  var _inheritsLoose, cclegacy, _decorator, DropModelComp, DropEntity, IsPlayerComp, BerforeDeathMarkerComp, PositionComp, BattleUtil, app, ecs, ItemType, DB_EquipConfig;
  return {
    setters: [function (module) {
      _inheritsLoose = module.inheritsLoose;
    }, function (module) {
    ...
    execute: function () {
      var _dec, _dec2, _class;
      cclegacy._RF.push({}, "04bb6229ndHlKfgqjzxx74s", "DropEquipmentComp", undefined);
      var ccclass = _decorator.ccclass,
        property = _decorator.property;
       ...
       * 掉落装备组件
       */
      var DropEquipmentComp = exports('DropEquipmentComp', (_dec = ccclass('DropEquipmentComp'), _dec2 = ecs.register('DropEquipmentComp'), _dec(_class = _dec2(_class = /*#__PURE__*/function (_ecs$Comp) {
        _inheritsLoose(DropEquipmentComp, _ecs$Comp);
        function DropEquipmentComp() {
          return _ecs$Comp.apply(this, arguments) || this;
        }
        var _proto = DropEquipmentComp.prototype;
        _proto.reset = function reset() {};
        return DropEquipmentComp;
      }(ecs.Comp)) || _class) || _class));

      /**掉落装备组件 */
      var DropEquipmentSystem = exports('DropEquipmentSystem', /*#__PURE__*/function (_ecs$ComblockSystem) {
        _inheritsLoose(DropEquipmentSystem, _ecs$ComblockSystem);
        var _proto2 = DropEquipmentSystem.prototype;
        _proto2.filter = function filter() {
          return ecs.allOf(DropEquipmentComp, BerforeDeathMarkerComp).excludeOf(IsPlayerComp);
        };
        function DropEquipmentSystem() {
          return _ecs$ComblockSystem.call(this) || this;
        }
        _proto2.entityEnter = function entityEnter(e) {
          //掉落装备
          if (Math.random() < app.config.game.EquipmentDropRate) {
            //TODO:后面优化
            var equipConfig = DB_EquipConfig;
            var dropEquip = [];
            for (var key in equipConfig) {
              var equipment = equipConfig[key];
              if (equipment.unlockLv <= app.store.player.lv) {
                //掉落
                dropEquip.push({
                  id: equipment.id,
                  probability: equipment.dropWeight
                });
              }
            }
            if (dropEquip.length > 0) {
              var _equipment = BattleUtil.randomSelectWithProbability(dropEquip);
              if (_equipment) {
                //掉落
                console.log('掉落装备', _equipment);
                var dropEntity = ecs.getEntity(DropEntity);
                var equipmentData = BattleUtil.createEquipment(_equipment.id);
                ...
                dropEntity.get(PositionComp).setPosition(pos);
              }
            }
          }
          e.remove(DropEquipmentComp);
        };
        _proto2.exit = function exit(e) {};
        return DropEquipmentSystem;
      }(ecs.ComblockSystem));
      cclegacy._RF.pop();
    }
  };
...
System.register("chunks:///_virtual/DropMagicStoneComp.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './DropModelComp.ts', './DropEntity.ts', './IsPlayerComp.ts', './BerforeDeathMarkerComp.ts', './PositionComp.ts', './BattleUtil.ts', './app.ts', './ECS.ts', './export.type.ts', './MagicStoneConfig.ts'], function (exports) {
  var _inheritsLoose, cclegacy, _decorator, DropModelComp, DropEntity, IsPlayerComp, BerforeDeathMarkerComp, PositionComp, BattleUtil, app, ecs, ItemType, DB_MagicStoneConfig;
  return {
    setters: [function (module) {
      _inheritsLoose = module.inheritsLoose;
    }, function (module) {
    ...
    execute: function () {
      var _dec, _dec2, _class;
      cclegacy._RF.push({}, "ed7c0NemoJPHY8oPMiBFF8/", "DropMagicStoneComp", undefined);
      var ccclass = _decorator.ccclass,
        property = _decorator.property;
       ...
       * 掉落魔法石组件
       */
      var DropMagicStoneComp = exports('DropMagicStoneComp', (_dec = ccclass('DropMagicStoneComp'), _dec2 = ecs.register('DropMagicStoneComp'), _dec(_class = _dec2(_class = /*#__PURE__*/function (_ecs$Comp) {
        _inheritsLoose(DropMagicStoneComp, _ecs$Comp);
        function DropMagicStoneComp() {
          return _ecs$Comp.apply(this, arguments) || this;
        }
        var _proto = DropMagicStoneComp.prototype;
        _proto.reset = function reset() {};
        return DropMagicStoneComp;
      }(ecs.Comp)) || _class) || _class));

      /**掉落魔法石组件 */
      var DropMagicStoneSystem = exports('DropMagicStoneSystem', /*#__PURE__*/function (_ecs$ComblockSystem) {
        _inheritsLoose(DropMagicStoneSystem, _ecs$ComblockSystem);
        var _proto2 = DropMagicStoneSystem.prototype;
        _proto2.filter = function filter() {
          return ecs.allOf(DropMagicStoneComp, BerforeDeathMarkerComp).excludeOf(IsPlayerComp);
        };
        function DropMagicStoneSystem() {
          return _ecs$ComblockSystem.call(this) || this;
        }
        _proto2.entityEnter = function entityEnter(e) {
          //掉落魔法石
          if (Math.random() < app.config.game.MagicStoneDropRate) {
            //TODO:后面优化
            var magicStone = DB_MagicStoneConfig;
            var dropMagicStone = [];
            for (var key in magicStone) {
              var stone = magicStone[key];
              if (stone.unlockLv <= app.store.player.lv) {
                //掉落
                dropMagicStone.push({
                  id: stone.id,
                  probability: stone.dropWeight
                });
              }
            }
            if (dropMagicStone.length > 0) {
              var _stone = BattleUtil.randomSelectWithProbability(dropMagicStone);
              if (_stone) {
                //掉落
                console.log('掉落魔法石', _stone);
                var dropEntity = ecs.getEntity(DropEntity);
                dropEntity.get(DropModelComp).init({
                  id: _stone.id,
          ...
          e.remove(DropMagicStoneComp);
        };
        _proto2.exit = function exit(e) {};
        return DropMagicStoneSystem;
      }(ecs.ComblockSystem));
      cclegacy._RF.pop();
    }
  };
...
System.register("chunks:///_virtual/DropMoneyComp.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './DropModelComp.ts', './DropEntity.ts', './IsPlayerComp.ts', './BerforeDeathMarkerComp.ts', './PositionComp.ts', './app.ts', './ECS.ts', './export.type.ts', './BattleUtil.ts'], function (exports) {
  var _inheritsLoose, cclegacy, _decorator, DropModelComp, DropEntity, IsPlayerComp, BerforeDeathMarkerComp, PositionComp, app, ecs, ItemType, BattleUtil;
  return {
    setters: [function (module) {
      _inheritsLoose = module.inheritsLoose;
    }, function (module) {
    ...
    execute: function () {
      var _dec, _dec2, _class;
      cclegacy._RF.push({}, "aba9eYMGdZGJIkrUtBcRAQS", "DropMoneyComp", undefined);
      var ccclass = _decorator.ccclass,
        property = _decorator.property;
       ...
       * 掉落金钱组件
       */
      var DropMoneyComp = exports('DropMoneyComp', (_dec = ccclass('DropMoneyComp'), _dec2 = ecs.register('DropMoneyComp'), _dec(_class = _dec2(_class = /*#__PURE__*/function (_ecs$Comp) {
        _inheritsLoose(DropMoneyComp, _ecs$Comp);
        function DropMoneyComp() {
          return _ecs$Comp.apply(this, arguments) || this;
        }
        var _proto = DropMoneyComp.prototype;
        _proto.reset = function reset() {};
        return DropMoneyComp;
      }(ecs.Comp)) || _class) || _class));

      /**掉落金钱组件 */
      var DropMoneySystem = exports('DropMoneySystem', /*#__PURE__*/function (_ecs$ComblockSystem) {
        _inheritsLoose(DropMoneySystem, _ecs$ComblockSystem);
        var _proto2 = DropMoneySystem.prototype;
        _proto2.filter = function filter() {
          return ecs.allOf(DropMoneyComp, BerforeDeathMarkerComp).excludeOf(IsPlayerComp);
        };
        function DropMoneySystem() {
          return _ecs$ComblockSystem.call(this) || this;
        }
        _proto2.entityEnter = function entityEnter(e) {
          //掉落金钱
          if (Math.random() < app.config.game.MoneyDropRate) {
            //掉落
            console.log('掉落金钱');
            var num = BattleUtil.randomBetweenTwoValues(app.config.game.MoneyDropRange[0], app.config.game.MoneyDropRange[1]);
            var dropEntity = ecs.getEntity(DropEntity);
            dropEntity.get(DropModelComp).init({
              id: 100101,
              num: num,
          ...
          e.remove(DropMoneyComp);
        };
        _proto2.exit = function exit(e) {};
        return DropMoneySystem;
      }(ecs.ComblockSystem));
      cclegacy._RF.pop();
    }
  };
...
System.register("chunks:///_virtual/DropPlayerExpComp.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './RoleConfig.ts', './ECS.ts', './IsPlayerComp.ts', './BerforeDeathMarkerComp.ts', './RoleModelComp.ts', './UpgradeComp.ts', './app.ts', './export.type.ts'], function (exports) {
  var _inheritsLoose, cclegacy, _decorator, DB_RoleConfig, ecs, IsPlayerComp, BerforeDeathMarkerComp, RoleModelComp, UpgradeComp, app, RoleType;
  return {
    setters: [function (module) {
      _inheritsLoose = module.inheritsLoose;
    }, function (module) {
...
System.register("chunks:///_virtual/DropSkillPluginComp.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './DropModelComp.ts', './DropEntity.ts', './IsPlayerComp.ts', './BerforeDeathMarkerComp.ts', './PositionComp.ts', './RoleModelComp.ts', './BattleUtil.ts', './app.ts', './RoleConfig.ts', './SkillPluginConfig.ts', './ECS.ts', './export.type.ts'], function (exports) {
  ...
  return {
    ...
    execute: function () {
      var _dec, _dec2, _class;
      cclegacy._RF.push({}, "0273eIbtOdBeJiOYW5P3Y9y", "DropSkillPluginComp", undefined);
      var ccclass = _decorator.ccclass,
        property = _decorator.property;
       ...
       * 掉落技能插件组件
       */
      var DropSkillPluginComp = exports('DropSkillPluginComp', (_dec = ccclass('DropSkillPluginComp'), _dec2 = ecs.register('DropSkillPluginComp'), _dec(_class = _dec2(_class = /*#__PURE__*/function (_ecs$Comp) {
        _inheritsLoose(DropSkillPluginComp, _ecs$Comp);
        function DropSkillPluginComp() {
          return _ecs$Comp.apply(this, arguments) || this;
        }
        var _proto = DropSkillPluginComp.prototype;
        _proto.reset = function reset() {};
        return DropSkillPluginComp;
      }(ecs.Comp)) || _class) || _class));

      /**掉落技能插件组件系统 */
      var DropSkillPluginSystem = exports('DropSkillPluginSystem', /*#__PURE__*/function (_ecs$ComblockSystem) {
        _inheritsLoose(DropSkillPluginSystem, _ecs$ComblockSystem);
        var _proto2 = DropSkillPluginSystem.prototype;
        _proto2.filter = function filter() {
          return ecs.allOf(DropSkillPluginComp, BerforeDeathMarkerComp).excludeOf(IsPlayerComp);
        };
        function DropSkillPluginSystem() {
          return _ecs$ComblockSystem.call(this) || this;
        }
        _proto2.entityEnter = function entityEnter(e) {
          var roleId = e.get(RoleModelComp).roleId;
          ...
          var dropSkillRate = 0;
          if (config.type == RoleType.normal) {
            dropSkillRate = app.config.game.NormalMonsterSkillPluginDropRate;
          } else if (config.type == RoleType.elite) {
            dropSkillRate = app.config.game.EliteMonsterSkillPluginDropRate;
          } else if (config.type == RoleType.boss) {
            dropSkillRate = app.config.game.BossMonsterSkillPluginDropRate;
          }
          //掉落技能插件
          if (Math.random() < dropSkillRate) {
            //TODO:后面优化
...
System.register("chunks:///_virtual/DropTaskExpComp.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './RoleConfig.ts', './ECS.ts', './IsPlayerComp.ts', './BerforeDeathMarkerComp.ts', './RoleModelComp.ts', './TaskModelComp.ts', './app.ts', './export.type.ts'], function (exports) {
  var _inheritsLoose, cclegacy, _decorator, DB_RoleConfig, ecs, IsPlayerComp, BerforeDeathMarkerComp, RoleModelComp, TaskModelComp, app, RoleType;
  return {
    setters: [function (module) {
      _inheritsLoose = module.inheritsLoose;
    }, function (module) {
...
System.register("chunks:///_virtual/DropViewComp.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './CollectDropComp.ts', './app.ts', './ECS.ts', './BaseUnit.ts', './EnabledComp.ts', './PositionComp.ts', './UnitComp.ts', './Drop.ts', './export.type.ts'], function (exports) {
  var _inheritsLoose, cclegacy, Prefab, instantiate, CollectDropComp, app, ecs, BaaseUnit, EnabledComp, PositionComp, UnitComp, Drop, MapLayersType;
  return {
    setters: [function (module) {
      _inheritsLoose = module.inheritsLoose;
    }, function (module) {
...
System.register("chunks:///_virtual/DropViewLoadComp.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './export.type.ts', './ECS.ts'], function (exports) {
  var _inheritsLoose, cclegacy, MapLayersType, ecs;
  return {
    setters: [function (module) {
      _inheritsLoose = module.inheritsLoose;
    }, function (module) {
...
System.register("chunks:///_virtual/DropWeaponComp.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './DropModelComp.ts', './DropEntity.ts', './IsPlayerComp.ts', './BerforeDeathMarkerComp.ts', './PositionComp.ts', './BattleUtil.ts', './app.ts', './ECS.ts', './export.type.ts', './WeaponConfig.ts'], function (exports) {
  var _inheritsLoose, cclegacy, _decorator, DropModelComp, DropEntity, IsPlayerComp, BerforeDeathMarkerComp, PositionComp, BattleUtil, app, ecs, ItemType, DB_WeaponConfig;
  return {
    setters: [function (module) {
      _inheritsLoose = module.inheritsLoose;
    }, function (module) {
    ...
    execute: function () {
      var _dec, _dec2, _class;
      cclegacy._RF.push({}, "5f46axNoL5Jma7Yjj8Y3ip2", "DropWeaponComp", undefined);
      var ccclass = _decorator.ccclass,
        property = _decorator.property;
       ...
       * 掉落武器组件
       */
      var DropWeaponComp = exports('DropWeaponComp', (_dec = ccclass('DropWeaponComp'), _dec2 = ecs.register('DropWeaponComp'), _dec(_class = _dec2(_class = /*#__PURE__*/function (_ecs$Comp) {
        _inheritsLoose(DropWeaponComp, _ecs$Comp);
        function DropWeaponComp() {
          return _ecs$Comp.apply(this, arguments) || this;
        }
        var _proto = DropWeaponComp.prototype;
        _proto.reset = function reset() {};
        return DropWeaponComp;
      }(ecs.Comp)) || _class) || _class));

      /**掉落武器组件系统 */
      var DropWeaponSystem = exports('DropWeaponSystem', /*#__PURE__*/function (_ecs$ComblockSystem) {
        _inheritsLoose(DropWeaponSystem, _ecs$ComblockSystem);
        var _proto2 = DropWeaponSystem.prototype;
        _proto2.filter = function filter() {
          return ecs.allOf(DropWeaponComp, BerforeDeathMarkerComp).excludeOf(IsPlayerComp);
        };
        function DropWeaponSystem() {
          return _ecs$ComblockSystem.call(this) || this;
        }
        _proto2.entityEnter = function entityEnter(e) {
          //掉落装备
          if (Math.random() < app.config.game.WeaponDropRate) {
            //TODO:后面优化
            var weaponConfig = DB_WeaponConfig;
            var dropWeapon = [];
            for (var key in weaponConfig) {
              var weapon = weaponConfig[key];
              if (weapon.unlockLv <= app.store.player.lv) {
                //掉落
                dropWeapon.push({
                  id: weapon.id,
                  probability: weapon.dropWeight
                });
              }
            }
            if (dropWeapon.length > 0) {
              var _weapon = BattleUtil.randomSelectWithProbability(dropWeapon);
              if (_weapon) {
                //掉落
                console.log('掉落武器', _weapon);
                var dropEntity = ecs.getEntity(DropEntity);
                var weaponData = BattleUtil.createWeapon(_weapon.id);
                dropEntity.get(DropModelComp).init({
                  id: _weapon.id,
          ...
          e.remove(DropWeaponComp);
        };
        _proto2.exit = function exit(e) {};
        return DropWeaponSystem;
      }(ecs.ComblockSystem));
      cclegacy._RF.pop();
    }
  };
...
System.register("chunks:///_virtual/Enemy1FsmComp.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './ECS.ts', './PursueComp.ts', './PursuePlayerMoveComp.ts', './SkeletonViewComp.ts', './StateMachineComp.ts', './export.type.ts', './CloseCombatAtkComp.ts'], function (exports) {
  var _inheritsLoose, cclegacy, _decorator, ecs, PursueComp, PursuePlayerMoveComp, SkeletonViewComp, StateMachineComp, RoleStateMachineType, RoleAnimType, CloseCombatAtkComp;
  return {
    setters: [function (module) {
      _inheritsLoose = module.inheritsLoose;
    }, function (module) {
      ...
      CloseCombatAtkComp = module.CloseCombatAtkComp;
    }],
    execute: function () {
      var _dec, _dec2, _class;
        ...
        _proto2.entityEnter = function entityEnter(e) {
          ...
          var atk = {
            enter: function enter() {
              ...
              e.get(CloseCombatAtkComp).pursueEntity = stateMachineComp.nextData;
            },
            update: function update(dt) {},
            exit: function exit() {
              // console.log('atk exit');
              e.get(CloseCombatAtkComp).pursueEntity = null;
              // e.remove(RoleAutoCastComp);
              // e.remove(CloseCombatAtkComp);
            }
          };
...
System.register("chunks:///_virtual/FactionTypeComp.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './ECS.ts', './export.type.ts'], function (exports) {
...
System.register("chunks:///_virtual/FireballComp.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './ECS.ts', './SkillRenderComp.ts', './PositionComp.ts', './app.ts', './BaseUnit.ts', './EnabledComp.ts', './UnitComp.ts', './export.type.ts'], function (exports) {
  var _inheritsLoose, cclegacy, _decorator, Prefab, instantiate, ecs, SkillRenderComp, PositionComp, app, BaaseUnit, EnabledComp, UnitComp, MapLayersType;
  return {
    setters: [function (module) {
      _inheritsLoose = module.inheritsLoose;
    }, function (module) {
...
System.register("chunks:///_virtual/GenerateOneRoleComp.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './ECS.ts', './BattleUtil.ts', './MapModelComp.ts', './MonsterFactoryConfig.ts', './CreateRoleComp.ts', './TaskRoleComp.ts', './TaskConfig.ts', './TaskModelComp.ts', './app.ts', './PositionComp.ts', './export.type.ts'], function (exports) {
  var _inheritsLoose, cclegacy, _decorator, v3, ecs, BattleUtil, MapModelComp, DB_MonsterFactoryConfig, CreateRoleComp, TaskRoleComp, DB_TaskConfig, TaskModelComp, app, PositionComp, FactionType;
  return {
    setters: [function (module) {
      _inheritsLoose = module.inheritsLoose;
    }, function (module) {
...
System.register("chunks:///_virtual/HpComp.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './export.type.ts', './ECS.ts', './DamageFlyTextComp.ts', './FactionTypeComp.ts', './AfterDeathMarkerComp.ts', './BerforeDeathMarkerComp.ts', './SkeletonViewComp.ts'], function (exports) {
  var _inheritsLoose, cclegacy, EntityType, RoleAnimType, ecs, DamageFlyTextComp, FactionTypeComp, AfterDeathMarkerComp, BerforeDeathMarkerComp, SkeletonViewComp;
  return {
    setters: [function (module) {
      _inheritsLoose = module.inheritsLoose;
    }, function (module) {
...
System.register("chunks:///_virtual/IconPrefab.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './app.ts', './IconConfig.ts', './BattleUtil.ts'], function (exports) {
  var _applyDecoratedDescriptor, _inheritsLoose, _initializerDefineProperty, _assertThisInitialized, cclegacy, _decorator, Node, Label, Button, SpriteFrame, Sprite, Component, app, DB_IconConfig, BattleUtil;
  return {
    setters: [function (module) {
      _applyDecoratedDescriptor = module.applyDecoratedDescriptor;
      _inheritsLoose = module.inheritsLoose;
    ...
    execute: function () {
      ...
      cclegacy._RF.push({}, "afa2atdLBBFSZpc3fOZGU30", "IconPrefab", undefined);
      var ccclass = _decorator.ccclass,
        property = _decorator.property;
      var IconPrefab = exports('IconPrefab', (_dec = ccclass('IconPrefab'), _dec2 = property(Node), _dec3 = property(Node), _dec4 = property(Label), _dec5 = property(Node), _dec(_class = (_class2 = /*#__PURE__*/function (_Component) {
        _inheritsLoose(IconPrefab, _Component);
        function IconPrefab() {
          var _this;
          for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
            args[_key] = arguments[_key];
        ...
        var _proto = IconPrefab.prototype;
        _proto.onLoad = function onLoad() {
          var _this2 = this;
...
System.register("chunks:///_virtual/InfiniteMapCom.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './ECS.ts', './app.ts', './PositionComp.ts', './MapModelComp.ts', './export.type.ts'], function (exports) {
  var _inheritsLoose, cclegacy, _decorator, view, Node, Sprite, UITransform, SpriteFrame, Size, ecs, app, PositionComp, MapModelComp, MapLayersType;
  return {
    setters: [function (module) {
      _inheritsLoose = module.inheritsLoose;
    }, function (module) {
    ...
    execute: function () {
      ...
      var InfiniteMapSystem = exports('InfiniteMapSystem', /*#__PURE__*/function (_ref) {
        ...
        _proto2.entityEnter = function entityEnter(e) {
          ...
          app.manager.battle.mapEntity.get(MapModelComp).width = app.config.game.InfiniteMapSize;
          app.manager.battle.mapEntity.get(MapModelComp).height = app.config.game.InfiniteMapSize;
        };
        _proto2.update = function update(e) {
          var _this2 = this;
          var comp = e.get(InfiniteMapCom);
...
System.register("chunks:///_virtual/MapLoadComp.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './MapConfig.ts', './ECS.ts', './RoleEntity.ts', './RoleModelComp.ts', './FactionTypeComp.ts', './PositionComp.ts', './PlayerShowComp.ts', './MapCompEntity.ts', './CompConfig.ts', './MapModelComp.ts', './CreateTaskComp.ts', './app.ts', './export.type.ts'], function (exports) {
  var _inheritsLoose, cclegacy, UITransform, Widget, v3, js, DB_MapConfig, ecs, RoleEntity, RoleModelComp, FactionTypeComp, PositionComp, PlayerShowComp, MapCompEntity, DB_CompConfig, MapModelComp, CreateTaskComp, app, FactionType, EntityType;
  return {
    setters: [function (module) {
      _inheritsLoose = module.inheritsLoose;
    }, function (module) {
...
System.register("chunks:///_virtual/MpComp.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './export.type.ts', './ECS.ts', './WeaponModelComp.ts', './WeaponDepotComp.ts'], function (exports) {
  var _inheritsLoose, cclegacy, WeaponAttributeType, ecs, WeaponModelComp, WeaponDepotComp;
  return {
    setters: [function (module) {
      _inheritsLoose = module.inheritsLoose;
    }, function (module) {
...
System.register("chunks:///_virtual/NormalAtkComp.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './ECS.ts', './AtkDetectorComp.ts', './EnabledComp.ts', './HpComp.ts', './PositionComp.ts', './StateMachineComp.ts', './MasterComp.ts', './SkeletonViewComp.ts', './RestrictMoveComp.ts', './BattleUtil.ts', './RoleAtkMarkerComp.ts', './export.type.ts'], function (exports) {
  var _inheritsLoose, _createClass, cclegacy, _decorator, ecs, AtkDetectorComp, EnabledComp, HpComp, PositionComp, StateMachineComp, MasterComp, SkeletonViewComp, RestrictMoveComp, BattleUtil, RoleAtkMarkerComp, RoleAnimType, RoleStateMachineType;
  return {
    setters: [function (module) {
      _inheritsLoose = module.inheritsLoose;
      _createClass = module.createClass;
...
System.register("chunks:///_virtual/PrecisionMsComp.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './ECS.ts', './RoleModelComp.ts', './export.type.ts'], function (exports) {
  var _inheritsLoose, cclegacy, _decorator, ecs, RoleModelComp, AttributeType, CorrectionSourceType, CorrectionType;
  return {
    setters: [function (module) {
      _inheritsLoose = module.inheritsLoose;
...
System.register("chunks:///_virtual/PursueComp.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './export.type.ts', './ECS.ts', './AtkDetectorComp.ts', './DirectionComp.ts', './EnabledComp.ts', './PositionComp.ts', './StateMachineComp.ts'], function (exports) {
  var _inheritsLoose, cclegacy, RoleStateMachineType, ecs, AtkDetectorComp, DirectionComp, EnabledComp, PositionComp, StateMachineComp;
  return {
    setters: [function (module) {
      _inheritsLoose = module.inheritsLoose;
    }, function (module) {
...
System.register("chunks:///_virtual/RandomlyGenerateMonsterComp.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './ECS.ts', './BattleUtil.ts', './MapModelComp.ts', './MonsterFactoryConfig.ts', './CreateRoleComp.ts', './TaskConfig.ts', './TaskModelComp.ts', './app.ts', './PositionComp.ts', './export.type.ts'], function (exports) {
  var _inheritsLoose, cclegacy, _decorator, v3, ecs, BattleUtil, MapModelComp, DB_MonsterFactoryConfig, CreateRoleComp, DB_TaskConfig, TaskModelComp, app, PositionComp, FactionType;
  return {
    setters: [function (module) {
      _inheritsLoose = module.inheritsLoose;
    }, function (module) {
...
System.register("chunks:///_virtual/RoleAfterDeathComp.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './AfterDeathMarkerComp.ts', './ECS.ts', './SkeletonViewComp.ts', './StateMachineComp.ts', './export.type.ts'], function (exports) {
  var _inheritsLoose, cclegacy, AfterDeathMarkerComp, ecs, SkeletonViewComp, StateMachineComp, RoleAnimType, RoleStateMachineType;
  return {
    setters: [function (module) {
      _inheritsLoose = module.inheritsLoose;
    }, function (module) {
...
System.register("chunks:///_virtual/RoleAtkMarkerComp.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './ECS.ts', './StateMachineComp.ts', './export.type.ts'], function (exports) {
...
System.register("chunks:///_virtual/RoleEntity.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './ECS.ts', './BaseEntity.ts', './CollisionComp.ts', './DamageFlyTextComp.ts', './DirectionComp.ts', './EnabledComp.ts', './FactionTypeComp.ts', './HpComp.ts', './MoveComp.ts', './UnitComp.ts', './PositionComp.ts', './RoleModelComp.ts', './RoleViewLoadComp.ts', './SpeedComp.ts', './StateMachineComp.ts', './WeaponDepotComp.ts', './RoleAfterDeathComp.ts', './MpComp.ts', './IsRoleComp.ts', './RoleMapExtraCompComp.ts', './RoleTaskExtraCompComp.ts', './app.ts'], function (exports) {
  var _inheritsLoose, cclegacy, ecs, BaseEntity, CollisionComp, DamageFlyTextComp, DirectionComp, EnabledComp, FactionTypeComp, HpComp, MoveComp, UnitComp, PositionComp, RoleModelComp, RoleViewLoadComp, SpeedComp, StateMachineComp, WeaponDepotComp, RoleAfterDeathComp, MpComp, IsRoleComp, RoleMapExtraCompComp, RoleTaskExtraCompComp, app;
  return {
    setters: [function (module) {
      _inheritsLoose = module.inheritsLoose;
    }, function (module) {
    ...
    execute: function () {
      ...
      var RoleEntity = exports('RoleEntity', (_dec = ecs.register('RoleEntity'), _dec(_class = /*#__PURE__*/function (_BaseEntity) {
        ...
        _proto.destroy = function destroy() {
          //先清除地图里的map
          var roleArr = app.manager.battle.roleMap.get(this.get(FactionTypeComp).faction);
          if (roleArr) {
          ...
          _BaseEntity.prototype.destroy.call(this);
        };
        return RoleEntity;
      }(BaseEntity)) || _class));
      cclegacy._RF.pop();
...
System.register("chunks:///_virtual/RoleModelComp.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './CompConfig.ts', './RoleConfig.ts', './ECS.ts', './RoleNumericMap.ts', './HpComp.ts', './TriggerNPCInteractionMenuComp.ts', './BattleUtil.ts', './export.type.ts'], function (exports) {
  var _inheritsLoose, cclegacy, js, DB_CompConfig, DB_RoleConfig, ecs, RoleNumericMap, HpComp, TriggerNPCInteractionMenuComp, BattleUtil, AttributeType;
  return {
    setters: [function (module) {
      _inheritsLoose = module.inheritsLoose;
    }, function (module) {
        ...
        _proto.init = function init(data) {
          ...
          if (config.comp) {
            for (var i = 0; i < config.comp.length; i++) {
              ...
              var comp = js.getClassByName(compConfig.className);
              this.ent.add(comp);
            }
          }
        }
...
System.register("chunks:///_virtual/RoleNumeric.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './export.type.ts'], function (exports) {
...
System.register("chunks:///_virtual/RoleNumericMap.ts", ['cc', './export.type.ts', './app.ts', './RoleNumeric.ts'], function (exports) {
  var cclegacy, AttributeType, app, RoleNumeric;
  return {
    setters: [function (module) {
      cclegacy = module.cclegacy;
    }, function (module) {
    ...
    execute: function () {
      ...
      var RoleNumericMap = exports('RoleNumericMap', /*#__PURE__*/function () {
        ...
        /**获取角色atk，会暴击 */;
        _proto.getAtk = function getAtk() {
          var atk = this.attributes.get(AttributeType.atk).value;
          var crit = this.attributes.get(AttributeType.crit).value;
          var critDamage = this.attributes.get(AttributeType.critDamage).value;
          //是否暴击
          var isCrit = Math.random() < crit;
          return {
            value: isCrit ? Math.floor((app.config.game.CritDamageRate + critDamage) * atk) : atk,
            isCrit: isCrit
          };
        };
        _proto.addCorrection = function addCorrection(type, data) {
...
System.register("chunks:///_virtual/RoleStateComp.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './export.type.ts', './ECS.ts'], function (exports) {
  var _inheritsLoose, cclegacy, RoleStateType, ecs;
  return {
    setters: [function (module) {
      _inheritsLoose = module.inheritsLoose;
    }, function (module) {
...
System.register("chunks:///_virtual/RoleViewComp.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './ECS.ts', './FactionTypeComp.ts', './SkeletonViewComp.ts', './AtkDetectorComp.ts', './RoleModelComp.ts', './RoleConfig.ts', './CollisionComp.ts', './IsDropComp.ts', './BaseUnit.ts', './export.type.ts', './SpeedObstacleAvoidanceComp.ts', './UnitComp.ts'], function (exports) {
  var _applyDecoratedDescriptor, _inheritsLoose, _initializerDefineProperty, _assertThisInitialized, cclegacy, _decorator, v3, PhysicsSystem, ecs, FactionTypeComp, SkeletonViewComp, AtkDetectorComp, RoleModelComp, DB_RoleConfig, CollisionComp, IsDropComp, BaaseUnit, RoleAnimType, SpeedObstacleAvoidanceComp, UnitComp;
  return {
    setters: [function (module) {
      _applyDecoratedDescriptor = module.applyDecoratedDescriptor;
      _inheritsLoose = module.inheritsLoose;
    ...
    execute: function () {
      ...
      var RoleViewComp = exports('RoleViewComp', (_dec = ccclass('RoleViewComp'), _dec2 = ecs.register('RoleViewComp', false), _dec3 = property(SkeletonViewComp), _dec4 = property(AtkDetectorComp), _dec(_class = _dec2(_class = (_class2 = /*#__PURE__*/function (_BaaseUnit) {
        ...
        _proto.onLoad = function onLoad() {
          this.ent.add(SpeedObstacleAvoidanceComp);
          this.ent.add(this.detector);
          this.ent.add(this.skeletonComp);
          this.ent.get(SkeletonViewComp).playAnim(RoleAnimType.idle);
          this.ent.get(UnitComp).unit = this;
          this.group = this.ent.get(FactionTypeComp).group;
...
System.register("chunks:///_virtual/RoleViewLoadComp.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './RoleModelComp.ts', './ECS.ts', './app.ts', './EnabledComp.ts', './IsPlayerComp.ts', './PositionComp.ts', './export.type.ts', './RoleViewComp.ts'], function (exports) {
  var _inheritsLoose, cclegacy, Prefab, instantiate, RoleModelComp, ecs, app, EnabledComp, IsPlayerComp, PositionComp, MapLayersType, RoleViewComp;
  return {
    setters: [function (module) {
      _inheritsLoose = module.inheritsLoose;
    }, function (module) {
...
System.register("chunks:///_virtual/SkeletonViewComp.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './RoleConfig.ts', './ECS.ts', './RoleModelComp.ts', './app.ts', './export.type.ts'], function (exports) {
  var _inheritsLoose, cclegacy, _decorator, sp, isValid, Component, DB_RoleConfig, ecs, RoleModelComp, app, RoleAnimType, RoleAnimLoop;
  return {
    setters: [function (module) {
      _inheritsLoose = module.inheritsLoose;
    }, function (module) {
        ...
        _proto.init = function init() {
          ...
          if (skillExtraComp) {
            for (var i = 0; i < skillExtraComp.length; i++) {
              ...
              if (compNme) {
                this.addComponents(js.getClassByName(compNme));
              }
            }
          }
        };
...
System.register("chunks:///_virtual/SkillLifeTimeComp.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './export.type.ts', './ECS.ts', './BerforeDeathMarkerComp.ts', './SkillModelComp.ts'], function (exports) {
  var _inheritsLoose, cclegacy, SkillAttributeType, ecs, BerforeDeathMarkerComp, SkillModelComp;
  return {
    setters: [function (module) {
      _inheritsLoose = module.inheritsLoose;
    }, function (module) {
...
System.register("chunks:///_virtual/SkillManagerComp.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './SkillPluginConfig.ts', './ECS.ts', './export.type.ts'], function (exports) {
...
System.register("chunks:///_virtual/SkillModelComp.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './ECS.ts', './SkillNumericMap.ts', './HpComp.ts', './export.type.ts'], function (exports) {
  var _inheritsLoose, cclegacy, Vec3, ecs, SkillNumericMap, HpComp, SkillAttributeType;
  return {
    setters: [function (module) {
      _inheritsLoose = module.inheritsLoose;
    }, function (module) {
...
System.register("chunks:///_virtual/SkillNumeric.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './export.type.ts'], function (exports) {
  var _createClass, cclegacy, CorrectionType;
  return {
    setters: [function (module) {
      _createClass = module.createClass;
...
System.register("chunks:///_virtual/SkillRenderLoadComp.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './ECS.ts', './app.ts', './BaseUnit.ts', './EnabledComp.ts', './UnitComp.ts', './export.type.ts'], function (exports) {
  var _inheritsLoose, cclegacy, Prefab, instantiate, ecs, app, BaaseUnit, EnabledComp, UnitComp, MapLayersType;
  return {
    setters: [function (module) {
      _inheritsLoose = module.inheritsLoose;
    }, function (module) {
...
System.register("chunks:///_virtual/SpeedComp.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './ECS.ts', './RoleModelComp.ts', './DirectionComp.ts', './SkillModelComp.ts', './export.type.ts'], function (exports) {
  var _inheritsLoose, _createClass, cclegacy, v3, ecs, RoleModelComp, DirectionComp, SkillModelComp, AttributeType, SkillAttributeType;
  return {
    setters: [function (module) {
      _inheritsLoose = module.inheritsLoose;
      _createClass = module.createClass;
    ...
    execute: function () {
      ...
      var SpeedObstacleAvoidanceSystem = exports('SpeedObstacleAvoidanceSystem', /*#__PURE__*/function (_ecs$ComblockSystem) {
        ...
        _proto2.update = function update(e) {
          ...
          if (oAComp.curAvoidTime > oAComp.avoidTime && unit) {
...
System.register("chunks:///_virtual/TaskRoleComp.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './ECS.ts', './TaskModelComp.ts', './RoleModelComp.ts', './HpComp.ts', './app.ts', './export.type.ts'], function (exports) {
  var _inheritsLoose, cclegacy, _decorator, ecs, TaskModelComp, RoleModelComp, HpComp, app, AttributeType;
  return {
    setters: [function (module) {
      _inheritsLoose = module.inheritsLoose;
    }, function (module) {
...
System.register("chunks:///_virtual/WeaponCastComp.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './ECS.ts', './WeaponManagerComp.ts', './SkillEntity.ts', './SkillManagerComp.ts', './WeaponDepotComp.ts', './SkillModelComp.ts', './SkillPluginConfig.ts', './FactionTypeComp.ts', './MasterComp.ts', './PositionComp.ts', './MpComp.ts', './WeaponModelComp.ts', './WeaponDirectionComp.ts', './export.type.ts', './RoleModelComp.ts'], function (exports) {
  var _inheritsLoose, cclegacy, ecs, WeaponManagerComp, SkillEntity, SkillManagerComp, WeaponDepotComp, SkillModelComp, DB_SkillPluginConfig, FactionTypeComp, MasterComp, PositionComp, MpComp, WeaponModelComp, WeaponDirectionComp, WeaponAttributeType, SkillAttributeType, AttributeType, EntityType, RoleModelComp;
  return {
    setters: [function (module) {
      _inheritsLoose = module.inheritsLoose;
    }, function (module) {
            ...
            if (skillPlugin.length > 0) {
              ...
              if (costMp <= e.get(MpComp).mp) {
                ...
                for (var _i2 = 0; _i2 < skillPlugin.length; _i2++) {
                  ...
                  var roleAttributes = e.get(RoleModelComp).attributes;
                  skillEntity.get(SkillModelComp).init({
                    att: (_att = {}, _att[SkillAttributeType.hp] = _config.pierce, _att[SkillAttributeType.atk] = _config.damage + roleAttributes.get(AttributeType.atk).value, _att[SkillAttributeType.speed] = _config.speed, _att[SkillAttributeType.crit] = _config.crit + roleAttributes.get(AttributeType.crit).value, _att[SkillAttributeType.critDamage] = _config.critDamage + roleAttributes.get(AttributeType.critDamage).value, _att[SkillAttributeType.lifeTime] = _config.lifeTime, _att),
...
System.register("chunks:///_virtual/WeaponDepotComp.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './WeaponModelComp.ts', './MasterComp.ts', './WeaponEntity.ts', './FixedEntPositionComp.ts', './ECS.ts'], function (exports) {
  var _inheritsLoose, cclegacy, WeaponModelComp, MasterComp, WeaponEntity, FixedEntPositionComp, ecs;
  return {
    setters: [function (module) {
      _inheritsLoose = module.inheritsLoose;
    }, function (module) {
...
System.register("chunks:///_virtual/WeaponManagerComp.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './SkillPluginConfig.ts', './ECS.ts', './BattleUtil.ts', './WeaponModelComp.ts', './export.type.ts'], function (exports) {
  var _inheritsLoose, cclegacy, js, DB_SkillPluginConfig, ecs, BattleUtil, WeaponModelComp, SkillPluginType, WeaponAttributeType;
  return {
    setters: [function (module) {
      _inheritsLoose = module.inheritsLoose;
    }, function (module) {
...
System.register("chunks:///_virtual/WeaponNumeric.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './export.type.ts'], function (exports) {
  var _createClass, cclegacy, CorrectionType;
  return {
    setters: [function (module) {
      _createClass = module.createClass;
