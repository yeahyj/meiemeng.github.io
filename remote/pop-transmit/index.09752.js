System.register("chunks:///_virtual/MiniDungeonItem.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './cc-comp-list-view.ts', './app.ts', './ListView.ts'], function (exports) {
  var _applyDecoratedDescriptor, _inheritsLoose, _initializerDefineProperty, _assertThisInitialized, cclegacy, _decorator, Node, Label, Button, Component, app, ListView;
  return {
    ...
    execute: function () {
      ...
      var MiniDungeonItem = exports('MiniDungeonItem', (_dec = ccclass('MiniDungeonItem'), _dec2 = property(Node), _dec3 = property(ListView), _dec4 = property(Node), _dec5 = property(Label), _dec(_class = (_class2 = /*#__PURE__*/function (_Component) {
        _inheritsLoose(MiniDungeonItem, _Component);
        function MiniDungeonItem() {
          ...
          _initializerDefineProperty(_this, "tipNode", _descriptor3, _assertThisInitialized(_this));
          _initializerDefineProperty(_this, "tipLab", _descriptor4, _assertThisInitialized(_this));
          //选择的难度
          _this._selectIndex = 0;
          return _this;
        }
        var _proto = MiniDungeonItem.prototype;
        ...
        _proto.onClickShrink = function onClickShrink() {
        ...
        _proto.onClickSelect = function onClickSelect(event, data) {
...
System.register("chunks:///_virtual/PopTransmit.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './BaseView.ts'], function (exports) {
  var _applyDecoratedDescriptor, _inheritsLoose, _initializerDefineProperty, _assertThisInitialized, cclegacy, _decorator, Node, Label, Button, BaseView;
  return {
    setters: [function (module) {
      _applyDecoratedDescriptor = module.applyDecoratedDescriptor;
      _inheritsLoose = module.inheritsLoose;
    ...
    execute: function () {
      ...
      var PopTransmit = exports('PopTransmit', (_dec = ccclass('PopTransmit'), _dec2 = property(Node), _dec3 = property(Node), _dec(_class = (_class2 = /*#__PURE__*/function (_BaseView) {
        _inheritsLoose(PopTransmit, _BaseView);
        function PopTransmit() {
          ...
          _initializerDefineProperty(_this, "detailsNode", _descriptor, _assertThisInitialized(_this));
          _initializerDefineProperty(_this, "typeNode", _descriptor2, _assertThisInitialized(_this));
          //上次点击按钮
          _this.lastClickIndex = 0;
          return _this;
        }
        var _proto = PopTransmit.prototype;
        // 初始化的相关逻辑写在这
        _proto.onLoad = function onLoad() {
          var _this2 = this;
          //TODO: 后面 应该是读取配置表的
        ...
        _proto.updateChallenge = function updateChallenge(index) {
