...
System.register("chunks:///_virtual/store.player.ts", ['cc', './BattleUtil.ts', './app.ts', './export.type.ts', './EquipConfig.ts', './MagicStoneConfig.ts'], function (exports) {
  var cclegacy, js, BattleUtil, app, WeaponAttributeType, ItemType, AttributeType, DB_EquipConfig, DB_MagicStoneConfig;
  return {
    setters: [function (module) {
      cclegacy = module.cclegacy;
      js = module.js;
      ...
      var Player = exports('default', /*#__PURE__*/function () {
        ...
        _proto.init = function init(data) {
          ...
          for (var i = 0; i < 8; i++) {
            ...
            var _data = BattleUtil.createEquipment(equipId[i]);
            var itemData = {
              id: _data.id,
              num: 1,
