...
System.register("chunks:///_virtual/executor.ts", ['cc', './app.ts', './index2.ts', './index.ts', './index3.ts', './SoundManager.ts', './UIManager.ts', './config.game.ts', './store.game.ts', './store.help.ts', './store.player.ts'], function (exports) {
