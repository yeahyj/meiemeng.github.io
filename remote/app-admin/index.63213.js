...
System.register("chunks:///_virtual/executor.ts", ['cc', './app.ts', './index.ts', './index2.ts', './index3.ts', './SoundManager.ts', './UIManager.ts', './config.game.ts', './store.game.ts', './store.player.ts'], function (exports) {
  var cclegacy, app, SoundManager, UIManager, Game, Game$1, Player;
  return {
