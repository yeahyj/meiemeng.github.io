...
System.register("chunks:///_virtual/PopWarehouse.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './BaseView.ts', './ItemPrefab.ts', './app.ts', './BattleUtil.ts', './cc-comp-list-view.ts', './ListView.ts'], function (exports) {
  var _applyDecoratedDescriptor, _inherits, _createSuper, _classCallCheck, _initializerDefineProperty, _assertThisInitialized, _createClass, cclegacy, _decorator, Node, Button, BaseView, ItemPrefab, app, BattleUtil, ListView;
  return {
    ...
    execute: function () {
      ...
      var PopWarehouse = exports('PopWarehouse', (_dec = ccclass('PopWarehouse'), _dec2 = property(ListView), _dec3 = property(ListView), _dec4 = property(Node), _dec(_class = (_class2 = /*#__PURE__*/function (_BaseView) {
        _inherits(PopWarehouse, _BaseView);
        var _super = _createSuper(PopWarehouse);
        function PopWarehouse() {
          var _this;
          _classCallCheck(this, PopWarehouse);
          for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
            args[_key] = arguments[_key];
          }
          _this = _super.call.apply(_super, [this].concat(args));
          _initializerDefineProperty(_assertThisInitialized(_this), "warehouseListView", _descriptor, _assertThisInitialized(_this));
          _initializerDefineProperty(_assertThisInitialized(_this), "bagListView", _descriptor2, _assertThisInitialized(_this));
          _initializerDefineProperty(_assertThisInitialized(_this), "closeNode", _descriptor3, _assertThisInitialized(_this));
          return _this;
        }
        _createClass(PopWarehouse, [{
          key: "onLoad",
          value:
          // 初始化的相关逻辑写在这
          function onLoad() {
          ...
          key: "onBagRenderEvent",
          value: function onBagRenderEvent(item, index) {
            var _this2 = this;
          ...
          key: "onWarehouseRenderEvent",
          value: function onWarehouseRenderEvent(item, index) {
            var _this3 = this;
