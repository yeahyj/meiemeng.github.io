...
System.register("chunks:///_virtual/Collider.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './Agent.ts', './Body.ts', './Object.ts', './Shape.ts'], function (exports) {
  var _createClass, cclegacy, Agent, cBody, Dirty, Trigger, ShapeSupport;
  return {
    setters: [function (module) {
      _createClass = module.createClass;
    }, function (module) {
    ...
    execute: function () {
      ...
      var cCollider = exports('cCollider', /*#__PURE__*/function () {
        ...
        _proto.triggers = function triggers() {
        ...
        _proto.onTrigger = function onTrigger(bi, bj, state) {
          var trigger = 0;
        ...
        _proto.endTrigger = function endTrigger() {
          var deletes = [];
          var pairs = this.pairs;
        ...
        _proto.preBuildAxis = function preBuildAxis() {
          var axis = 0,
            sumX = 0,
            sumX2 = 0,
            sumY = 0,
...
System.register("chunks:///_virtual/Object.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './Collider.ts', './Shape.ts'], function (exports) {
  var _applyDecoratedDescriptor, _inheritsLoose, _initializerDefineProperty, _assertThisInitialized, cclegacy, _decorator, ccenum, Vec2, Vec3, PhysicsSystem, UITransform, Node, Component, cCollider, ShapeType, cPolygon, cSphere, cBox;
  return {
    setters: [function (module) {
    ...
    execute: function () {
      ...
      var cObject = exports('cObject', (_dec = ccclass('cObject'), _dec2 = property({
        ...
        function cObject() {
          ...
          //相交形状类型
          _initializerDefineProperty(_this, "center", _descriptor3, _assertThisInitialized(_this));
          ...
          _initializerDefineProperty(_this, "points", _descriptor6, _assertThisInitialized(_this));
          _initializerDefineProperty(_this, "agent", _descriptor7, _assertThisInitialized(_this));
          //Agent开关
          _initializerDefineProperty(_this, "weight", _descriptor8, _assertThisInitialized(_this));
          //Agent 权值越小，穿透力越强
          _initializerDefineProperty(_this, "maxRadius", _descriptor9, _assertThisInitialized(_this));
          //Agent碰撞半径,小于等于物体体积
          _initializerDefineProperty(_this, "maxVelocity", _descriptor10, _assertThisInitialized(_this));
          //Agent 最大速度上限
          ...
          _this.shape = null;
          _this.body = null;
          _this.group = PhysicsSystem.PhysicsGroup.DEFAULT;
          return _this;
        }
        ...
        _proto.init = function init(customParam) {}
