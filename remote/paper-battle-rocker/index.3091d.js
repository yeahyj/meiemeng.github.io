...
System.register("chunks:///_virtual/PaperBattleRocker.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './BaseView.ts', './cc-ctrl-rocker.ts', './DirectionComp.ts', './WeaponCastComp.ts', './WeaponDepotComp.ts', './WeaponDirectionComp.ts', './app.ts', './Rocker.ts'], function (exports) {
  var _applyDecoratedDescriptor, _inherits, _createSuper, _classCallCheck, _initializerDefineProperty, _assertThisInitialized, _defineProperty, _createClass, cclegacy, _decorator, Node, Vec3, BaseView, DirectionComp, WeaponCastComp, WeaponDepotComp, WeaponDirectionComp, app, RockerEventType;
  return {
    ...
    execute: function () {
      ...
      var PaperBattleRocker = exports('PaperBattleRocker', (_dec = ccclass('PaperBattleRocker'), _dec2 = property(Node), _dec3 = property(Node), _dec(_class = (_class2 = /*#__PURE__*/function (_BaseView) {
        _inherits(PaperBattleRocker, _BaseView);
        var _super = _createSuper(PaperBattleRocker);
        function PaperBattleRocker() {
          var _this;
          _classCallCheck(this, PaperBattleRocker);
          for (var _len = arguments.length, args = new Array(_len), _key = 0; _key < _len; _key++) {
            args[_key] = arguments[_key];
          }
          _this = _super.call.apply(_super, [this].concat(args));
          _initializerDefineProperty(_assertThisInitialized(_this), "moveNode", _descriptor, _assertThisInitialized(_this));
          _initializerDefineProperty(_assertThisInitialized(_this), "atkNode", _descriptor2, _assertThisInitialized(_this));
          _defineProperty(_assertThisInitialized(_this), "movePos", void 0);
          _defineProperty(_assertThisInitialized(_this), "moveLong", void 0);
          _defineProperty(_assertThisInitialized(_this), "atkPos", void 0);
          _defineProperty(_assertThisInitialized(_this), "atkLong", void 0);
          return _this;
        }
        _createClass(PaperBattleRocker, [{
          key: "onLoad",
          value:
          // 初始化的相关逻辑写在这
          function onLoad() {
          ...
          key: "onMoveChange",
          value: function onMoveChange(pos, _long) {
            this.movePos = pos;
            this.moveLong = _long;
          }
        }, {
          key: "onAtkRockerChange",
          value: function onAtkRockerChange(pos, _long2) {
            this.atkPos = pos;
            this.atkLong = _long2;
          }
        }, {
          ...
          value: function update(dt) {
            ...
            this.movePos = (_this$movePos = this.movePos) !== null && _this$movePos !== void 0 ? _this$movePos : new Vec3(0, 0, 0);
            this.moveLong = (_this$moveLong = this.moveLong) !== null && _this$moveLong !== void 0 ? _this$moveLong : 0;
