...
System.register("chunks:///_virtual/PopAssembleWeapon.ts", ['./rollupPluginModLoBabelHelpers.js', 'cc', './BaseView.ts', './WeaponDepotComp.ts', './app.ts', './IconPrefab.ts', './WeaponConfig.ts', './export.type.ts'], function (exports) {
  var _applyDecoratedDescriptor, _inheritsLoose, _initializerDefineProperty, _assertThisInitialized, cclegacy, _decorator, Label, Node, Prefab, Button, instantiate, BaseView, WeaponDepotComp, app, IconPrefab, DB_WeaponConfig, WeaponAttributeType, ItemType;
  return {
      ...
      var PopAssembleWeapon = exports('PopAssembleWeapon', (_dec = ccclass('PopAssembleWeapon'), _dec2 = property(Label), _dec3 = property(Node), _dec4 = property(Node), _dec5 = property(Prefab), _dec6 = property(Node), _dec7 = property(Node), _dec(_class = (_class2 = /*#__PURE__*/function (_BaseView) {
        ...
        _proto.updateUI = function updateUI() {
          ...
          var _loop = function _loop(i) {
            ...
            node.getComponent(IconPrefab).updateUI(data, function () {
        ...
        _proto.onSelectWeaponNode = function onSelectWeaponNode(index) {
          ...
          if (this.selectPluginNodeIndex === index) {
            ...
            (_this$pluginNode$chil = this.pluginNode.children[this.selectPluginNodeIndex]) == null || (_this$pluginNode$chil = _this$pluginNode$chil.getComponent(IconPrefab)) == null || _this$pluginNode$chil.unSelect();
            return;
          }
          if (this.selectPluginNodeIndex !== undefined) {
            var _this$pluginNode$chil2;
            (_this$pluginNode$chil2 = this.pluginNode.children[this.selectPluginNodeIndex]) == null || (_this$pluginNode$chil2 = _this$pluginNode$chil2.getComponent(IconPrefab)) == null || _this$pluginNode$chil2.unSelect();
          }
          this.selectPluginNodeIndex = index;
          (_this$pluginNode$chil3 = this.pluginNode.children[this.selectPluginNodeIndex]) == null || (_this$pluginNode$chil3 = _this$pluginNode$chil3.getComponent(IconPrefab)) == null || _this$pluginNode$chil3.onSelect();
          this.onExchange();
        }
        ...
        _proto.onSelectBagNode = function onSelectBagNode(index) {
          ...
          if (this.selectBagNodeIndex === index) {
            ...
            (_this$bagNode$childre = this.bagNode.children[this.selectBagNodeIndex]) == null || (_this$bagNode$childre = _this$bagNode$childre.getComponent(IconPrefab)) == null || _this$bagNode$childre.unSelect();
            return;
          }
          if (this.selectBagNodeIndex !== undefined) {
            var _this$bagNode$childre2;
            (_this$bagNode$childre2 = this.bagNode.children[this.selectBagNodeIndex]) == null || (_this$bagNode$childre2 = _this$bagNode$childre2.getComponent(IconPrefab)) == null || _this$bagNode$childre2.unSelect();
          }
          this.selectBagNodeIndex = index;
          (_this$bagNode$childre3 = this.bagNode.children[this.selectBagNodeIndex]) == null || (_this$bagNode$childre3 = _this$bagNode$childre3.getComponent(IconPrefab)) == null || _this$bagNode$childre3.onSelect();
          this.onExchange();
        }
        ...
        _proto.onExchange = function onExchange() {
          ...
          (_this$bagNode$childre4 = this.bagNode.children[this.selectBagNodeIndex]) == null || (_this$bagNode$childre4 = _this$bagNode$childre4.getComponent(IconPrefab)) == null || _this$bagNode$childre4.unSelect();
          (_this$pluginNode$chil4 = this.pluginNode.children[this.selectPluginNodeIndex]) == null || (_this$pluginNode$chil4 = _this$pluginNode$chil4.getComponent(IconPrefab)) == null || _this$pluginNode$chil4.unSelect();
          this.selectBagNodeIndex = undefined;
          this.selectPluginNodeIndex = undefined;
          this.updateUI();
        };
